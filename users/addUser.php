                              ...
                              <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             ...
                                             <div class="col-lg-7">
                                                  <input type="text" class="form-control isRequired" id="interfaceUserName" name="interfaceUserName" placeholder="Interface User Name" title="Please enter interface user name" />
                                             </div>
                                        </div>
                                   </div>
                                   <div class="col-md-6">
