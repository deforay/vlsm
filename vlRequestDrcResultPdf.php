  ...
  $html.='<table style="padding:2px;">';
    ...
    $html .='<tr>';
      ...
      $html .='<tr>';
        ...
        $html .='<td style="width:25%;line-height:14px;font-size:12px;text-align:left;">&nbsp;'.strtoupper($result[0]['zone']).'</td>';
      $html .='</tr>';
      $html .='</table>';
      $html .='</td>';
    $html .='</tr>';
