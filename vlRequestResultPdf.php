    ...
    $html .='<tr>';
      ...
      $html .='<table>';
       $html .='<tr>';
        ...
        $html .='<td style="width:25%;line-height:12px;font-size:12px;text-align:left;">'.strtoupper($result[0]['district']).'</td>';
      $html .='</tr>';
      $html .='<tr>';
        $html .='<td style="width:50%;"></td>';
         $html .='<td style="width:25%;line-height:22px;font-size:13px;font-weight:bold;text-align:left;">Clinic Name</td>';
        $html .='<td style="width:25%;line-height:12px;font-size:12px;text-align:left;">'.strtoupper($result[0]['facility_name']).'</td>';
      $html .='</tr>';
      $html .='</table>';
      $html .='</td>';
    $html .='</tr>';
      ...
      $html .='<td colspan="3">';
       $html .='<table>';
        $html .='<tr>';
          ...
          $html .='<td colspan="3" style="line-height:22px;font-size:12px;text-align:left;">'.ucwords($result[0]['labName']).'</td>';
         $html .='</tr>';
         $html .='<tr>';
          $html .='<td colspan="2" style="line-height:22px;font-size:13px;font-weight:bold;text-align:left;">Lab number</td>';
          $html .='<td colspan="2" style="line-height:22px;font-size:13px;font-weight:bold;text-align:left;">Barcode number</td>';
         $html .='</tr>';
         $html .='<tr>';
         ...
         $html .='<tr>';
          ...
          $html .='<td colspan="2" style="line-height:22px;font-size:13px;font-weight:bold;text-align:left;">Surname</td>';
         $html .='</tr>';
         $html .='<tr>';
         ...
         $html .='<tr>';
          ...
          $html .='<td style="line-height:22px;font-size:13px;font-weight:bold;text-align:left;">Sex</td>';
         $html .='</tr>';
         $html .='<tr>';
          ...
          $html .='<td style="line-height:22px;font-size:12px;font-weight:bold;text-align:left;">'.ucwords($result[0]['gender']).'</td>';
         $html .='</tr>';
       $html .='</table>';
      $html .='</td>';
      $html .='<td></td>';
