...
$html.='<table style="padding:2px;">';
    ...
    $html .='<tr>';
      ...
      $html .='<table>';
        $html .='<tr>';
          $html .='<td style="text-align:left;width:4%;"><img src="assets/img/smiley_smile.png" alt="smile_face" style="width:12px;height:12px;"/></td>';
          $html .='<td style="font-size:10px;font-style:italic;text-align:left;"> = VL < = 1000 copies/ml: Continue on current regimen</td>';
        $html .='</tr>';
        $html .='<tr>';
          $html .='<td style="text-align:left;width:4%;"><img src="assets/img/smiley_frown.png" alt="frown_face" style="width:16px;height:16px;"/></td>';
          $html .='<td style="font-size:10px;font-style:italic;text-align:left;"> = VL > 1000 copies/ml: copies/ml: Clinical and counselling action required</td>';
        $html .='</tr>';
        $html .='</table>';
      $html .='</td>';
    $html .='</tr>';
