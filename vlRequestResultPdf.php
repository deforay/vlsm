...
$html.='<table style="padding:2px;">';
    ...
    $html .='<tr>';
     ...
     $html .='<td colspan="2" style="line-height:22px;font-size:12px;text-align:left;">'.strtoupper($result[0]['state']).'</td>';
    $html .='</tr>';
    $html .='<tr>';
    ...
    $html .='<tr>';
      $html .='<td colspan="3">';
       $html .='<table>';
        $html .='<tr>';
          $html .='<td colspan="4" style="line-height:22px;font-size:13px;font-weight:bold;text-align:left;">'.ucwords($result[0]['labName']).'</td>';
         $html .='</tr>';
         $html .='<tr>';
