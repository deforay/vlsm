...
foreach ($rResult as $aRow) {
     $row = array();
     $print = '<a href="covid-19-update-result.php?id=' . base64_encode($aRow['covid19_id']) . '" class="btn btn-success btn-xs" style="margin-right: 2px;" title="'. _("Result").'"><i class="fa fa-pencil-square-o"></i> '. _("Enter Result").'</a>';
