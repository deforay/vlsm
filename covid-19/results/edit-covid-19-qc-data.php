...
$covid19Results = $covid19Db->getCovid19Results();
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" method='post' name='addQcTestKits' id='addQcTestKits' autocomplete="off" enctype="multipart/form-data" action="save-covid-19-qc-data.php">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" value="<?php echo $qcDataInfo['lot_no']; ?>" class="form-control" id="lotNo" name="lotNo" placeholder="<?php echo _('Lot no'); ?>" title="<?php echo _('Please enter lot no'); ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" value="<?php echo date("d-m-Y", strtotime($qcDataInfo['expiry_date'])); ?>" class="form-control date" id="expiryDate" name="expiryDate" placeholder="<?php echo _('Expiry date'); ?>" title="<?php echo _('Please enter expiry date'); ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" value="<?php echo date("d-m-Y H:s:i", strtotime($qcDataInfo['qc_tested_datetime'])); ?>" class="form-control date-time" id="testedOn" name="testedOn" placeholder="<?php echo _('Tested on'); ?>" title="<?php echo _('Please enter tested on'); ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table id="qcTestTableRoot" cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-condensed" style="width:100%;<?php echo $display; ?>">
                        <thead>
                            <tr>
                        ...
                        <tbody id="qcTestTable">
                            <?php foreach ($qcResultDataInfo as $key => $row) { ?>
                                <tr>
                                    ...
                                    <td><select class="form-control" id="testResults<?php echo ($key + 1); ?>" name="testResults[]" class="form-control" title="Please enter the expected results">
