...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <!-- form start -->
                <form class="form-horizontal" method="post" name="addPositiveConformForm" id="addPositiveConformForm" autocomplete="off" action="/covid-19/batch/covid-19-add-confirmation-manifest-helper.php">
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a id="batchSubmit" class="btn btn-primary" href="javascript:void(0);" title="Please select machine" onclick="validateNow();return false;" style="pointer-events:none;" disabled>Submit</a>
...
<script type="text/javascript">
    ...
    function validateNow() {
        flag = deforayValidator.init({
            formId: 'addPositiveConformForm'
        });

        if (flag) {
            $.blockUI();
            document.getElementById('addPositiveConformForm').submit();
        }
    }
