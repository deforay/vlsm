...
if (sizeof($requestResult) > 0) {
    ...
    foreach ($requestResult as $result) {
        ...
        $pdf->setHeading($arr['logo'], $arr['header'], $result['labName'], $title = 'COVID-19 PATIENT REPORT', null, 5);
        ...
        if (isset($covid19TestInfo) && count($covid19TestInfo) > 0 && $arr['covid19_tests_table_in_results_pdf'] == 'yes') {
            ...
            foreach ($covid19TestInfo as $indexKey => $rows) {
                $html .= '<tr>
                                            ...
                                            <td align="center" width="15%">' . ucwords($covid19TestInfo[$indexKey]['testing_platform']) . '</td>
        ...
        if (trim($result['approver_comments']) != '') {
            $html .= '<tr>';
            $html .= '<td colspan="3" style="line-height:11px;font-size:11px;font-weight:bold;">Approver Comments&nbsp;&nbsp;:&nbsp;&nbsp;<span style="font-weight:normal;">' . ucfirst($result['approver_comments']) . '</span></td>';
            $html .= '</tr>';
