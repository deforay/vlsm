...
$aResultFilterTotal = $db->rawQuery("SELECT covid19_id FROM form_covid19 as vl LEFT JOIN facility_details as f ON vl.facility_id=f.facility_id 
...
$aResultTotal =  $db->rawQuery("select COUNT(covid19_id) as total FROM form_covid19 as vl $dWhere");
...
foreach ($rResult as $aRow) {
	...
	if (isset($_POST['vlPrint']) && $_POST['vlPrint'] == 'print') {
		...
		// $print = '<a href="/covid-19/results/generate-result-pdf.php?source=print&id='.$aRow['covid19_id'].'&newData=printData" class="btn btn-primary btn-xs" style="margin-right: 2px;" title="View" onclick="resultPDF(' . $aRow['covid19_id'] . ',\'printData\');"><i class="fa fa-print"> Print</i></a>';
		$print = '<a href="/covid-19/results/generate-result-pdf.php?source=print&id='.$aRow['covid19_id'].'&newData=printData" class="btn btn-primary btn-xs" style="margin-right: 2px;" title="View" target="_blank"><i class="fa fa-print"> Print</i></a>';
	} 
