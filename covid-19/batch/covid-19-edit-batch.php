														...
														<div class="col-md-12">
															 <div style="width:60%;margin:0 auto;clear:both;">
																...
																foreach($result as $key=>$sample){
																	?>
																	  <option value="<?php echo $sample['form_covid19'];?>" <?php echo (trim($sample['sample_batch_id']) == $id)?'selected="selected"':''; ?>><?php  echo $sample['sample_code']." - ".ucwords($sample['facility_name']);?></option>
																	<?php
																}
																?>
															 </select>
