...
<div class="content-wrapper">
	...
	<section class="content-header">
        ...
        </svg></i> <?php echo _("Covid-19 Results");?></h1>
		<ol class="breadcrumb">
				...
				<div class="box">
					<div class="box-header with-border">
						<?php if (isset($_SESSION['privileges']) && in_array("covid19-sample-type.php", $_SESSION['privileges']) && $sarr['sc_user_type'] != 'vluser') { ?>
							<a href="add-covid19-results.php" class="btn btn-primary pull-right"> <i class="fa fa-plus"></i> <?php echo _("Add Covid-19 Results");?></a>
						<?php } ?>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
