...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        <!-- form start -->
        <form class="form-horizontal" method='post' name='editComorbidityForm' id='editComorbidityForm' autocomplete="off" enctype="multipart/form-data" action="editComorbidityHelper.php">
          <div class="box-body">
            <div class="row">
              <div class="col-md-6">
