            ...
            <form class="form-inline" method="post" name="vlRequestForm" id="vlRequestForm" autocomplete="off" action="addVlRequestHelperDrc.php">
              <div class="box-body">
                <div class="box box-default">
                    <div class="box-body">
                        <div class="box-header with-border">
                            <h3 class="box-title">1. Réservé à la structure de soins<br><span class="translate-content">Reserved for the care structure</span></h3>
                        </div>
                        <div class="box-header with-border">
                        ...
                        <table class="table" style="width:100%">
                            <tr>
                                ...
                                <td><label for="clinicName">Zone de santé <br><span class="translate-content">Health zone </span></label></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><label for="clinicanTelephone">Téléphone <br><span class="translate-content">Phone </span></label></td>
                                <td>
                        ...
                        <table class="table" style="width:100%">
                            <tr>
                                ...
                                <td><label for="ageInYears">Âge en années <br><span class="translate-content">Age in Years </span></label></td>
                                <td>
                                ...
                                <td><label for="ageInMonths">Âge en mois <br><span class="translate-content">Age in Months </span></label></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><label for="">Date du début des ARV <br><span class="translate-content">Date of start ARVs </span></label></td>
                                <td colspan="4">
                                    <input type="text" class="form-control date" id="dateOfArtInitiation" name="dateOfArtInitiation" placeholder="e.g 09-Jan-1992" title="Please enter date du début des ARV" style="width:40%;"/> (Jour/Mois/Année) <span class="translate-content">(Day/Month/Year)</span>
                                </td>
                            </tr>
                            <tr>
                                <td><label>Régime ARV en cours <br><span class="translate-content">ARV current regime </span></label></td>
                                <td colspan="7">
                            ...
                            <tr class="newArtRegimen" style="display:none;">
                                <td><label for="newArtRegimen">Autre, à préciser <br><span class="translate-content">Other, please specify </span></label></td>
                                <td colspan="7">
                            ...
                            <tr>
                                <td><label for="hasChangedRegimen">Ce patient a-t-il déjà changé de régime de traitement? <br><span class="translate-content">This patient has already changed treatment regime </span></label></td>
                                <td colspan="3">
                                ...
                                <td><label for="reasonForArvRegimenChange" class="arvChangedElement" style="display:none;">Motif de changement de régime ARV <br><span class="translate-content">Regime shift pattern ARV </span></label></td>
                                <td colspan="3">
                            ...
                            <tr class="arvChangedElement" style="display:none;">
                                <td><label for="">Date du changement de régime ARV <br><span class="translate-content">Date of change of ARV regimen </span></label></td>
                                <td colspan="7">
                                    <input type="text" class="form-control date" id="dateOfArvRegimenChange" name="dateOfArvRegimenChange" placeholder="e.g 09-Jan-1992" title="Please enter date du changement de régime ARV" style="width:30%;"/> (Jour/Mois/Année) <span class="translate-content">(Day/Month/Year)</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><label for="lastViralLoadResult">Résultat dernière charge virale <br><span class="translate-content">Result last viral load </span></label></td>
                                <td colspan="7">
                            ...
                            <tr>
                                <td><label for="">Date dernière charge virale (demande) <br><span class="translate-content">Date of last viral load (demand) </span></label></td>
                                <td colspan="7">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Informations sur le prélèvement <br><span class="translate-content">Sampling information </span></h3>
                        </div>
                        <table class="table" style="width:100%">
                            <tr>
                                <td style="width:20%;"><label for="">Date du prélèvement <br><span class="translate-content">Withdrawal date </span></label></td>
                                <td colspan="3">
                            ...
                            <tr>
                                <td><label for="specimenType">Type d’échantillon <br><span class="translate-content">Sample Type</span></label></td>
                                <td colspan="3">
                            ...
                            <tr class="plasmaElement" style="display:none;">
                                <td><label for="storageTemperature">Si plasma,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Température de conservation <br><span class="translate-content">If plasma,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Temperature conservation </span></label></td>
                                <td>
                                ...
                                <td><label for="duationOfConservation">Durée de conservation <br><span class="translate-content">The duration of the conversation </span></label></td>
                                <td>
                                    <input type="text" class="form-control" id="duationOfConservation" name="duationOfConservation" placeholder="e.g 05/30" title="Please enter durée de conservation" style="width:60%;"/>Jour/Heures <span class="translate-content">Day/Hour </span>
                                </td>
                            </tr>
                            <tr>
                                <td><label for="">Date de départ au Labo biomol <br><span class="translate-content">Departure date at Lab biomol </span></label></td>
                                <td colspan="3">
                            ...
                            <tr>
                                <td colspan="4"><label class="radio-inline" style="margin:0;padding:0;">A remplir par le préleveur <br><span class="translate-content">To be completed by the sampler</span></label></td>
                            </tr>
                        </table>
                    </div>
                </div>
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="box-header with-border">
                            <h3 class="box-title">2. Réservé au Laboratoire de biologie moléculaire <br><span class="translate-content"> Reserved for Molecular Biology Laboratory</span></h3>
                        </div>
                        <table class="table" style="width:100%">
                            <tr>
                                <td style="width:20%;"><label for="">Date de réception de l’échantillon <br><span class="translate-content">Date of sample receipt </span></label></td>
                                <td colspan="3">
                            ...
                            <tr>
                                <td><label for="">Décision prise <br><span class="translate-content">Decision taken </span></label></td>
                                <td colspan="3">
                            ...
                            <tr>
                                <td><label for="">Date de réalisation de la charge virale <br><span class="translate-content">Date of completion of the viral load </span></label></td>
                                <td colspan="3">
                            ...
                            <tr>
                                <td><label for="testingPlatform">Technique utilisée <br><span class="translate-content">Technique used </span></label></td>
                                <td colspan="3">
                            ...
                            <tr>
                                <td><label for="vlResult">Résultat <br><span class="translate-content">Result </span></label></td>
                                <td>
                                ...
                                <td colspan="2">Limite de détection : < 40 Copies/ml ou  log  < 1.6 ( pour DBS )<br><span class="translate-content">Detection Limit </span></td>
                            </tr>
                            <tr>
                            ...
                            <tr><td colspan="4" style="height:30px;border:none;"></td></tr>
                            <tr>
                                <td><label for="">Date de remise du résultat <br><span class="translate-content">Date for the result </span></label></td>
                                <td colspan="3">
                ...
                <div class="box-header with-border">
                  <label class="radio-inline" style="margin:0;padding:0;">1. Biffer la mention inutile <br><span class="translate-content">Delete as appropriate</span><br>2. Sélectionner un seul régime de traitement <br><span class="translate-content">Select a single treatment regimen</span></label>
                </div>
              </div>
              <!-- /.box-body -->
