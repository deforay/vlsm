...
$country = $configResult[0]['value'];
        ...
        */
        ...
        $aColumns = array('facility_state','facility_district','facility_name','facility_code',"DATE_FORMAT(vl.sample_collection_date,'%d-%b-%Y')",'vl.comments');
        $orderColumns = array('facility_state','facility_district','facility_name','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','sample_collection_date','vl.comments');
	...
	//echo $sQuery;die;
        ...
        */
	    ...
	    $totalQuery = 'SELECT vl_sample_id,patient_dob,patient_gender,is_patient_pregnant,is_patient_breastfeeding,result,is_sample_rejected,reason_for_sample_rejection FROM vl_request_form as vl where vl.facility_id = '.$aRow['facility_id'].' AND vl.form_id = '.$country;
	    if(isset($_POST['lab']) && trim($_POST['lab'])!= ''){
