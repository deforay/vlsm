                ...
                <div class="row">
                  <div class="col-md-7">
                    <div class="form-group">
                      ...
                      <div class="col-lg-8">
                        <select type="text" class="form-control" id="sc_user_type" name="sc_user_type" placeholder="Instance Type" title="Please choose instance type" onchange="enableLab();">
                          <option value="standalone" <?php echo ('standalone' == $arr['sc_user_type']) ? "selected='selected'" : "" ?>>Standalone</option>
                          <option value="vluser" <?php echo ('vluser' == $arr['sc_user_type']) ? "selected='selected'" : "" ?>>Lab Instance</option>
                          <option value="remoteuser" <?php echo ('remoteuser' == $arr['sc_user_type']) ? "selected='selected'" : "" ?>>Remote Instance</option>
                        </select>
                      </div>
                    </div>
                  </div>
