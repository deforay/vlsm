...
$sQuery = "SELECT * FROM track_api_requests";
...
// $aResultFilterTotal = $db->rawQuery("SELECT * FROM track_api_requests $sWhere order by $sOrder");
// $iFilteredTotal = count($aResultFilterTotal);

// print_r($iFilteredTotal);die;

/* Total data set length */
$aResultTotal =  $db->rawQuery("select COUNT(api_track_id) as total FROM track_api_requests");
