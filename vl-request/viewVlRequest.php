...
$fQuery="SELECT vl.sample_code,vl.patient_first_name,vl.patient_art_no,vl.test_urgency,vl.patient_dob,vl.patient_gender,vl.patient_mobile_number,vl.patient_location,vl.sample_collection_date,vl.treatment_initiation,vl.date_of_initiation_of_current_regimen,vl.is_patient_pregnant,vl.is_patient_breastfeeding,vl.arv_adherance_percentage,vl.number_of_enhanced_sessions,vl.reason_for_vl_testing,vl.last_vl_date_routine,vl.last_vl_result_routine,vl.last_vl_sample_type_routine,vl.last_vl_date_failure_ac,vl.last_vl_result_failure_ac,vl.last_vl_sample_type_failure_ac,vl.last_vl_date_failure,vl.last_vl_result_failure,vl.last_vl_sample_type_failure,vl.request_clinician_name,vl.request_clinician_phone_number,vl.sample_testing_date,vl.vl_focal_person,vl.vl_focal_person_phone_number,vl.date_sample_received_at_testing_lab,vl.date_results_dispatched,vl.is_sample_rejected,vl.sample_rejection_facility,vl.reason_for_sample_rejection,vl.patient_other_id,vl.patient_age_in_years,vl.patient_age_in_months,vl.treatment_initiated_date,vl.patient_anc_no,vl.consent_to_receive_sms,vl.treatment_details,vl.lab_name,vl.lab_contact_person,vl.lab_phone_no,vl.lab_tested_date,vl.test_methods,vl.log_value,vl.absolute_value,vl.text_value,vl.result,vl.comments,vl.result_reviewed_by,vl.result_reviewed_date,vl.result_status,ts.status_name,r_a_c_d.art_code,f.facility_name,f.facility_code,f.facility_emails,f.facility_state,f.facility_hub_name,r_s_t.sample_name,r_s_t_rm.sample_name as snrm,r_s_t_tfac.sample_name as sntfac,r_s_t_stf.sample_name as snstf,r_s_t_stdf.sample_name as stdf,r_s_t_mis.sample_name as mis from vl_request_form as vl LEFT JOIN facility_details as f ON vl.facility_id=f.facility_id LEFT JOIN r_sample_type as r_s_t ON r_s_t.sample_id=vl.sample_type INNER JOIN r_sample_status as ts ON ts.status_id=vl.result_status LEFT JOIN r_sample_type as r_s_t_rm ON r_s_t_rm.sample_id=vl.last_vl_sample_type_routine LEFT JOIN r_sample_type as r_s_t_tfac ON r_s_t_tfac.sample_id=vl.last_vl_sample_type_failure_ac LEFT JOIN r_sample_type as r_s_t_stf ON r_s_t_stf.sample_id=vl.last_vl_sample_type_failure LEFT JOIN r_sample_type as r_s_t_stdf ON r_s_t_stdf.sample_id=vl.switch_to_tdf_sample_type LEFT JOIN r_sample_type as r_s_t_mis ON r_s_t_mis.sample_id=vl.missing_sample_type LEFT JOIN r_art_code_details as r_a_c_d ON r_a_c_d.art_id=vl.current_regimen where vl_sample_id=$id";
//echo $fQuery;die;
            ...
            <div class="box-body">
             <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="rejectionFacility" class="col-lg-4 control-label">Rejection Facility</label>
                        <div class="col-lg-7" style="font-style:italic;">
