...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('.daterange,#sampleCollectionDate,#sampleTestDate,#printSampleCollectionDate,#printSampleTestDate,#vlSampleCollectionDate,#eidSampleCollectionDate,#covid19SampleCollectionDate,#recencySampleCollectionDate,#hepatitisSampleCollectionDate,#hvlSampleTestDate,#rjtSampleTestDate,#noResultSampleTestDate').on('cancel.daterangepicker', function(ev, picker) {
			$(this).val('');
		});
	});
