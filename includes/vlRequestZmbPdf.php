...
$configQuery="SELECT * from global_config";
    ...
    $html.='</tr>';
    $html.='<tr>';
    $html.='<td>Patient Name:'.$result[0]['patient_first_name']." ".$result[0]['patient_last_name'].'</td>';
    $html.='</tr>';
    $html.='<tr>';
    $html.='<td>Patient OI/ART Number:'.$result[0]['patient_art_no'].'</td>';
    $html.='</tr>';
    $html.='<tr>';
    $html.='<td>Patient Phone Number:'.$result[0]['patient_mobile_number'].'</td>';
    $html.='</tr>';
    $html.='<tr>';
