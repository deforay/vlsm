...
$pdf->AddPage();
$html = '';
$html .= '<div style="font-size:11px;font-family:Times New Roman;">';
  $html.='<table style="padding:2px;">';
    ...
    $html.='<table>';
        ...
        $html.='<tr>';
            ...
            $html.='<td colspan="2" style="line-height:20px;">&nbsp;&nbsp;Date du début des ARV   </td>';
            $html.='<td colspan="2" style="line-height:20px;">------/-----/------------</td>';
        $html.='</tr>';
        $html.='<tr>';
            $html.='<td colspan="2" style="line-height:20px;">Régime ARV en cours </td>';
            $html.='<td colspan="6" style="line-height:20px;">-------------------------</td>';
        $html.='</tr>';
        $html.='<tr>';
            $html.='<td colspan="3" style="line-height:20px;">Ce patient a-t-il déjà changé de régime de traitement? </td>';
        ...
        $html.='<tr>';
            ...
            $html.='<td style="line-height:20px;text-align:center;">&nbsp;&nbsp;Si Femme enceinte </td>';
