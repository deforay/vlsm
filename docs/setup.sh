...
apt update
apt install -y php8.2 openssl php8.2-common php8.2-cli php8.2-json php8.2-mysql php8.2-zip php8.2-gd php8.2-mbstring php8.2-curl php8.2-xml php8.2-xmlrpc php8.2-bcmath php8.2-gmp php8.2-intl php8.2-imagick php-mime-type php8.2-apcu
service apache2 restart || {
    echo "Failed to restart Apache2. Exiting..."
    exit 1
}
