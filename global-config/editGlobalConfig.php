								...
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input type="text" class="form-control isRequired readPage" name="fName" id="fName" title="Please enter instance name" placeholder="Facility/Instance Name" value="<?php echo $instanceResult[0]['instance_facility_name']; ?>" />
											</div>
										</div>
									</div>
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input type="text" class="form-control readPage" id="fCode" name="fCode" placeholder="Facility Code" title="Please enter instance/facility code" value="<?php echo $instanceResult[0]['instance_facility_code']; ?>" />
											</div>
										</div>
									</div>
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<select class="form-control isRequired readPage" name="instance_type" id="instance_type" title="Please select the instance type">
													...
													<div class="fileinput fileinput-new instanceLogo" data-provides="fileinput">
														...
														<div>
															<span class="btn btn-default btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
																<input class="readPage" type="file" id="instanceLogo" name="instanceLogo" title="Please select logo image" onchange="getNewInstanceImage('<?php echo $instanceResult[0]['instance_facility_logo']; ?>');">
															</span>
															<?php
															if (isset($instanceResult[0]['instance_facility_logo']) && trim($instanceResult[0]['instance_facility_logo']) != '' && file_exists(UPLOAD_PATH . DIRECTORY_SEPARATOR . "instance-logo" . DIRECTORY_SEPARATOR . $instanceResult[0]['instance_facility_logo'])) {
															?>
								...
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input type="text" class="form-control readPage" id="default_time_zone" name="default_time_zone" placeholder="eg: Africa/Harare" title="Please enter default time zone" value="<?php echo $arr['default_time_zone']; ?>" />
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<textarea class="form-control readPage" id="header" name="header" placeholder="Header" title="Please enter header" style="width:100%;min-height:80px;max-height:100px;"><?php echo $arr['header']; ?></textarea>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<div class="fileinput fileinput-new logo" data-provides="fileinput">
													...
													<div>
														<span class="btn btn-default btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
															<input type="file" class="readPage" id="logo" name="logo" title="Please select logo image" onchange="getNewImage('<?php echo $arr['logo']; ?>');">
														</span>
														<?php
														if (isset($arr['logo']) && trim($arr['logo']) != '' && file_exists(UPLOAD_PATH . DIRECTORY_SEPARATOR . "logo" . DIRECTORY_SEPARATOR . $arr['logo'])) {
														?>
								...
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input type="radio" class="readPage" id="edit_profile_yes" name="edit_profile" value="yes" <?php echo ($arr['edit_profile'] == 'yes') ? 'checked' : ''; ?>>&nbsp;&nbsp;Yes&nbsp;&nbsp;
												<input type="radio" class="readPage" id="edit_profile_no" name="edit_profile" value="no" <?php echo ($arr['edit_profile'] == 'no') ? 'checked' : ''; ?>>&nbsp;&nbsp;No
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-7" style="height:38px;">
										<div class="form-group" style="height:38px;">
											...
											<div class="col-lg-8">
												<select class="form-control isRequired readPage" name="barcode_format" id="barcode_format" title="Please select the Barcode type">
								...
								<div class="row" style="margin-top:10px;">
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<br>
												<input type="radio" class="readPage" id="user_review_yes" name="user_review_approve" value="yes" <?php echo ($arr['user_review_approve'] == 'yes') ? 'checked' : ''; ?>>&nbsp;&nbsp;Yes&nbsp;&nbsp;
												<input type="radio" class="readPage" id="user_review_no" name="user_review_approve" value="no" <?php echo ($arr['user_review_approve'] == 'no') ? 'checked' : ''; ?>>&nbsp;&nbsp;No
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-7" style="height:38px;">
										<div class="form-group" style="height:38px;">
											...
											<div class="col-lg-8">
												<input type="text" class="form-control readPage" id="manager_email" name="manager_email" placeholder="eg. manager1@example.com, manager2@example.com" title="Please enter manager email" value="<?php echo $arr['manager_email']; ?>" />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<select class="form-control isRequired readPage" name="bar_code_printing" id="bar_code_printing" title="Please select the barcode printing">
									...
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<br>
												<br>
												<input class="readPage" type="radio" id="import_non_matching_sample_yes" name="import_non_matching_sample" value="yes" <?php echo ($arr['import_non_matching_sample'] == 'yes') ? 'checked' : ''; ?>>&nbsp;&nbsp;Yes&nbsp;&nbsp;
												<input class="readPage" type="radio" id="import_non_matching_sample_no" name="import_non_matching_sample" value="no" <?php echo ($arr['import_non_matching_sample'] == 'no') ? 'checked' : ''; ?>>&nbsp;&nbsp;No
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-10">
													<br>
													<input type="radio" class="readPage" id="show_full_date_yes" name="show_date" value="yes" <?php echo ($arr['show_date'] == 'yes') ? 'checked' : ''; ?>>&nbsp;&nbsp;Full Date&nbsp;&nbsp;
													<input type="radio" class="readPage" id="show_full_date_no" name="show_date" value="no" <?php echo ($arr['show_date'] == 'no' || $arr['show_date'] == '') ? 'checked' : ''; ?>>&nbsp;&nbsp;Month and Year
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-10">
													<div class="input-group" style="max-width:200px;">
														<input type="text" class="form-control readPage forceNumeric isNumeric isRequired" id="viral_load_threshold_limit" name="viral_load_threshold_limit" placeholder="Viral Load Threshold Limit" title="Please enter VL threshold limit" value="<?php echo $arr['viral_load_threshold_limit']; ?>" />
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-10">
													...
													?>
													<input type="radio" title="Please select the Viral Load Sample Code Format" class="isRequired readPage" id="auto_generate_yy" name="sample_code" value="YY" <?php echo ($arr['sample_code'] == 'YY') ? 'checked' : ''; ?> onclick="makeReadonly('prefixMMYY','prefixYY')">&nbsp;<input <?php echo $sPrefixYYDisplay; ?> type="text" class="boxWidth prefixYY readPage" id="prefixYY" name="sample_code_prefix" title="Enter Prefix" value="<?php echo $sPrefixYY; ?>" /> YY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" title="Please select the Viral Load Sample Code Format" class="isRequired readPage" id="auto_generate_mmyy" name="sample_code" value="MMYY" <?php echo ($arr['sample_code'] == 'MMYY') ? 'checked' : ''; ?> onclick="makeReadonly('prefixYY','prefixMMYY')">&nbsp;<input <?php echo $sPrefixMMYYDisplay; ?> type="text" class="boxWidth prefixMMYY readPage" id="prefixMMYY" name="sample_code_prefix" title="Enter Prefix" value="<?php echo $sPrefixMMYY; ?>" /> MMYY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" title="Please select the Viral Load Sample Code Format" class="isRequired readPage" id="auto_generate" name="sample_code" value="auto" <?php echo ($arr['sample_code'] == 'auto') ? 'checked' : ''; ?>><span id="auto1"><?php echo ($arr['vl_form'] == 5) ? ' Auto 1' : ' Auto'; ?> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" title="Please select the Viral Load Sample Code Format" class="isRequired readPage" id="auto_generate2" name="sample_code" value="auto2" <?php echo ($arr['sample_code'] == 'auto2') ? 'checked' : ''; ?> style="display:<?php echo ($arr['vl_form'] == 5) ? '' : 'none'; ?>"><span id="auto2" style="display:<?php echo ($arr['vl_form'] == 5) ? '' : 'none'; ?>"> Auto 2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
													<input type="radio" title="Please select the Viral Load Sample Code Format" class="isRequired readPage" id="numeric" name="sample_code" value="numeric" <?php echo ($arr['sample_code'] == 'numeric') ? 'checked' : ''; ?>> Numeric&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" title="Please select the Viral Load Sample Code Format" class="isRequired readPage" id="alpha_numeric" name="sample_code" value="alphanumeric" <?php echo ($arr['sample_code'] == 'alphanumeric') ? 'checked' : ''; ?>> Alpha Numeric
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-10">
													...
													?>
													<input type="radio" class="isRequired readPage" title="Please select the EID Sample Code Format" id="eid_auto_generate_yy" name="eid_sample_code" value="YY" <?php echo ($arr['eid_sample_code'] == 'YY') ? 'checked' : ''; ?> onclick="makeReadonly('prefixMMYY','prefixYY')">&nbsp;<input <?php echo $sPrefixYYDisplay; ?> type="text" class="eid_boxWidth eid_prefixYY readPage" id="eid_prefixYY" name="eid_sample_code_prefix" title="Enter Prefix" value="<?php echo $sPrefixYY; ?>" /> YY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" class="isRequired readPage" title="Please select the EID Sample Code Format" id="eid_auto_generate_mmyy" name="eid_sample_code" value="MMYY" <?php echo ($arr['eid_sample_code'] == 'MMYY') ? 'checked' : ''; ?> onclick="makeReadonly('prefixYY','prefixMMYY')">&nbsp;<input <?php echo $sPrefixMMYYDisplay; ?> type="text" class="eid_boxWidth eid_prefixMMYY readPage" id="eid_prefixMMYY" name="eid_sample_code_prefix" title="Enter Prefix" value="<?php echo $sPrefixMMYY; ?>" /> MMYY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" class="isRequired readPage" title="Please select the EID Sample Code Format" id="eid_auto_generate" name="eid_sample_code" value="auto" <?php echo ($arr['eid_sample_code'] == 'auto') ? 'checked' : ''; ?>><span id="eid_auto1"><?php echo ($arr['vl_form'] == 5) ? ' Auto 1' : ' Auto'; ?> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" class="isRequired readPage" title="Please select the EID Sample Code Format" id="eid_auto_generate2" name="eid_sample_code" value="auto2" <?php echo ($arr['eid_sample_code'] == 'auto2') ? 'checked' : ''; ?> style="display:<?php echo ($arr['vl_form'] == 5) ? '' : 'none'; ?>"><span id="eid_auto2" style="display:<?php echo ($arr['vl_form'] == 5) ? '' : 'none'; ?>"> Auto 2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
													<input type="radio" class="isRequired readPage" title="Please select the EID Sample Code Format" id="eid_numeric" name="eid_sample_code" value="numeric" <?php echo ($arr['eid_sample_code'] == 'numeric') ? 'checked' : ''; ?>> Numeric&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" class="isRequired readPage" title="Please select the EID Sample Code Format" id="eid_alpha_numeric" name="eid_sample_code" value="alphanumeric" <?php echo ($arr['eid_sample_code'] == 'alphanumeric') ? 'checked' : ''; ?>> Alpha Numeric
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-10">
													<input type="text" class="form-control forceNumeric readPage isNumeric <?php echo ($arr['eid_sample_code'] == 'auto' || 'MMYY' || 'YY') ? '' : 'isRequired'; ?>" id="eid_min_length" name="eid_min_length" <?php echo ($arr['eid_sample_code'] == 'auto' || 'MMYY' || 'YY') ? 'readonly' : ''; ?> placeholder="Min" title="Please enter sample code min length" value="<?php echo ($arr['eid_sample_code'] == 'auto') ? '' : $arr['min_length']; ?>" style="max-width:60px;" />
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-10">
													<input type="text" class="form-control readPage forceNumeric isNumeric <?php echo ($arr['eid_sample_code'] == 'auto' || 'MMYY' || 'YY') ? '' : 'isRequired'; ?>" id="eid_max_length" name="eid_max_length" <?php echo ($arr['eid_sample_code'] == 'auto' || 'MMYY' || 'YY') ? 'readonly' : ''; ?> placeholder="Max" title="Please enter sample code max length" value="<?php echo ($arr['eid_sample_code'] == 'auto') ? '' : $arr['max_length']; ?>" style="max-width:60px;" />
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												<?php if (isset($arr['covid19_report_type']) && $arr['covid19_report_type'] != '') { ?>
													<label for="covid19ReportType" class="col-lg-2 control-label">Covid-19 Excel Export Report Format<span class="mandatory ">*</span></label>
													<div class="col-lg-4">
														<select name="covid19ReportType" id="covid19ReportType" class="form-control isRequired readPage" title="Please select covid19 report type">
															<option value="">-- Select --</option>
												...
												if (isset($arr['covid19_positive_confirmatory_tests_required_by_central_lab']) && $arr['covid19_positive_confirmatory_tests_required_by_central_lab'] != '') { ?>
													...
													<div class="col-lg-4">
														<select name="covid19PositiveConfirmatoryTestsRequiredByCentralLab" id="covid19PositiveConfirmatoryTestsRequiredByCentralLab" class="form-control readPage isRequired" title="Please select covid19 report type">
															<option value="">-- Select --</option>
										...
										<div class="col-md-12">
											<div class="form-group">
												<?php if (isset($arr['covid19_tests_table_in_results_pdf']) && $arr['covid19_tests_table_in_results_pdf'] != '') { ?>
													...
													<div class="col-lg-4">
														<select name="covid19TestsTableInResultsPdf" id="covid19TestsTableInResultsPdf" class="form-control readPage isRequired" title="Please select covid19 Tests method in Results Pdf">
															<option value="">-- Select --</option>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-10">
													...
													?>
													<input type="radio" class="isRequired readPage" title="Please select the Hepatitis Sample Code Format" id="hepatitis_auto_generate_yy" name="hepatitis_sample_code" value="YY" <?php echo ($arr['hepatitis_sample_code'] == 'YY') ? 'checked' : ''; ?> onclick="makeReadonly('prefixMMYY','prefixYY')">&nbsp;<input <?php echo $sPrefixYYDisplay; ?> type="text" class="hepatitis_boxWidth hepatitis_prefixYY" id="hepatitis_prefixYY" name="hepatitis_sample_code_prefix" title="Enter Prefix" value="<?php echo $sPrefixYY; ?>" /> YY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" class="isRequired readPage" title="Please select the Hepatitis Sample Code Format" id="hepatitis_auto_generate_mmyy" name="hepatitis_sample_code" value="MMYY" <?php echo ($arr['hepatitis_sample_code'] == 'MMYY') ? 'checked' : ''; ?> onclick="makeReadonly('prefixYY','prefixMMYY')">&nbsp;<input <?php echo $sPrefixMMYYDisplay; ?> type="text" class="hepatitis_boxWidth hepatitis_prefixMMYY" id="hepatitis_prefixMMYY" name="hepatitis_sample_code_prefix" title="Enter Prefix" value="<?php echo $sPrefixMMYY; ?>" /> MMYY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" class="isRequired readPage" title="Please select the Hepatitis Sample Code Format" id="hepatitis_auto_generate" name="hepatitis_sample_code" value="auto" <?php echo ($arr['hepatitis_sample_code'] == 'auto') ? 'checked' : ''; ?>><span id="hepatitis_auto1"><?php echo ($arr['vl_form'] == 5) ? ' Auto 1' : ' Auto'; ?> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" class="isRequired readPage" title="Please select the Hepatitis Sample Code Format" id="hepatitis_auto_generate2" name="hepatitis_sample_code" value="auto2" <?php echo ($arr['hepatitis_sample_code'] == 'auto2') ? 'checked' : ''; ?> style="display:<?php echo ($arr['vl_form'] == 5) ? '' : 'none'; ?>"><span id="hepatitis_auto2" style="display:<?php echo ($arr['vl_form'] == 5) ? '' : 'none'; ?>"> Auto 2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
													<input type="radio" class="isRequired readPage" title="Please select the Hepatitis Sample Code Format" id="hepatitis_numeric" name="hepatitis_sample_code" value="numeric" <?php echo ($arr['hepatitis_sample_code'] == 'numeric') ? 'checked' : ''; ?>> Numeric&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" class="isRequired readPage" title="Please select the Hepatitis Sample Code Format" id="hepatitis_alpha_numeric" name="hepatitis_sample_code" value="alphanumeric" <?php echo ($arr['hepatitis_sample_code'] == 'alphanumeric') ? 'checked' : ''; ?>> Alpha Numeric
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control readPage forceNumeric isNumeric <?php echo ($arr['tb_sample_code'] == 'auto' || 'MMYY' || 'YY') ? '' : 'isRequired'; ?>" id="tb_min_length" name="tb_min_length" <?php echo ($arr['tb_sample_code'] == 'auto' || 'MMYY' || 'YY') ? 'readonly' : ''; ?> placeholder="Min" title="Please enter sample code min length" value="<?php echo ($arr['tb_sample_code'] == 'auto') ? '' : $arr['min_length']; ?>" />
												</div>
												...
												<div class="col-lg-4">
													<input type="text" class="form-control readPage forceNumeric isNumeric <?php echo ($arr['tb_sample_code'] == 'auto' || 'MMYY' || 'YY') ? '' : 'isRequired'; ?>" id="tb_max_length" name="tb_max_length" <?php echo ($arr['tb_sample_code'] == 'auto' || 'MMYY' || 'YY') ? 'readonly' : ''; ?> placeholder="Max" title="Please enter sample code max length" value="<?php echo ($arr['tb_sample_code'] == 'auto') ? '' : $arr['max_length']; ?>" />
												</div>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-7" style="height:38px;">
										<div class="form-group" style="height:38px;">
											...
											<div class="col-lg-8">
												<input type="text" class="form-control readPage" id="vldashboard_url" name="vldashboard_url" placeholder="https://dashboard.example.org" title="Please enter dashboard URL" value="<?php echo $arr['vldashboard_url']; ?>" />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input type="radio" class="readPage" id="show_smiley_yes" name="show_smiley" value="yes" <?php echo ($arr['show_smiley'] == 'yes') ? 'checked' : ''; ?>>&nbsp;&nbsp;Yes&nbsp;&nbsp;
												<input type="radio" class="readPage" id="show_smiley_no" name="show_smiley" value="no" <?php echo ($arr['show_smiley'] == 'no' || $arr['show_smiley'] == '') ? 'checked' : ''; ?>>&nbsp;&nbsp;No
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<textarea class="form-control readPage" id="h_vl_msg" name="h_vl_msg" placeholder="High Viral Load message that will appear for results >= the VL threshold limit" title="Please enter high viral load message" style="width:100%;min-height:80px;max-height:100px;"><?php echo $arr['h_vl_msg']; ?></textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<textarea class="form-control readPage" id="l_vl_msg" name="l_vl_msg" placeholder="Low Viral Load message that will appear for results lesser than the VL threshold limit" title="Please enter low viral load message" style="width:100%;min-height:80px;max-height:100px;"><?php echo $arr['l_vl_msg']; ?></textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<select type="text" class="form-control readPage" id="patient_name_pdf" name="patient_name_pdf" title="Choose one option" value="<?php echo $arr['patient_name_pdf']; ?>">
