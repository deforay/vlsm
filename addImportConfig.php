            ...
            <form class="form-horizontal" method='post'  name='addImportConfigForm' id='addImportConfigForm' autocomplete="off" action="addImportConfigHelper.php">
              <div class="box-body">
                ...
                <div class="row">
                   <div class="col-md-12">
                    <div class="form-group">
                        <label for="logAndAbsoluteInSameColumnYes" class="col-lg-4 control-label">Log and Absolute Values are same Column <span class="mandatory">*</span></label>
                        <div class="col-lg-7">
                ...
                <div class="row">
                   <div class="col-md-6">
                    <label for="reviewedBy" class="col-lg-4 control-label"> </label>
                    <div class="form-group">
                        <div class="col-lg-7">
                        <label for="reviewedDate" class="control-label">Column</label>
                        </div>
                    </div>
                  </div>
                   <div class="col-md-6">
                    <div class="form-group">
                        <div class="col-lg-7">
                          <label for="reviewedDate" class="control-label">Row</label>
                        </div>
                    </div>
                  </div>
                </div>
