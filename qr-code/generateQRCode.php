  ...
  if(count($sampleArray) >0){
    ...
    if(count($sResult) > 0){
        ...
        foreach($sResult as $vl){
            ...
            $pdf->write2DBarcode($qrString, 'QRCODE,L', 165, 2, 65, 65, $style, 'N');
