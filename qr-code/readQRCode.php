...
<div class="content-wrapper" style="min-height: 347px;">
    <section class="content-header">
      ...
      <textarea class="form-control" id="qrText" name="qrText" placeholder="Please place your cursor here before start reading QR code" style="width:100%;min-height:100px;max-height:200px;box-shadow: 0 0 10px rgba(0,0,0,0.6);"></textarea>
    </section>
</div>
<script>
