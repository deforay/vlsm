                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="fCode">Clinic Code <span class="mandatory">*</span></label>
                            <input type="text" class="form-control " style="width:100%;" name="fCode" id="fCode" placeholder="Clinic Code" title="Please enter clinic code" value="<?php echo $facilityResult[0]['facility_code'];?>" <?php echo $disable;?>>
                          </div>
                      </div>
                    </div>
