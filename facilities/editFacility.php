			...
			<div class="box-body">
				...
				<form class="form-horizontal" method='post' name='editFacilityForm' id='editFacilityForm' autocomplete="off" enctype="multipart/form-data" action="editFacilityHelper.php">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<select class="form-control isRequired" id="facilityType" name="facilityType" title="Please select facility type" onchange="<?php echo ($sarr['sc_user_type'] == 'remoteuser') ? 'getFacilityUser()' : ''; ?>;getTestType(); showSignature(this.value);">
					...
					<div class="row" id="userDetails">
						<?php if (($facilityInfo[0]['facility_type'] == 1 || $facilityInfo[0]['facility_type'] == 4) && ($sarr['sc_user_type'] == 'remoteuser')) { ?>
