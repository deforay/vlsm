    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
	      ...
	      <?php if(isset($_SESSION['privileges']) && in_array("addVlFacilityMap.php", $_SESSION['privileges'])){ ?>
              ...
              <table id="facilityMapDataTable" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Health Centre Name</th>
									<?php if(isset($_SESSION['privileges']) && in_array("editVlFacilityMap.php", $_SESSION['privileges'])){ ?>
                  <th>Action</th>
									<?php } ?>
                </tr>
                </thead>
