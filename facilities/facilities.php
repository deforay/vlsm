    ...
    <section class="content">
      <div class="row">
	    ...
	    <span style="display: none;position:absolute;z-index: 9999 !important;color:#000;padding:5px;margin-left: 325px;" id="showhide" class="">
	      ...
	      <?php if(isset($_SESSION['privileges']) && in_array("addFacility.php", $_SESSION['privileges']) && ((USERTYPE=='remoteuser') || (USERTYPE=='standalone'))){ ?>
		  ...
		  <th>Facility Code</th>
                  ...
                  <th>Facility Type</th>
                  <th>Status</th>
		  <?php if(isset($_SESSION['privileges']) && in_array("editFacility.php", $_SESSION['privileges']) && ((USERTYPE=='remoteuser') || (USERTYPE=='standalone'))){ ?>
                  <th>Action</th>
		  <?php } ?>
                </tr>
                </thead>
