...
if (isset($_SESSION['vlMonitoringThresholdReportQuery']) && trim((string) $_SESSION['vlMonitoringThresholdReportQuery']) != "") {
    ...
    $sheet->setCellValue('A1', html_entity_decode('Viral Load Testing Target ', ENT_QUOTES, 'UTF-8'));
