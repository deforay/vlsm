...
foreach ($rResult as $aRow) {
    $status = '<select class="form-control" name="status[]" id="' . $aRow['failure_id'] . '" title="' . _("Please select status") . '" onchange="updateStatus(this,\'' . $aRow['status'] . '\')">
    ...
    $row[] = '<a href="edit-vl-test-failure-reason.php?id=' . base64_encode($aRow['failure_id']) . '" class="btn btn-primary btn-xs" style="margin-right: 2px;" title="' . _("Edit") . '"><i class="fa-solid fa-pen-to-square"></i> ' . _("Edit") . '</i></a>';
    $output['aaData'][] = $row;
}
