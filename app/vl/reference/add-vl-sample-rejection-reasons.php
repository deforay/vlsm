						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<select class="form-control select2 editableSelect" id="rejectionType" name="rejectionType" placeholder="<?php echo _translate('Rejection Type'); ?>" title="<?php echo _translate('Please enter Rejection Type'); ?>">
										</select>
									</div>
								</div>
							</div>
