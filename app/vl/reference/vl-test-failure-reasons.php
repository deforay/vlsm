            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <a href="javascript:void(0);" onclick="setCurrentDateTime('<?php echo base64_encode('r_vl_test_failure_reasons');?>')" class="btn btn-success pull-right" style="margin-left: 10px;"> <em class="fa-solid fa-refresh"></em></a>
