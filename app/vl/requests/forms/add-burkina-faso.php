                                        ...
                                        <div class="box box-primary">
                                             ...
                                             <div class="box-body">
                                                  <div class="row">
                                                       ...
                                                       <div class="col-xs-3 col-md-3">
                                                            <div class="form-group" style=" width: 100%; ">
                                                                <label for=""><?= _translate("Duration of treatment");?> </label>
                                                                <select class="form-control" id="treatPeriod" name="treatPeriod" placeholder="Select Treatment Period" title="Please select how long has this patient been on treatment" onchange="treatmentDuration(this.value)">
                                                                    <option value=""> -- <?= _translate("Select");?> -- </option>
                                                                ...
                                                                <input type="text" class="form-control" name="treatPeriodMorethen12" id="treatPeriodMorethen12" placeholder="Enter treatment period" title="Please enter treatment period" style="width:100%;display:none;margin-top:2px;">
                                                            </div>
                                                       </div>
                                                    </div>
                                                    <div class="row">
                                                       <div class="col-xs-3 col-md-3">
                                                            <div class="form-group" style=" width: 100%; ">
                                                                <label for="cd4Count"><?= _translate("Latest CD4 count");?> <small>(cells/µl)</small></label>
                                                                <input type="text" class="form-control" name="cd4Count" id="cd4Count" placeholder="Enter CD4 count" title="Please enter CD4 count" style="width:100%;margin-top:2px;">
                                                            </div>
                                                       </div>
                                                       <div class="col-xs-3 col-md-3">
                                                            <div class="form-group" style=" width: 100%; ">
                                                       ...
                                                       <div class="col-xs-3 col-md-3">
                                                            <div class="form-group" style=" width: 100%; ">
                                                                <label for="cdDate"><?= _translate("Date");?> </label>
                                                                <input type="text" class="form-control date" name="cdDate" id="cdDate" placeholder="Enter CD Date" title="Please enter CD Date" style="width:100%;margin-top:2px;">
                                                            </div>
                                                       </div>
                                                  </div>
                                                  <div class="row">
                                                       <div class="col-xs-3 col-md-3">
                                                            <div class="form-group" style=" width: 100%; ">
                                                                <label for="hiv1Result"><?= _translate("Last HIV-1 Viral Load");?> <small>(copies/ml)</small></label>
                                                                <input type="text" class="form-control" name="hiv1Result" id="hiv1Result" placeholder="Enter CD4 count" title="Please enter HIV-1 Result" style="width:100%;margin-top:2px;">
                                                            </div>
                                                       </div>
                                                       <div class="col-xs-3 col-md-3">
                                                            <div class="form-group" style=" width: 100%; ">
                                                                <label for="hiv1Date"><?= _translate("Date");?> </label>
                                                                <input type="text" class="form-control date" name="hiv1Date" id="hiv1Date" placeholder="Enter HIV-1 Date" title="Please enter HIV-1 Date" style="width:100%;margin-top:2px;">
                                                            </div>
                                                       </div>
                                                  </div>
                                             </div>
...
<script>
     ...
     function treatmentDuration(value) {
          if (value == "More then 12 Months") {
               $('#treatPeriodMorethen12').show();
            }else{
              $('#treatPeriodMorethen12').hide();
          }
     }
