							...
							<div class="box-body">
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									...
									<tr>
										...
										<td>
											<label class="radio-inline">
												<input type="radio" class="" id="firstLine" name="lineOfTreatment" value="1" <?php echo ($vlQueryInfo['line_of_treatment'] == 1) ? 'checked="checked"' : ''; ?> title="Please check ART Line"> First Line
											</label><br>
											<label class="radio-inline">
												<input type="radio" class="" id="secondLine" name="lineOfTreatment" value="2" <?php echo ($vlQueryInfo['line_of_treatment'] == 2) ? 'checked="checked"' : ''; ?> title="Please check ART Line"> Second Line
											</label>
										</td>
										<td class="labels">
									...
									<tr>
										...
										<td class="rejectionReason" style="display: <?php echo ($vlQueryInfo['is_sample_rejected'] == 'yes') ? "" : "none"; ?>"><input value="<?php echo DateUtility::humanReadableDateFormat($vlQueryInfo['rejection_on']); ?>" class="form-control date rejection-date" type="text" name="rejectionDate" id="rejectionDate" placeholder="Select Rejection Date" /></td>
									</tr>
									<tr>
