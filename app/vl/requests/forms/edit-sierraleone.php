...
$newValue = "";
$treatmentInd = explode("_", (string) $vlQueryInfo['treatment_indication']);
if (isset($treatmentInd[1]) && $treatmentInd[1] == "Other") {
									...
									<div class="col-xs-3 col-md-3">
										<div class="form-group">
											...
											<label class="radio-inline" style="margin-left:0px;">
												<input type="radio" class="isRequired" id="genderMale" name="gender" value="male" title="Please choose sex" <?php echo ($vlQueryInfo['patient_gender'] == 'male') ? "checked='checked'" : "" ?>> Male
											</label>
											<label class="radio-inline" style="margin-left:0px;">
												<input type="radio" class="isRequired" id="genderFemale" name="gender" value="female" title="Please choose sex" <?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "checked='checked'" : "" ?>> Female
											</label>
											<label class="radio-inline" style="margin-left:0px;">
												<input type="radio" class="isRequired" id="genderUnreported" name="gender" value="unreported" title="Please choose sex" <?php echo ($vlQueryInfo['patient_gender'] == 'unreported') ? "checked='checked'" : "" ?>> Unreported
											</label>
										</div>
									</div>
									<div class="col-xs-3 col-md-3">
								...
								<div class="box box-primary">
										...
										<div class="box-body">
												...
												<div class="col-md-6">
													<div class="form-group">
														<div class="col-lg-12">
															<label class="radio-inline">
																<?php
																$vlTestReasonQueryRow = "SELECT * from r_vl_test_reasons where test_reason_id=? OR test_reason_name = ?";
																$vlTestReasonResultRow = $db->rawQuery($vlTestReasonQueryRow, [trim((string) $vlQueryInfo['reason_for_vl_testing']), trim((string) $vlQueryInfo['reason_for_vl_testing'])]);
																$checked = '';
																$display = '';
																if (trim((string) $vlQueryInfo['reason_for_vl_testing']) == $vlTestReasonResultRow[0]['test_reason_id']) {
											...
											<div class="row repeatTesting hideTestData" style="display: <?php echo $display; ?>;">
												...
												<div class="col-md-4">
													...
													<div class="col-lg-7 resultInputContainer">
														<input list="repeatTestingPossibleVlResults" class="form-control" id="repeatTestingVlValue" name="repeatTestingVlValue" placeholder="Select or Type VL Result" title="Please enter viral load result" value="<?= ($vlQueryInfo['last_vl_result_failure_ac']); ?>">
											...
											<div class="row suspendTreatment hideTestData" style="display: <?php echo $display; ?>;">
												...
												<div class="col-md-4">
													...
													<div class="col-lg-7 resultInputContainer">
														<input list="suspendTreatmentPossibleVlResults" class="form-control" id="suspendTreatmentVlValue" name="suspendTreatmentVlValue" placeholder="Select or Type VL Result" title="Please enter viral load result" value="<?= ($vlQueryInfo['last_vl_result_failure']); ?>">
									...
									<?php if (_isAllowed('/vl/results/vlTestResult.php') && $_SESSION['accessType'] != 'collection-site') { ?>
										...
										<div class="box-body labSectionBody">
											...
											<div class="row">
												<div class="col-md-4">
													<label class="col-lg-5 control-label" for="sampleReceivedAtHubOn">Date Sample Received at Hub </label>
													<div class="col-lg-7">
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="col-lg-7">
													<textarea class="form-control labSection" name="labComments" id="labComments" placeholder="Lab comments" style="width:100%"><?php echo trim((string) $vlQueryInfo['lab_tech_comments']); ?></textarea>
												</div>
											</div>
