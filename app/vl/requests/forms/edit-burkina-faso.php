...
<div class="content-wrapper">
     ...
     <section class="content">
          ...
          <div class="box box-default">
               ...
               <div class="box-body">
                    <!-- form start -->
                    <form class="form-inline" method="post" name="vlRequestFormFasco" id="vlRequestFormFasco" autocomplete="off" action="editVlRequestHelper.php">
                         <div class="box-body">
                                             ...
                                             <div class="col-xs-4 col-md-4">
                                                  <div class="form-group" style=" width: 100%; ">
                                                       <label for="sampleReordered">
                                                            <input type="checkbox" class="" id="sampleReordered" name="sampleReordered" value="yes" <?php echo (trim((string) $vlQueryInfo['sample_reordered']) == 'yes') ? 'checked="checked"' : '' ?> title="Please indicate if this is a reordered sample"> <?= _translate("Sample Reordered") ?>
                                                       </label>
                                                  </div>
                                             </div>
                                        </div>
                                        ...
                                        <div class="row">
                                             <div class="col-xs-4 col-md-4">
                                                  <div class="form-group" style=" width: 100%; ">
                                                       ...
                                                       <input type="text" value="<?php echo $vlQueryInfo['test_request_date']; ?>" class="form-control date" readonly name="testRequestDate" id="testRequestDate" title="<?= _translate("Please enter the test request date"); ?>" placeholder="<?= _translate("Test request date"); ?>" style="width:100%;" />
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                              ...
                              <div class="box box-primary">
                                   ...
                                   <div class="box-body">
                                        <div class="row">
                                             ...
                                             <div class="col-xs-3 col-md-3">
                                                  <div class="form-group" style=" width: 100%; ">
                                                       <label for="ageInMonths"><?= _translate("If Age < 1, Age in Months"); ?></label> <input type="text" name="ageInMonths" id="ageInMonths" class="form-control forceNumeric" maxlength="2" placeholder="Age in Month" title="Enter age in months" value="<?= ($vlQueryInfo['patient_age_in_months']); ?>" />
                                                  </div>
                                             </div>
                                        </div>
                                        <div class="row">
                                             ...
                                             <div class="col-xs-3 col-md-3">
                                                  <div class="form-group" style=" width: 100%; ">
                                                       ...
                                                       <select class="form-control ajax-select2" id="gender" name="gender" placeholder="Sex" style="width:100%;">
                                                            <option value="">-- Select --</option>
                                             ...
                                             <div class="col-xs-3 col-md-3 femaleSection" style="display:<?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "" : "none" ?>">
                                                  <div class="form-group">
                                                       ...
                                                       <label class="radio-inline">
                                                            <input type="radio" class="<?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "isRequired" : ""; ?>" id="pregNo" name="patientPregnant" value="no" <?php echo ($vlQueryInfo['is_patient_pregnant'] == 'no') ? "checked='checked'" : "" ?>> <?= _translate('No'); ?>
                                                       </label>
                                                  </div>
                                             </div>
                                             <div class="col-xs-3 col-md-3 femaleSection" style="display:<?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "" : "none" ?>">
                                                  <div class="form-group">
                                                       ...
                                                       <label class="radio-inline">
                                                            <input type="radio" class="" id="breastfeedingYes" name="breastfeeding" value="yes" title="<?= _translate('Please check if patient is breastfeeding'); ?>" <?php echo ($vlQueryInfo['is_patient_breastfeeding'] == 'yes') ? "checked='checked'" : "" ?>> <?= _translate('Yes'); ?>
                                                       </label>
                                                       <label class="radio-inline">
                                             ...
                                             <div class="row">
                                                  ...
                                                  <div class="col-xs-3 col-md-3">
                                                       <div class="form-group" style=" width: 100%; ">
                                                            ...
                                                            <input type="text" value="<?php echo $vlQueryInfo['sample_dispatched_datetime']; ?>" class="form-control isRequired dateTime" style="width:100%;" name="sampleDispatchedDate" id="sampleDispatchedDate" placeholder="Sample Dispatched On" title="Please select sample dispatched on">
                                                       </div>
                                                  </div>
                                                  <div class="col-xs-3 col-md-3">
                                                       <div class="form-group" style=" width: 100%; ">
                                                  ...
                                                  <div class="row">
                                                       <div class="col-xs-3 col-md-3">
                                                            <div class="form-group" style=" width: 100%; ">
                                                                 ...
                                                                 <input type="text" class="form-control" name="cd4Result" id="cd4Result" placeholder="Enter CD4 count" title="Please enter CD4 count" style="width:100%;margin-top:2px;" value="<?php echo $vlQueryInfo['last_cd4_result']; ?>">
                                                            </div>
                                                       </div>
                                                       <div class="col-xs-3 col-md-3">
                                                            <div class="form-group" style=" width: 100%; ">
                                                                 <label for="cd4Percentage"><?= _translate("CD4 (%)"); ?> </label>
                                                                 <input type="text" class="form-control" name="cd4Percentage" id="cd4Percentage" placeholder="Enter CD4 %" title="Please enter CD4 %" style="width:100%;margin-top:2px;" value="<?php echo $vlQueryInfo['last_cd4_percentage']; ?>">
                                                            </div>
                                                       </div>
                                                       <div class="col-xs-3 col-md-3">
                                                            <div class="form-group" style=" width: 100%; ">
                                                                 <label for="cd4Date"><?= _translate("Date"); ?> </label>
                                                                 <input type="text" class="form-control date" name="cd4Date" id="cd4Date" placeholder="Enter CD Date" title="Please enter CD Date" style="width:100%;margin-top:2px;" value="<?php echo DateUtility::humanReadableDateFormat($vlQueryInfo['last_cd4_date'] ?? '', true); ?>">
                                                            </div>
                                                       </div>
                                                  </div>
                                                  <div class="row">
                                                       ...
                                                       <div class="col-xs-3 col-md-3">
                                                            <div class="form-group" style=" width: 100%; ">
                                                                 ...
                                                                 <input type="text" class="form-control date" name="cd8Date" id="cd8Date" placeholder="Enter HIV-1 Date" title="Please enter HIV-1 Date" style="width:100%;margin-top:2px;" value="<?php echo DateUtility::humanReadableDateFormat($vlQueryInfo['last_cd8_date'] ?? '', true); ?>">
                                                            </div>
                                                       </div>
                                                  </div>
                                             </div>
