...
$pdQuery = "SELECT * FROM geographical_divisions
               WHERE geo_parent = 0 and geo_status='active'";
...
$vlQueryInfo['sample_received_at_vl_lab_datetime'] = DateUtility::humanReadableDateFormat($vlQueryInfo['sample_received_at_vl_lab_datetime'] ?? '', true);
