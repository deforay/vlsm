...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="box box-default">
			...
			<div class="box-body">
				<!-- form start -->
				<form class="form-horizontal" method="post" name="updateVlRequestForm" id="updateVlRequestForm"
							...
							<div class="box-body">
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									<tr>
										...
										<td>
											<input type="text" class="form-control" id="sampleCode" name="sampleCode"
												placeholder="Échantillon id" title="Please enter échantillon id" <?php echo $disable; ?>
									...
									<tr>
										...
										<td>
											<select class="form-control" name="province" id="province"
												title="Please choose province" <?php echo $disable; ?>
												style="width:100%;">
										...
										<td>
											<select class="form-control" name="district" id="district"
												title="Please choose district" <?php echo $disable; ?>
												style="width:100%;">
												<option value=""> -- Sélectionner -- </option>
												<?php
										...
										<td>
											<select class="form-control" name="clinicName" id="clinicName"
												title="Please choose service provider" <?php echo $disable; ?>
												style="width:100%;">
												<?= $facility; ?>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<input type="text" class="form-control" id="clinicianName"
												name="clinicianName" placeholder="Demandeur"
												title="<?= _("Please enter requesting clinician name"); ?>" <?php echo $disable; ?>
												value="<?php echo $vlQueryInfo['request_clinician_name']; ?>"
												style="width:100%;" />
										</td>
										<td><label for="clinicanTelephone">Téléphone </label></td>
										<td>
											<input type="text" class="form-control forceNumeric" id="clinicanTelephone"
												name="clinicanTelephone" placeholder="Téléphone"
												title="<?= _("Please enter phone number"); ?>" <?php echo $disable; ?>
										...
										<td>
											...
											<select class="form-control" name="implementingPartner"
												...
												title="Please choose partenaire de mise en œuvre" <?php echo $disable; ?> style="width:100%;">
												<option value=""> -- Sélectionner -- </option>
												<?php
									...
									<tr>
										...
										<td>
											<input type="text" class="form-control date" id="dateOfDemand"
												...
												title="Please enter date de la demande" <?php echo $disable; ?>
										...
										<td>
											<select class="form-control" name="fundingSource" id="fundingSource"
												title="Please choose source de financement" <?php echo $disable; ?>
												style="width:100%;">
												<option value=""> -- Sélectionner -- </option>
												<?php
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									...
									<tr>
										...
										<td style="width:35%;">
											...
											<label class="radio-inline"
												style="width:4%;padding-bottom:22px;margin-left:0;">
												<input type="radio" class="" id="genderFemale" name="gender" <?php echo $disable; ?> value="female"
										...
										<td style="width: 35%; !important;">
											...
											<label class="radio-inline"
												...
												<input type="radio" class="" id="changedRegimenYes"
													...
													title="Please check any of one option" <?php echo $disable; ?> <?php echo (trim($vlQueryInfo['has_patient_changed_regimen']) == "yes") ? 'checked="checked"' : ''; ?>>
											</label>
									...
									<tr>
										...
										<td style="width: 35%; !important;">
											<input type="text" class="form-control date" id="lastViralLoadTestDate"
												...
												placeholder="<?= _("Please enter date"); ?>"
												title="Please enter date dernière charge virale" <?php echo $disable; ?>
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									<tr>
										...
										<td>
											<input type="text" class="form-control dateTime" id="sampleCollectionDate"
												name="sampleCollectionDate" placeholder="<?= _("Please enter date"); ?>"
												title="Please enter date du prélèvement" <?php echo $disable; ?>
										...
										<tr>
											...
											<td>
												<select name="specimenType" id="specimenType" class="form-control"
													title="Please choose type déchantillon" <?php echo $disable; ?>
													style="width:100%;">
													<option value=""> -- Sélectionner -- </option>
													<?php
									...
									<tr class="plasmaElement"
										...
										<td>
											<input type="text" class="form-control forceNumeric"
												...
												title="Please enter température de conservation" <?php echo $disable; ?>
										...
										<td>
											<input type="text" class="form-control" id="durationOfConservation"
												...
												title="Please enter durée de conservation" <?php echo $disable; ?>
									...
									<tr>
										...
										<td>
											<input type="text" class="form-control dateTime"
												id="dateDispatchedFromClinicToLab" name="dateDispatchedFromClinicToLab"
												placeholder="<?= _("Please enter date"); ?>"
												title="Please enter date de départ au Labo biomol" <?php echo $disable; ?> value="<?php echo $vlQueryInfo['sample_dispatched_datetime']; ?>"
												style="width:100%;" />
										</td>
										<td></td>
										<td></td>
							...
							<div class="box-body">
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									<tr style="<?php echo ($sCode != '') ? 'display:none' : ''; ?>">
										<td><label for="">Date de réception de l'échantillon <span
													class="mandatory">*</span> </label></td>
										<td>
											<input type="text" class="form-control dateTime isRequired"
												id="sampleReceivedOn<?php echo ($sCode != '') ? 'Lab' : ''; ?>"
												name="sampleReceivedOn<?php echo ($sCode != '') ? 'Lab' : ''; ?>"
												placeholder="<?= _("Please enter date"); ?>"
									...
									<tr>
										<td><label for="">Date de réalisation de la charge virale <span
													class="mandatory">*</span></label></td>
										<td>
											<input type="text" class="form-control dateTime isRequired"
										...
										<td><label for="testingPlatform">Technique utilisée <span
													class="mandatory">*</span></label></td>
										<td>
									...
									<tr>
										...
										<td>
											<select class="form-control result-focus isRequired" id="noResult"
												name="noResult" title="<?= _('Please select if sample is rejected'); ?>"
												<?php echo $labFieldDisabled; ?> onchange="checkTestStatus();"
												style="width:100%;">
												<option value=""> -- Sélectionner -- </option>
									...
									<tr class="rejectionReason"
										...
										<td><label for="rejectionReason">Motifs de rejet <span
													class="mandatory">*</span></label></td>
										<td>
											<select class="form-control" id="rejectionReason" name="rejectionReason"
												title="<?= _('Please select reason for rejection'); ?>" <?php echo $labFieldDisabled; ?> onchange="checkRejectionReason();"
												style="width:100%;">
												<option value=""> -- Sélectionner -- </option>
									...
									<tr class="vlResult"
										...
										<td class="vlResult resultInputContainer">
											<input list="possibleVlResults"
												...
												title="Please enter résultat"
												value="<?= htmlspecialchars($vlQueryInfo['result']); ?>"
												oninput="calculateLogValue(this)">
										...
										<td class="vlLog">
											<input type="text" class="form-control forceNumeric other-failed-results"
												...
												value="<?= htmlspecialchars($vlQueryInfo['result_value_log']); ?>" <?php echo $labFieldDisabled; ?> oninput="calculateLogValue(this)"
												style="width:100%;" />&nbsp;(copies/ml)
										</td>
									</tr>
									...
									<?php } ?>
									<tr>
										<td style="width:14%;"><label for="reviewedOn">Revu le <span
													class="mandatory">*</span></label></td>
										<td style="width:14%;">
											<input type="text" name="reviewedOn"
												value="<?php echo $vlQueryInfo['result_reviewed_datetime']; ?>"
												id="reviewedOn" class="dateTime form-control isRequired"
												placeholder="Revu le" title="Please enter the Revu le" />
										</td>
										<td style="width:14%;"><label for="reviewedBy">Revu par <span
													class="mandatory">*</span></label></td>
										<td style="width:14%;">
											<select name="reviewedBy" id="reviewedBy"
												class="select2 form-control isRequired" title="Please choose revu par"
												style="width: 100%;">
									...
									<tr>
										...
										<td>
											<input type="text" name="approvedOnDateTime" id="approvedOnDateTime"
												...
												class="dateTime form-control isRequired" placeholder="Approuvé le"
									...
									<tr>
										...
										<td class="reasonForResultChanges" style="display:<?php if ($reasonChange != "")
											...
											<textarea class="form-control" name="reasonForResultChanges"
												...
												style="width:100%;"><?php if ($reasonChange != "")
													echo $reasonChange; ?></textarea>
										</td>
									</tr>
								</table>
							</div>
					...
					<div class="box-footer">
						...
						<input type="hidden" id="dubPatientArtNo" name="dubPatientArtNo"
							value="<?= htmlspecialchars($vlQueryInfo['patient_art_no']); ?>" />
						...
						<input type="hidden" id="vlSampleId" name="vlSampleId"
							value="<?= htmlspecialchars($vlQueryInfo['vl_sample_id']); ?>" />
