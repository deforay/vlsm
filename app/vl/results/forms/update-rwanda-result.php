							...
							<div class="row">
								<div class="col-xs-3 col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control isRequired" id="sampleCode" name="sampleCode" placeholder="Enter Sample ID" title="<?= _translate("Please make sure you have selected Sample Collection Date and Requesting Facility"); ?>" value="<?= ($vlQueryInfo['sample_code']); ?>" <?php echo $disable; ?> style="width:100%;" />
									</div>
								</div>
								<div class="col-xs-3 col-md-3">
									<div class="form-group">
					...
					<div class="box box-primary">
							...
							<div class="row">
								<div class="col-xs-3 col-md-3">
									<div class="form-group">
										...
										<input type="text" name="artNo" id="artNo" class="form-control isRequired" placeholder="Enter ART Number" title="Enter art number" value="<?= ($vlQueryInfo['patient_art_no']); ?>" <?php echo $disable; ?> />
									</div>
								</div>
								<div class="col-xs-3 col-md-3">
									<div class="form-group">
										<label for="dob">Date of Birth <span class="mandatory">*</span></label>
										<input type="text" name="dob" id="dob" class="form-control date isRequired" placeholder="Enter DOB" title="Enter dob" value="<?= ($vlQueryInfo['patient_dob']); ?>" <?php echo $disable; ?> />
									</div>
								</div>
								<div class="col-xs-3 col-md-3">
									<div class="form-group">
								...
								<div class="col-xs-3 col-md-3">
									<div class="form-group">
										...
										<label class="radio-inline" style="margin-left:0px;">
											<input type="radio" class="isRequired" id="genderMale" name="gender" value="male" title="Please choose sex" <?php echo $disable; ?> <?php echo ($vlQueryInfo['patient_gender'] == 'male') ? "checked='checked'" : "" ?>> Male
										</label>&nbsp;&nbsp;
										<label class="radio-inline" style="margin-left:0px;">
											<input type="radio" id="genderFemale" name="gender" value="female" title="Please choose sex" <?php echo $disable; ?> <?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "checked='checked'" : "" ?>> Female
										</label>
										<!--<label class="radio-inline" style="margin-left:0px;">
							<input type="radio" class="" id="genderNotRecorded" name="gender" value="not_recorded" title="Please choose sex" < ?php echo $disable;?> < ?php echo ($vlQueryInfo['patient_gender']=='not_recorded')?"checked='checked'":""?>>Not Recorded
						  </label>-->
									</div>
								</div>
								<div class="col-xs-3 col-md-3">
						...
						<div class="box box-primary">
							...
							<div class="box box-primary">
									...
									<div class="row">
										...
										<div class="col-xs-3 col-md-3">
											<div class="form-group">
												...
												<input type="text" class="form-control date <?php echo ($general->isSTSInstance()) ? "isRequired" : ''; ?>" style="width:100%;" name="regimenInitiatedOn" id="regimenInitiatedOn" placeholder="Current Regimen Initiated On" title="Please enter current regimen initiated on" <?php echo $disable; ?> value="<?php echo $vlQueryInfo['date_of_initiation_of_current_regimen']; ?>">
											</div>
										</div>
										<div class="col-xs-3 col-md-3">
											<div class="form-group">
									...
									<div class="row femaleSection" style="display:<?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "" : "none" ?>" ;>
										<div class="col-xs-3 col-md-3">
											<div class="form-group">
												...
												<label class="radio-inline">
													<input type="radio" class="<?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "isRequired" : ""; ?>" id="pregYes" name="patientPregnant" value="yes" title="Please check if patient is pregnant" <?php echo $disable; ?> <?php echo ($vlQueryInfo['is_patient_pregnant'] == 'yes') ? "checked='checked'" : "" ?>> Yes
												</label>
												<label class="radio-inline">
										...
										<div class="col-xs-3 col-md-3">
											<div class="form-group">
												...
												<label class="radio-inline">
													<input type="radio" class="<?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "isRequired" : ""; ?>" id="breastfeedingYes" name="breastfeeding" value="yes" title="Please check if patient is breastfeeding" <?php echo $disable; ?> <?php echo ($vlQueryInfo['is_patient_breastfeeding'] == 'yes') ? "checked='checked'" : "" ?>> Yes
												</label>
												<label class="radio-inline">
								...
								<div class="box box-primary">
									<div class="box-header with-border">
										<h3 class="box-title">Indication for Viral Load Testing <span class="mandatory">*</span></h3><small> (Please tick one):(To be
									...
									<div class="box-body">
										...
										<div class="row suspendTreatment hideTestData" style="display: <?php echo $display; ?>;">
											...
											<div class="col-md-6">
												...
												<div class="col-lg-7">
													...
													< 20<br>
														<input type="checkbox" id="suspendTreatmentVlCheckValueTnd" name="suspendTreatmentVlCheckValue" <?php echo ($vlQueryInfo['last_vl_result_failure'] == 'tnd') ? 'checked="checked"' : ''; ?> value="tnd" <?php echo $disable; ?> title="Please check VL Result"> Target Not
														Detected
												</div>
											</div>
										</div>
										...
										<div class="row repeatTesting hideTestData" style="display: <?php echo $display; ?>;">
											...
											<div class="col-md-6">
												...
												<div class="col-lg-7">
													...
													< 20<br>
														<input type="checkbox" id="repeatTestingVlCheckValueTnd" name="repeatTestingVlCheckValue" <?php echo ($vlQueryInfo['last_vl_result_failure_ac'] == 'tnd') ? 'checked="checked"' : ''; ?> value="tnd" <?php echo $disable; ?> title="Please check VL Result"> Target Not
														Detected
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-4">
												...
												<div class="col-lg-7">
													<input type="text" class="form-control <?php echo ($general->isSTSInstance()) ? "isRequired" : ''; ?>" id="reqClinician" name="reqClinician" placeholder="Requesting Clinician" title="Please enter request clinician" value="<?php echo $vlQueryInfo['request_clinician_name']; ?>" <?php echo $disable; ?> />
												</div>
											</div>
											<div class="col-md-4">
											...
											<div class="col-md-4">
												...
												<div class="col-lg-7">
													<input type="text" class="form-control date <?php echo ($general->isSTSInstance()) ? "isRequired" : ''; ?>" id="requestDate" name="requestDate" placeholder="Request Date" title="Please select request date" value="<?php echo $vlQueryInfo['test_requested_on']; ?>" <?php echo $disable; ?> />
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-4">
												...
												<div class="col-lg-7">
													<input type="text" class="form-control <?php echo ($general->isSTSInstance()) ? "isRequired" : ''; ?>" id="vlFocalPerson" name="vlFocalPerson" placeholder="VL Focal Person" title="Please enter vl focal person name" value="<?= ($vlQueryInfo['vl_focal_person']); ?>" <?php echo $disable; ?> />
												</div>
											</div>
											<div class="col-md-4">
												...
												<div class="col-lg-7">
													<input type="text" class="form-control phone-number <?php echo ($general->isSTSInstance()) ? "isRequired" : ''; ?>" id="vlFocalPersonPhoneNumber" name="vlFocalPersonPhoneNumber" maxlength="15" placeholder="Phone Number" title="Please enter vl focal person phone number" value="<?= ($vlQueryInfo['vl_focal_person_phone_number']); ?>" <?php echo $disable; ?> />
												</div>
											</div>
											<div class="col-md-4">
										...
										<div class="box-body">
											<div class="row">
												...
												<div class="col-md-4">
													...
													<div class="col-lg-7">
														<select name="testingPlatform" id="testingPlatform" class="isRequired form-control labSection" title="Please choose VL Testing Platform" onchange="hivDetectionChange();">
															<option value="">-- Select --</option>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<label class="col-lg-3 control-label" for="labComments">Lab Tech.
														Comments </label>
													<div class="col-lg-9">
														<textarea class="form-control labSection" name="labComments" id="labComments" placeholder="Lab comments"><?php echo trim((string) $vlQueryInfo['lab_tech_comments']); ?></textarea>
													</div>
												</div>
