								...
								<div class="col-xs-3 col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control isRequired" id="sampleCode"
											name="sampleCode" placeholder="Enter Sample ID"
											title="Please enter sample id" value="<?= ($vlQueryInfo['sample_code']); ?>"
							...
							<div class="row">
								<div class="col-xs-3 col-md-3">
									...
									<select class="form-control isRequired" name="province" id="province"
										title="Please choose province" <?php echo $disable; ?> style="width:100%;"
								...
								<div class="col-xs-3 col-md-3">
									...
									<select class="form-control isRequired" name="district" id="district"
										title="Please choose district" <?php echo $disable; ?> style="width:100%;"
								...
								<div class="col-xs-3 col-md-3">
									...
									<select class="form-control isRequired" id="fName" name="fName"
							...
							<div class="row">
								<div class="col-xs-3 col-md-3">
									<div class="form-group">
										...
										<input type="text" name="artNo" id="artNo" class="form-control isRequired"
								...
								<div class="col-xs-3 col-md-3">
									<div class="form-group">
										...
										<input type="text" name="dob" id="dob" class="form-control date isRequired"
								...
								<div class="col-xs-3 col-md-3">
									<div class="form-group">
										...
										<label class="radio-inline" style="margin-left:0px;">
											<input type="radio" class="isRequired" id="genderMale" name="gender"
												value="male" title="Please check gender" <?php echo $disable; ?> <?php echo ($vlQueryInfo['patient_gender'] == 'male') ? "checked='checked'" : "" ?>> Male
										</label>&nbsp;&nbsp;
										<label class="radio-inline" style="margin-left:0px;">
						...
						<div class="box box-primary">
								...
								<div class="row">
									<div class="col-xs-3 col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control isRequired" style="width:100%;"
									...
									<div class="col-xs-3 col-md-3">
										<div class="form-group">
											...
											<select name="specimenType" id="specimenType"
												class="form-control isRequired" title="Please choose sample type" <?php echo $disable; ?>>
												<option value=""> -- Select -- </option>
												<?php
							...
							<div class="box box-primary">
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-xs-3 col-md-3">
											<div class="form-group">
												<label for="artRegimen">Current Regimen
													<?php echo ($_SESSION['instanceType'] == 'remoteuser') ? "<span class='mandatory'>*</span>" : ''; ?>
												</label>
												<select
													class="form-control <?php echo ($_SESSION['instanceType'] == 'remoteuser') ? "isRequired" : ''; ?>"
													id="artRegimen" name="artRegimen" title="Please choose ART Regimen"
													<?php echo $disable; ?> style="width:100%;"
													onchange="checkARTValue();">
													<option value="">-- Select --</option>
										...
										<div class="col-xs-3 col-md-3">
											<div class="form-group">
												...
												<input type="text"
													class="form-control date <?php echo ($_SESSION['instanceType'] == 'remoteuser') ? "isRequired" : ''; ?>"
													style="width:100%;" name="regimenInitiatedOn"
													id="regimenInitiatedOn" placeholder="Current Regimen Initiated On"
										...
										<div class="col-xs-3 col-md-3">
											<div class="form-group">
												...
												<select name="arvAdherence" id="arvAdherence"
													class="form-control <?php echo ($_SESSION['instanceType'] == 'remoteuser') ? "isRequired" : ''; ?>"
									...
									<div class="row femaleSection"
										style="display:<?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "" : "none" ?>"
										;>
										<div class="col-xs-3 col-md-3">
											<div class="form-group">
												<label for="patientPregnant">Is Patient Pregnant? <span
														class="mandatory">*</span></label><br>
												<label class="radio-inline">
													<input type="radio"
														class="<?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "isRequired" : ""; ?>"
														id="pregYes" name="patientPregnant" value="yes"
														title="Please check if patient is pregnant" <?php echo $disable; ?> <?php echo ($vlQueryInfo['is_patient_pregnant'] == 'yes') ? "checked='checked'" : "" ?>> Yes
												</label>
												<label class="radio-inline">
													<input type="radio" id="pregNo" name="patientPregnant" value="no"
														<?php echo $disable; ?> <?php echo ($vlQueryInfo['is_patient_pregnant'] == 'no') ? "checked='checked'" : "" ?>> No
												</label>
											</div>
										</div>
										<div class="col-xs-3 col-md-3">
											<div class="form-group">
												<label for="breastfeeding">Is Patient Breastfeeding? <span
														class="mandatory">*</span></label><br>
												<label class="radio-inline">
													<input type="radio"
														class="<?php echo ($vlQueryInfo['patient_gender'] == 'female') ? "isRequired" : ""; ?>"
														id="breastfeedingYes" name="breastfeeding" value="yes"
														title="Please check if patient is breastfeeding" <?php echo $disable; ?> <?php echo ($vlQueryInfo['is_patient_breastfeeding'] == 'yes') ? "checked='checked'" : "" ?>> Yes
												</label>
												<label class="radio-inline">
													<input type="radio" id="breastfeedingNo" name="breastfeeding"
														value="no" <?php echo $disable; ?> <?php echo ($vlQueryInfo['is_patient_breastfeeding'] == 'no') ? "checked='checked'" : "" ?>> No
												</label>
											</div>
										</div>
									</div>
								...
								<div class="box box-primary">
									<div class="box-header with-border">
										<h3 class="box-title">Indication for Viral Load Testing <span
												class="mandatory">*</span></h3><small> (Please tick one):(To be
									...
									<div class="box-body">
												...
												<div class="form-group">
													<div class="col-lg-12">
														<label class="radio-inline">
															...
															?>
															<input type="radio" class="isRequired" id="rmTesting"
																name="reasonForVLTesting" value="routine"
																title="Please check viral load indication testing type"
											...
											<div class="col-md-6">
												...
												<div class="col-lg-7">
													<input type="text" class="form-control forceNumeric viralTestData"
														...
														value="<?php echo $vlValue; ?>" <?php echo $disable; ?> />
													(copies/ml)<br>
													<input type="checkbox" id="rmTestingVlCheckValuelt20"
														name="rmTestingVlCheckValue" <?php echo ($vlQueryInfo['last_vl_result_routine'] == '<20') ? 'checked="checked"' : ''; ?> value="<20" <?php echo $disable; ?>
														title="Please check VL Result">
													&lt; 20<br>
													<input type="checkbox" id="rmTestingVlCheckValueTnd"
														name="rmTestingVlCheckValue" <?php echo ($vlQueryInfo['last_vl_result_routine'] == 'tnd') ? 'checked="checked"' : ''; ?> value="tnd" <?php echo $disable; ?>
														title="Please check VL Result"> Target Not Detected
												</div>
											</div>
										</div>
										<div class="row">
												...
												<div class="form-group">
													<div class="col-lg-12">
														<label class="radio-inline">
															...
															?>
															<input type="radio" id="suspendTreatment"
											...
											<div class="col-md-6">
												...
												<div class="col-lg-7">
													...
													<input type="checkbox" id="suspendTreatmentVlCheckValuelt20"
														name="suspendTreatmentVlCheckValue" <?php echo ($vlQueryInfo['last_vl_result_failure'] == '<20') ? 'checked="checked"' : ''; ?> value="<20" <?php echo $disable; ?>
														title="Please check VL Result">
													< 20<br>
														<input type="checkbox" id="suspendTreatmentVlCheckValueTnd"
															name="suspendTreatmentVlCheckValue" <?php echo ($vlQueryInfo['last_vl_result_failure'] == 'tnd') ? 'checked="checked"' : ''; ?> value="tnd" <?php echo $disable; ?> title="Please check VL Result"> Target Not
														Detected
												</div>
											</div>
										</div>
												...
												<div class="form-group">
													<div class="col-lg-12">
														<label class="radio-inline">
															...
															?>
															<input type="radio" id="repeatTesting"
																name="reasonForVLTesting" value="failure"
																title="Please check viral load indication testing type"
																<?php echo $disable; ?> <?php echo $checked; ?>
																onclick="showTesting('repeatTesting');">
															<strong>Control VL test after adherence counselling
																addressing suspected treatment failure </strong>
														</label>
													</div>
												</div>
											</div>
											...
											<div class="col-md-6">
												...
												<div class="col-lg-7">
													<input type="text" class="form-control forceNumeric viralTestData"
														...
														value="<?php echo $vlValue; ?>" <?php echo $disable; ?> />
													(copies/ml)<br>
													<input type="checkbox" id="repeatTestingVlCheckValuelt20"
														name="repeatTestingVlCheckValue" <?php echo ($vlQueryInfo['last_vl_result_failure_ac'] == '<20') ? 'checked="checked"' : ''; ?> value="<20" <?php echo $disable; ?>
														title="Please check VL Result">
													< 20<br>
														<input type="checkbox" id="repeatTestingVlCheckValueTnd"
															name="repeatTestingVlCheckValue" <?php echo ($vlQueryInfo['last_vl_result_failure_ac'] == 'tnd') ? 'checked="checked"' : ''; ?> value="tnd" <?php echo $disable; ?> title="Please check VL Result"> Target Not
														Detected
												</div>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<div class="col-lg-12">
															<label class="radio-inline">
																<input type="radio" class="" id="recencyTest"
																	name="reasonForVLTesting" value="recency"
																	title="Please check viral load indication testing type"
																	<?php echo $disable; ?> 	<?php echo trim($vlQueryInfo['reason_for_vl_testing']) == '9999' ? "checked='checked'" : ""; ?>
																	onclick="showTesting('recency')">
										...
										<div class="row">
											<div class="col-md-4">
												...
												<div class="col-lg-7">
													<input type="text"
														class="form-control <?php echo ($_SESSION['instanceType'] == 'remoteuser') ? "isRequired" : ''; ?>"
														id="reqClinician" name="reqClinician"
														placeholder="Request Clinician"
											...
											<div class="col-md-4">
												<label for="reqClinicianPhoneNumber"
													class="col-lg-5 control-label">Phone Number
													<?php echo ($_SESSION['instanceType'] == 'remoteuser') ? "<span class='mandatory'>*</span>" : ''; ?>
												</label>
												<div class="col-lg-7">
													<input type="text"
														class="form-control forceNumeric <?php echo ($_SESSION['instanceType'] == 'remoteuser') ? "isRequired" : ''; ?>"
											...
											<div class="col-md-4">
												...
												<div class="col-lg-7">
													<input type="text"
														class="form-control date <?php echo ($_SESSION['instanceType'] == 'remoteuser') ? "isRequired" : ''; ?>"
														id="requestDate" name="requestDate" placeholder="Request Date"
										...
										<div class="row">
											<div class="col-md-4">
												...
												<div class="col-lg-7">
													<input type="text"
														...
														value="<?= ($vlQueryInfo['vl_focal_person']); ?>" <?php echo $disable; ?> />
												</div>
											</div>
											<div class="col-md-4">
												...
												<div class="col-lg-7">
													<input type="text"
														class="form-control forceNumeric <?php echo ($_SESSION['instanceType'] == 'remoteuser') ? "isRequired" : ''; ?>"
														id="vlFocalPersonPhoneNumber" name="vlFocalPersonPhoneNumber"
														maxlength="15" placeholder="Phone Number"
											...
											<div class="col-md-4">
												...
												<div class="col-lg-7">
													<input type="text" class="form-control" id="emailHf" name="emailHf"
														placeholder="Email for HF" title="Please enter email for hf"
								...
								<form class="form-inline" method="post" name="vlRequestFormRwd" id="vlRequestFormRwd"
									autocomplete="off" action="updateVlTestResultHelper.php">
									<div class="box box-primary">
										<div class="box-header with-border">
										...
										<div class="box-body">
												...
												<div class="col-md-4">
													...
													<div class="col-lg-7">
														<select name="labId" id="labId"
															class="isRequired form-control labSection"
												...
												<div class="col-md-4">
													...
													<div class="col-lg-7">
														<select name="testingPlatform" id="testingPlatform"
															class="isRequired form-control labSection"
															title="Please choose VL Testing Platform"
															onchange="hivDetectionChange();">
															<option value="">-- Select --</option>
															<?php foreach ($importResult as $mName) { ?>
																<option
																	value="<?php echo $mName['machine_name'] . '##' . $mName['lower_limit'] . '##' . $mName['higher_limit']; ?>"
												...
												<div class="col-md-4">
													<label class="col-lg-5 control-label"
														for="sampleTestingDateAtLab">Sample Testing Date <span
															class="mandatory">*</span> </label>
													<div class="col-lg-7">
														<input type="text" class="isRequired form-control labSection"
															id="sampleTestingDateAtLab" name="sampleTestingDateAtLab"
												...
												<div class="col-md-4 vlResult"
													...
													<div class="col-lg-7">
														<input type="text" class="form-control labSection" id="vlLog"
															...
															title="Please enter viral load log"
											...
											<div class="row">
												<div class="col-md-6">
													<label class="col-lg-3 control-label" for="labComments">Lab Tech.
														Comments </label>
													<div class="col-lg-9">
							...
							<div class="box-footer">
								...
								<input type="hidden" name="reasonForResultChangesHistory"
									...
									value="<?php echo $vlQueryInfo['reason_for_vl_result_changes']; ?>" />
