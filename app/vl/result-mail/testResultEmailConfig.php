      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header with-border">
            <a href="editTestResultEmailConfig.php" class="btn btn-default pull-right" style="margin-right:10px;"><em class="fa-solid fa-pen-to-square"></em></i> <?php echo _("Edit"); ?></a>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
