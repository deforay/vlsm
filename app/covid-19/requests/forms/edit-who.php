                                ...
                                <div class="box-body">
                                    ...
                                    <table class="table" aria-hidden="true"  style="width:100%">
                                                        ...
                                                        <?php if (isset($covid19TestInfo) && count($covid19TestInfo) > 0) {
                                                            foreach ($covid19TestInfo as $indexKey => $rows) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td><select class="form-control test-result test-result test-name-table-input result-focus" name="testResult[]" id="testResult<?php echo ($indexKey + 1); ?>" title="Please select the result for row <?php echo ($indexKey + 1); ?>">
                                                                            <option value=''> -- Select -- </option>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($covid19Info['authorized_on']); ?>" name="authorizedOn" id="authorizedOn" class="disabled-field form-control date" placeholder="Authorized on" /></td>
                                            <th scope="row"></th>
                                            <td></td>
                                        </tr>
                                        <!-- <tr>
