...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><em class="fa-solid fa-pen-to-square"></em> <?php echo _translate("WHO COVID-19 VIRUS LABORATORY TEST REQUEST FORM"); ?></h1>
        <ol class="breadcrumb">
            <li><a href="/"><em class="fa-solid fa-chart-pie"></em> <?php echo _translate("Home"); ?></a></li>
            <?php if (isset($covid19Info['result']) && $covid19Info['result'] != "") { ?>
                <li class="active"><?php echo _translate("View Request"); ?></li>
            <?php } else { ?>
                <li class="active"><?php echo _translate("Update Request"); ?></li>
            <?php } ?>
        </ol>
    </section>
    <!-- Main content -->
                            ...
                            <div class="box-body">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="row" style="width:15% !important">Has the patient had contact with a confirmed case? <span class="mandatory">*</span></th>
                                ...
                                <div class="box-body">
                                    ...
                                    <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" value="<?php echo DateUtility::humanReadableDateFormat($covid19Info['authorized_on']); ?>" name="authorizedOn" id="authorizedOn" class="disabled-field form-control date" placeholder="Authorized on" /></td>
                                            <th scope="row"></th>
                                            <td></td>
                                        </tr>
                                        <!-- <tr>
