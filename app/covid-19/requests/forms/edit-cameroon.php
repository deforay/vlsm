                            ...
                            <div class="box-body">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select2 isRequired " name="facilityId" id="facilityId" title="<?= _translate("Please choose service provider"); ?>" style="width:100%;" onchange="getfacilityProvinceDetails(this);">
                                                <?php echo $facility; ?>
                                            </select>
                                        </td>
                                    </tr>
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control" id="patientZone" value="<?php echo $covid19Info['patient_zone']; ?>" name="patientZone" placeholder="Case Payam" title="<?= _translate("Please enter the Case Payam"); ?>" style="width:100%;"></td>
