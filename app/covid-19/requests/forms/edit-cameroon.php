                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <td>
                                                <input type="text" readonly value="<?php echo $covid19Info[$sampleCode]; ?>" class="form-control isRequired" id="sampleCode" name="sampleCode" placeholder="<?= _("Sample ID"); ?>" title="<?= _("Please enter Sample ID"); ?>" style="width:100%;" onchange="" />
                                            </td>
                                        <?php } ?>
                                        ...
                                        <td class="show-alert-poe" style="<?php echo (isset($covid19Info['source_of_alert']) && $covid19Info['source_of_alert'] == 'others') ? "" : "display:none;"; ?>"><label for="sourceOfAlertPOE"><?= _("Source of Alert / POE Others"); ?><span class="mandatory">*</span></label></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select2 isRequired" name="province" id="province" title="<?= _("Please choose State"); ?>" onchange="getfacilityDetails(this);" style="width:100%;">
                                                <?php echo $province; ?>
                                            </select>
                                        </td>
                                        <td><label for="district"><?= _("Health Facility/POE County"); ?> </label><span class="mandatory">*</span></td>
                                        <td>
                                            <select class="form-control select2 isRequired" name="district" id="district" title="<?= _("Please choose County"); ?>" style="width:100%;" onchange="getfacilityDistrictwise(this);">
                                                <option value=""> <?= _("-- Select --"); ?> </option>
                                            </select>
                                        </td>
                                        <td><label for="facilityId"><?= _("Health Facility/POE"); ?> </label><span class="mandatory">*</span></td>
                                        <td>
                                            <select class="form-control select2 isRequired " name="facilityId" id="facilityId" title="<?= _("Please choose service provider"); ?>" style="width:100%;" onchange="getfacilityProvinceDetails(this);">
                                                <?php echo $facility; ?>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <?php if ($sarr['sc_user_type'] == 'remoteuser' && $_SESSION['accessType'] == 'collection-site') { ?>
                                            ...
                                            <td>
                                                <select name="labId" id="labId" class="form-control select2 isRequired" title="<?= _("Please select Testing Testing Laboratory"); ?>" style="width:100%;">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    <tr>
                                        ...
                                        <td style="width:35% !important">
                                            <input type="text" class="form-control isRequired" id="patientId" name="patientId" placeholder="<?= _("Identification"); ?>" title="<?= _("Please enter ID"); ?>" style="width:100%;" value="<?php echo $covid19Info['patient_id']; ?>" />
                                        </td>
                                        <th scope="row" style="width:15% !important"><label for="externalSampleCode"><?= _("DHIS2 Case ID"); ?> </label></th>
                                        <td style="width:35% !important"><input type="text" class="form-control" id="externalSampleCode" name="externalSampleCode" placeholder="<?= _("DHIS2 Case ID"); ?>" title="<?= _("Please enter DHIS2 Case ID"); ?>" style="width:100%;" value="<?php echo $covid19Info['external_sample_code']; ?>" /></td>
                                    </tr>
                                    <tr>
                                        <th scope="row" style="width:15% !important"><label for="firstName"><?= _("First Name"); ?> <span class="mandatory">*</span> </label></th>
                                        <td style="width:35% !important">
                                            <input type="text" class="form-control isRequired" id="firstName" name="firstName" placeholder="<?= _("First Name"); ?>" title="<?= _("Please enter Case first name"); ?>" style="width:100%;" value="<?php echo $covid19Info['patient_name']; ?>" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select2" name="patientDistrict" id="patientDistrict" title="<?= _("Please Case County"); ?>" style="width:100%;">
                                                <option value=""><?= _("--Select--"); ?></option>
                                            </select>
                                        </td>
                                        <th scope="row"><?= _("Payam"); ?></th>
                                        <td><input class="form-control" id="patientZone" value="<?php echo $covid19Info['patient_zone']; ?>" name="patientZone" placeholder="Case Payam" title="<?= _("Please enter the Case Payam"); ?>" style="width:100%;"></td>

                                    </tr>
                                    <tr>
                                        <th scope="row"><?= _("Boma/Village"); ?></th>
                                        <td><input class="form-control" value="<?php echo $covid19Info['patient_city']; ?>" id="patientCity" name="patientCity" placeholder="<?= _("Case Boma/Village"); ?>" title="<?= _("Please enter the Case Boma/Village"); ?>" style="width:100%;"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control" id="patientPassportNumber" name="patientPassportNumber" value="<?php echo $covid19Info['patient_passport_number']; ?>" placeholder="<?= _("Passport Number"); ?>" title="<?= _("Please enter Passport Number"); ?>" style="width:100%;"></td>
                                ...
                                <div class="box-body">
                                    ...
                                    <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" id="sampleReceivedDate" name="sampleReceivedDate" placeholder="<?= _("Please enter date"); ?>" title="<?= _("Please enter sample receipt date"); ?>" value="<?php echo DateUtility::humanReadableDateFormat($covid19Info['sample_received_at_vl_lab_datetime']) ?>" onchange="" style="width:100%;" />
                                            </td>
                                            <td class="lab-show"><label for="labId"><?= _("Testing Laboratory"); ?> </label> </td>
                                            <td class="lab-show">
                                                <select name="labId" id="labId" class="form-control" title="<?= _("Please select Testing Testing Laboratory"); ?>" style="width:100%;" onchange="getTestingPoints();">
                                                    <?= $general->generateSelectOptions($testingLabs, $covid19Info['lab_id'], '-- Select --'); ?>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control" id="specimenQuality" name="specimenQuality" title="<?= _("Please enter the specimen quality"); ?>">
                                                    <option value=""><?= _("--Select--"); ?></option>
                                            ...
                                            <td>
                                                <select name="labTechnician" id="labTechnician" class="form-control" title="<?= _("Please select a Lab Technician"); ?>" style="width:100%;">
                                                    <option value=""><?= _("--Select--"); ?></option>
                                        ...
                                        <tr class="show-rejection" style="display:none;">
                                            ...
                                            <td><input value="<?php echo DateUtility::humanReadableDateFormat($covid19Info['rejection_on']); ?>" class="form-control date rejection-date" type="text" name="rejectionDate" id="rejectionDate" placeholder="<?= _("Select Rejection Date"); ?>" title="<?= _("Please select the Rejection Date"); ?>" /></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                                                <table aria-describedby="table" class="table table-bordered table-striped" aria-hidden="true" id="testNameTable">
                                                            ...
                                                            foreach ($covid19TestInfo as $indexKey => $rows) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <select onchange="testMethodChanged(this.value,<?= ($indexKey + 1); ?>)" class="form-control test-name-table-input" id="testName<?= ($indexKey + 1); ?>" name="testName[]" title="<?= _("Please enter the name of the Testkit (or) Test Method used"); ?>">
                                                                            <option value=""><?= _("--Select--"); ?></option>
                                                                        ...
                                                                        <input <?php echo $value; ?> type="text" name="testNameOther[]" id="testNameOther<?= ($indexKey + 1); ?>" class="form-control testNameOther<?= ($indexKey + 1); ?>" title="<?= _("Please enter the name of the Testkit (or) Test Method used"); ?>" placeholder="<?= _("Enter Test Method used"); ?>" style="display: <?php echo $show; ?>;margin-top: 10px;" />
                                                                    </td>
                                                                    <td><input type="text" value="<?php echo DateUtility::humanReadableDateFormat($rows['sample_tested_datetime']); ?>" name="testDate[]" id="testDate<?= ($indexKey + 1); ?>" class="form-control test-name-table-input dateTime" placeholder="<?= _("Tested on"); ?>" title="<?= _("Please enter the tested on for row <?= ($indexKey + 1); ?>"); ?>" /></td>
                                                                    <td>
                                                                        <select name="testingPlatform[]" id="testingPlatform<?= ($indexKey + 1); ?>" class="form-control result-optional test-name-table-input" title="<?= _("Please select the Testing Platform for <?= ($indexKey + 1); ?>"); ?>">
                                                                    ...
                                                                    <td class="kitlabels" style="display: none;"><input type="text" value="<?php echo $rows['kit_lot_no']; ?>" name="lotNo[]" id="lotNo<?= ($indexKey + 1); ?>" class="form-control kit-fields<?= ($indexKey + 1); ?>" placeholder="<?= _("Kit lot no"); ?>" title="<?= _("Please enter the kit lot no. for row 1"); ?>" style="<?php echo $display; ?>" /></td>
                                                                    <td class="kitlabels" style="display: none;"><input type="text" value="<?php echo DateUtility::humanReadableDateFormat($rows['kit_expiry_date']); ?>" name="expDate[]" id="expDate<?= ($indexKey + 1); ?>" class="form-control expDate kit-fields<?= ($indexKey + 1); ?>" placeholder="<?= _("Expiry date"); ?>" title="<?= _("Please enter the expiry date for row 1"); ?>" style="<?php echo $display; ?>" /></td>
                                                                    <td><select class="form-control test-result test-name-table-input result-focus" name="testResult[]" id="testResult<?= ($indexKey + 1); ?>" title="<?= _("Please select the result for row <?= ($indexKey + 1); ?>"); ?>">
                                                                            <option value=''> <?= _("-- Select --"); ?> </option>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <th scope="row" colspan="<?php echo $span; ?>" class="text-right final-result-row"><?= _("Final Result"); ?></th>
                                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" value="<?php echo $covid19Info['result_reviewed_datetime']; ?>" name="reviewedOn" id="reviewedOn" class="dateTime disabled-field form-control" placeholder="<?= _("Reviewed on"); ?>" title="<?= _("Please enter the Reviewed on"); ?>" /></td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><?= _("Tested By"); ?></th>
                                            <td>
                                                <select name="testedBy" id="testedBy" class="select2 form-control" title="<?= _("Please choose approved by"); ?>" style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="isResultAuthorized" id="isResultAuthorized" class="disabled-field form-control" title="<?= _("Is Result authorized ?"); ?>" style="width:100%">
                                                    <option value=""><?= _("-- Select --"); ?></option>
                                            ...
                                            <td>
                                                <select name="authorizedBy" <?php echo $disabled; ?> id="authorizedBy" class="disabled-field form-control" title="<?= _("Please choose authorized by"); ?>" style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" <?php echo $disabled; ?> value="<?php echo DateUtility::humanReadableDateFormat($covid19Info['authorized_on']); ?>" name="authorizedOn" id="authorizedOn" class="disabled-field form-control date" placeholder="<?= _("Authorized on"); ?>" title="<?= _("Please select the Authorized On"); ?>" /></td>
                                            <th scope="row"></th>
                                            <td></td>
                                        </tr>
                                    </table>
