    ...
    class DRC_PDF extends MYPDF
    {
        ...
        public function Header()
        {
            ...
            if ($this->htitle != '') {
                ...
                $this->writeHTMLCell(0, 0, 0, 22, '<em>Département de Biologie Médicale</em>', 0, 0, 0, true, 'C');
                ...
                $this->writeHTMLCell(0, 0, 0, 42, 'TEST AU nCOV-19 PAR RT-PCR en temps réel', 0, 0, 0, true, 'C');
        ...
        public function Footer()
        {
            ...
            $this->writeHTMLCell(0, 0, 10, 280, 'Département de Biologie Médicale', 0, 0, false, true, 'C');
            // Page number
...
$html .= '<td width="100%" style="line-height:10px;font-size:11px;text-align:center;" colspan="3">
            <br><br><strong>Fait à Kinshasa, le: </strong>' . DateUtils::humanReadableDateFormat($result['result_approved_datetime']) .
...
$html .= '<tr>';
$html .= '<td colspan="3" style="line-height:12px;font-size:12px;text-align:center;"><br><br><strong>' . $labManager . '</strong><br>Chef de Labo Spécialisé Covid<br><span style="font-size:8;font-weight:normal;">(Lab Manager)</span></td>';
$html .= '</tr>';
