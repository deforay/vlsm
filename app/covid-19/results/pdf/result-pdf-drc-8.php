    ...
    class DRCCovid19PDF8 extends Covid19ResultPDFHelper
    {
        ...
        public function Header()
        {
            ...
            if (!empty($this->htitle) && trim($this->htitle) != '') {
                ...
                $this->writeHTMLCell(0, 0, 0, 32, '<em>Biologie Moléculaire</em>', 0, 0, 0, true, 'C');
...
$pdf = new DRCCovid19PDF8(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
