...
if (sizeof($requestResult) > 0) {
    ...
    foreach ($requestResult as $result) {
        ...
        $html .= '<tr>';
        $html .= '<td style="line-height:11px;font-size:11px;text-align:left;">' . \App\Utilities\DateUtils::humanReadableDateFormat($result['date_of_symptom_onset']) . '</td>';
        ...
        $html .= '<td style="line-height:11px;font-size:11px;text-align:left;">' . \App\Utilities\DateUtils::humanReadableDateFormat($result['travel_return_date']) . '</td>';
