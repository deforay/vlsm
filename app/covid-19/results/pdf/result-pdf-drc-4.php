...
if (!class_exists('DRCCovid19PDF4')) {

    class DRCCovid19PDF4 extends Covid19ResultPDFHelper
    {
        //Page header
...
$pdf = new DRCCovid19PDF4(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
