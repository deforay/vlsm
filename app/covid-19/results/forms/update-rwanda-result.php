...
//var_dump($facilitiesService->getTestingPoints(16));die;
                            ...
                            <div class="box-body disabledForm">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true">
                                    <tr>
                                        ...
                                        <td style="width:35% !important;">
                                            <input class="form-control date " type="text" name="dateOfSymptomOnset" id="dateOfSymptomOnset" placeholder="Symptom Onset Date" value="<?php echo DateUtility::humanReadableDateFormat($covid19Info['date_of_symptom_onset']); ?> " />
                                        </td>
                                ...
                                <div class="box-body">
                                    ...
                                    <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control isRequired" id="sampleReceivedDate" name="sampleReceivedDate" placeholder="<?= _("Please enter date"); ?>" title="Please enter sample receipt date" value="<?php echo DateUtility::humanReadableDateFormat($covid19Info['sample_received_at_lab_datetime']) ?>" onchange="" style="width:100%;" />
                                            </td>
