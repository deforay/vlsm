                        ...
                        <div class="box-body disabledForm">
                            ...
                            <table class="table" aria-hidden="true"  style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control isRequired" id="patientDob" name="patientDob" placeholder="Date de naissance" title="Date de naissance" style="width:100%;" onchange="calculateAgeInYears();" value="<?php echo DateUtils::humanReadableDateFormat($covid19Info['patient_dob']); ?>" />
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="table" aria-hidden="true" >
                                ...
                                <tr>
                                    ...
                                    <td style="width:35% !important;">
                                        <input class="form-control date" type="text" name="dateOfSymptomOnset" id="dateOfSymptomOnset" placeholder="Date d'apparition des symptômes" value="<?php echo DateUtils::humanReadableDateFormat($covid19Info['date_of_symptom_onset']); ?> " />
                                    </td>
                            ...
                            <div class="box-body">
                                ...
                                <table class="table" aria-hidden="true"  style="width:100%">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control isRequired" id="sampleReceivedDate" name="sampleReceivedDate" placeholder="<?= _("Please enter date"); ?>" title="Date de réception de l'échantillon" value="<?php echo DateUtils::humanReadableDateFormat($covid19Info['sample_received_at_vl_lab_datetime']) ?>" onchange="" style="width:100%;" />
                                        </td>
                                                    ...
                                                    <?php if (isset($covid19TestInfo) && count($covid19TestInfo) > 0) {
                                                        ...
                                                        foreach ($covid19TestInfo as $indexKey => $rows) { ?>
                                                            <tr>
                                                                ...
                                                                <td><input type="text" value="<?php echo DateUtils::humanReadableDateFormat($rows['sample_tested_datetime']); ?>" name="testDate[]" id="testDate<?= ($indexKey + 1); ?>" class="form-control test-name-table-input dateTime isRequired" placeholder="Testé sur" title="Veuillez saisir la ligne testée pour<?= ($indexKey + 1); ?>" /></td>
