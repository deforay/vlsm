...
foreach ($rResult as $aRow) {
     ...
     if ($aRow['result'] == '') {
          ...
          $print = '<a href="update-record-confirmatory-tests.php?id=' . base64_encode($aRow['covid19_id']) . '" class="btn btn-success btn-xs" style="margin-right: 2px;" title="Result"><i class="fa-solid fa-pen-to-square"></i> Enter Result</a>';
     } else {
