...
try {
    ...
    foreach ($rResult as $aRow) {
        ...
        $print = '<a href="javascript:void(0);" class="btn btn-primary btn-xs" style="margin-right: 2px;" title="' . _translate("Print") . '" onclick="generateResultPDF(' . $aRow['covid19_id'] . ')"><em class="fa-solid fa-print"></em> ' . _translate("Print") . '</a>';
