            ...
            <div class="row">
              <div class="col-md-9">
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" id="subject" name="subject" class="form-control isRequired" placeholder="Subject" title="Please enter subject" value="Covid-19 Test Results" />
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <div style="width:100%;margin:0 auto;clear:both;">
                      <a href="#" id="select-all-sample" style="float:left" class="btn btn-info btn-xs">Select All&nbsp;&nbsp;<em class="icon-chevron-right"></em></a> <a href="#" id="deselect-all-sample" style="float:right" class="btn btn-danger btn-xs"><i class="icon-chevron-left"></i>&nbsp;Deselect All</a>
                    </div><br /><br />
                    <select id="sample" name="sample[]" multiple="multiple" class="search isRequired" title="Please select sample(s)">
                      ...
                      ?>
                          <option value="<?php echo $sample['covid19_id']; ?>"><?php echo ucwords($sample['sample_code']); ?></option>
                      <?php
                        }
                      }
                      ?>
...
<script type="text/javascript">
  ...
  function getSampleDetails() {
    ...
    var type = $('#type').val();
    $.post("/covid-19/mail/get-samples-for-mail.php", {
