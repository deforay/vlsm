...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-virus-covid"></em> <?php echo _("Add Covid-19 Sample Rejection Reasons"); ?></h1>
		<ol class="breadcrumb">
			...
			<div class="box-body">
				...
				<form class="form-horizontal" method='post' name='addSampleRejcForm' id='addSampleRejcForm' autocomplete="off" enctype="multipart/form-data" action="add-rejection-reason-helper.php">
					...
					<div class="box-footer">
						...
						<a href="covid19-sample-rejection-reasons.php" class="btn btn-default"> <?php echo _("Cancel"); ?></a>
					</div>
					<!-- /.box-footer -->
				</form>
				<!-- /.row -->
