...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-virus-covid"></em> <?php echo _translate("Add Covid-19 Sample Rejection Reasons"); ?></h1>
		<ol class="breadcrumb">
			...
			<div class="box-body">
				...
				<form class="form-horizontal" method='post' name='addSampleRejcForm' id='addSampleRejcForm' autocomplete="off" enctype="multipart/form-data" action="add-rejection-reason-helper.php">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="rejectionReasonCode" name="rejectionReasonCode" placeholder="<?php echo _translate('Rejection Reason Code'); ?>" title="<?php echo _translate('Please enter Rejection Reason Code'); ?>" onblur='checkNameValidation("r_covid19_sample_rejection_reasons","rejection_reason_code",this,null,"<?php echo _translate("The Rejection Reason code that you entered already exists.Enter another Rejection Reason code"); ?>",null)' />
									</div>
								</div>
							</div>
							<div class="col-md-6">
					...
					<div class="box-footer">
						...
						<a href="covid19-sample-rejection-reasons.php" class="btn btn-default"> <?php echo _translate("Cancel"); ?></a>
					</div>
					<!-- /.box-footer -->
				</form>
				<!-- /.row -->
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		editableSelect('rejectionType', 'rejection_type', 'r_covid19_sample_rejection_reasons', 'Rejection type');
	});
