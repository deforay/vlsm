...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-virus-covid"></em> <?php echo _translate("Covid-19 Results"); ?></h1>
		<ol class="breadcrumb">
				...
				<div class="box">
					<div class="box-header with-border">
						<?php if (_isAllowed("covid19-sample-type.php") && $general->isLISInstance() === false) { ?>
							<a href="add-covid19-results.php" class="btn btn-primary pull-right"> <em class="fa-solid fa-plus"></em> <?php echo _translate("Add Covid-19 Results"); ?></a>
						<?php } ?>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
...
<script>
	...
	$(document).ready(function() {
		...
		oTable = $('#sampTypDataTable').dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "get-covid19-results-helper.php",
