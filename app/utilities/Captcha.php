...
class Captcha
{
    ...
    public function getCaptcha($config = array())
    {
        ...
        $captcha_config = array(
            ...
            'min_length' => 4,
            'max_length' => 5,
            'png_backgrounds' => array(APPLICATION_PATH . '/assets/img/captchabg/default.png', APPLICATION_PATH . '/assets/img/captchabg/ravenna.png'),
            'fonts' => array(APPLICATION_PATH . '/assets/fonts/Idolwild/idolwild.ttf'),
