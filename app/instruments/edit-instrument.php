				...
				<form class="form-horizontal" method='post' name='editImportConfigForm' id='editImportConfigForm'
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="configurationName"
											name="configurationName"
											placeholder="<?php echo _('eg. Roche or Abbott'); ?>"
											title="<?php echo _('Please enter instrument name'); ?>"
											value="<?php echo $sInfo['machine_name']; ?>"
											onblur="checkNameValidation('instruments','machine_name',this,'<?php echo "config_id##" . $sInfo['config_id']; ?>','<?php echo _('This instrument name already exists.Try another name'); ?>',null);" />
									</div>
								</div>
							</div>
						</div>
						<?php if (isset($vlsmSystemConfig['sc_user_type']) && $vlsmSystemConfig['sc_user_type'] == 'vluser') { ?>
							<input type="hidden" value="<?php echo $general->getSystemConfig('sc_testing_lab_id'); ?>"
								name="testingLab" />
						<?php } else { ?>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-lg-7">
											<select class="form-control select2" id="testingLab" name="testingLab"
												title="Please select the testing lab">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<select multiple class="form-control" id="supportedTests"
											name="supportedTests[]">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="configurationFile"
											name="configurationFile"
											placeholder="<?php echo _('eg. roche.php or abbott.php'); ?>"
											title="<?php echo _('Please enter file name'); ?>"
											value="<?php echo $sInfo['import_machine_file_name']; ?>" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control forceNumeric" id="lowerLimit"
											name="lowerLimit" placeholder="<?php echo _('eg. 20'); ?>"
											title="<?php echo _('Please enter lower limit'); ?>"
											value="<?php echo $sInfo['lower_limit']; ?>" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control forceNumeric" id="higherLimit"
											name="higherLimit" placeholder="<?php echo _('eg. 10000000'); ?>"
											title="<?php echo _('Please enter lower limit'); ?>"
											value="<?php echo $sInfo['higher_limit']; ?>" />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="maxNOfSamplesInBatch" class="col-lg-4 control-label">
										<?php echo _("Maximum No. of Samples In a Batch"); ?> <span
											class="mandatory">*</span>
									</label>
									<div class="col-lg-7">
										<input type="text" class="form-control forceNumeric isRequired"
											id="maxNOfSamplesInBatch" name="maxNOfSamplesInBatch"
											placeholder="<?php echo _('Max. no of samples'); ?>"
											title="<?php echo _('Please enter max no of samples in a row'); ?>"
											value="<?php echo $sInfo['max_no_of_samples_in_a_batch']; ?>" />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row lowVlResultText" <?php echo $lowerText; ?>>
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-lg-7">
											<textarea class="form-control" id="lowVlResultText" name="lowVlResultText"
												placeholder="<?php echo _('Comma separated Low Viral Load Result Text for eg. Target Not Detected, TND, < 20, < 40'); ?>"
												title="<?php echo _('Low Viral Load Result Text for eg. Target Not Detected, TND, < 20, < 40'); ?>"><?php echo $sInfo['low_vl_result_text']; ?></textarea>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-7">
										<select class="form-control" id="status" name="status"
											title="<?php echo _('Please select import config status'); ?>">
						...
						<?php if (SYSTEM_CONFIG['modules']['vl'] || SYSTEM_CONFIG['modules']['eid'] || SYSTEM_CONFIG['modules']['covid19']) { ?>
							<div class="box-body">
								...
								<table aria-describedby="table" border="0"
									class="user-access table table-striped table-bordered table-condensed"
									style="width:100%;<?php echo $ua; ?>;">
									<thead>
										<tr>
									...
									<tbody>
										<?php if (SYSTEM_CONFIG['modules']['vl']) { ?>
											<tr class="vl-access user-access-form"
												style="<?php echo in_array('vl', $sInfo['supported_tests']) ? "" : "display:none;"; ?>">
												<td align="left" style="text-align:center;">
													<?php echo _("VL"); ?><input type="hidden" name="userTestType[]"
														id="testType1" value="vl" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByVl"
														class="form-control user-vl select2"
														title='<?php echo _("Please enter Reviewed By for VL Test"); ?>'>
														<?php echo $general->generateSelectOptions($userList, $sInfo['reviewed_by']['vl'], '--Select--'); ?>
													</select>
												</td>
												<td>
													<select name="approvedBy[]" id="approvedByVl"
														class="form-control user-vl select2"
														title='<?php echo _("Please enter Approved By for VL Test"); ?>'>
										...
										if (SYSTEM_CONFIG['modules']['eid']) { ?>
											<tr class="eid-access user-access-form"
												style="<?php echo in_array('eid', $sInfo['supported_tests']) ? "" : "display:none;"; ?>">
												<td align="left" style="text-align:center;">
													<?php echo _("EID"); ?><input type="hidden" name="userTestType[]"
														id="testType1" value="eid" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByEid"
														class="form-control user-eid select2"
														title='<?php echo _("Please enter Reviewed By for EID Test"); ?>'>
														<?php echo $general->generateSelectOptions($userList, $sInfo['reviewed_by']['eid'], '--Select--'); ?>
													</select>
												</td>
												<td>
													<select name="approvedBy[]" id="approvedByEid"
														class="form-control user-eid select2"
														title='<?php echo _("Please enter Approved By for EID Test"); ?>'>
										...
										if (SYSTEM_CONFIG['modules']['covid19']) { ?>
											<tr class="covid19-access user-access-form"
												style="<?php echo in_array('covid19', $sInfo['supported_tests']) ? "" : "display:none;"; ?>">
												<td align="left" style="text-align:center;">
													<?php echo _("Covid-19"); ?><input type="hidden" name="userTestType[]"
														id="testType1" value="covid19" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByCovid19"
														class="form-control user-covid19 select2"
														title='<?php echo _("Please enter Reviewed By for Covid19 Test"); ?>'>
														<?php echo $general->generateSelectOptions($userList, $sInfo['reviewed_by']['covid19'], '--Select--'); ?>
													</select>
												</td>
												<td>
													<select name="approvedBy[]" id="approvedByCovid19"
														class="form-control user-covid19 select2"
														title='<?php echo _("Please enter Approved By for Covid19 Test"); ?>'>
										...
										if (SYSTEM_CONFIG['modules']['hepatitis']) { ?>
											<tr class="hepatitis-access user-access-form"
												style="<?php echo in_array('hepatitis', $sInfo['supported_tests']) ? "" : "display:none;"; ?>">
												<td align="left" style="text-align:center;">
													<?php echo _("Hepatitis"); ?><input type="hidden" name="userTestType[]"
														id="testType1" value="hepatitis" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByHepatitis"
														class="form-control user-hepatitis select2"
														title='<?php echo _("Please enter Reviewed By for Hepatitis Test"); ?>'>
														<?php echo $general->generateSelectOptions($userList, $sInfo['reviewed_by']['hepatitis'], '--Select--'); ?>
													</select>
												</td>
												<td>
													<select name="approvedBy[]" id="approvedByHepatitis"
														class="form-control user-hepatitis select2"
														title='<?php echo _("Please enter Approved By for Hepatitis Test"); ?>'>
										...
										if (SYSTEM_CONFIG['modules']['tb']) { ?>
											<tr class="tb-access user-access-form"
												style="<?php echo in_array('tb', $sInfo['supported_tests']) ? "" : "display:none;"; ?>">
												<td align="left" style="text-align:center;">
													<?php echo _("TB"); ?><input type="hidden" name="userTestType[]"
														id="testType1" value="tb" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByTb"
														class="form-control user-tb select2"
														title='<?php echo _("Please enter Reviewed By for TB Test"); ?>'>
														<?php echo $general->generateSelectOptions($userList, $sInfo['reviewed_by']['tb'], '--Select--'); ?>
													</select>
												</td>
												<td>
													<select name="approvedBy[]" id="approvedByTb"
														class="form-control user-tb select2"
														title='<?php echo _("Please enter Approved By for TB Test"); ?>'>
									...
									<tbody id="testTypesTable">
										<?php if ((SYSTEM_CONFIG['modules']['vl'])) { ?>
											<tr id="vlTable" class="ctlCalibrator" <?php echo $vl; ?>>
												<td align="left">
													<?php echo _("VL"); ?><input type="hidden" name="testType[]" id="testType1"
														value="vl" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['vl']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control"
														placeholder="<?php echo _('No of In-House Controls in vl'); ?>"
														title="<?php echo _('Please enter No of In-House Controls in vl'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['vl']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control"
														placeholder="<?php echo _('No of Manufacturer Controls in vl'); ?>"
														title="<?php echo _('Please enter No of Manufacturer Controls in vl'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['vl']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1" class="form-control"
														placeholder="<?php echo _('No of Calibrators in vl'); ?>"
														title="<?php echo _('Please enter No of Calibrators in vl'); ?>" /></td>
											</tr>
										<?php }
										if ((SYSTEM_CONFIG['modules']['eid'])) { ?>
											<tr id="eidTable" class="ctlCalibrator" <?php echo $eid; ?>>
												<td align="left">
													<?php echo _("EID"); ?><input type="hidden" name="testType[]" id="testType1"
														value="eid" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['eid']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control"
														placeholder="<?php echo _('No of In-House Controls in eid'); ?>"
														title="<?php echo _('Please enter No of In-House Controls in eid'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['eid']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control"
														placeholder="<?php echo _('No of Manufacturer Controls in eid'); ?>"
														title="<?php echo _('Please enter No of Manufacturer Controls in eid'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['eid']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1" class="form-control"
														placeholder="<?php echo _('No of Calibrators in eid'); ?>"
														title="<?php echo _('Please enter No of Calibrators in eid'); ?>" />
												</td>
											</tr>
										<?php }
										if ((SYSTEM_CONFIG['modules']['covid19'])) { ?>
											<tr id="covid19Table" class="ctlCalibrator" <?php echo $covid19; ?>>
												<td align="left">
													<?php echo _("Covid-19"); ?><input type="hidden" name="testType[]"
														id="testType1" value="covid-19" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['covid-19']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control"
														placeholder="<?php echo _('No of In-House Controls in covid-19'); ?>"
														title="<?php echo _('Please enter No of In-House Controls in covid-19'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['covid-19']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control"
														placeholder="<?php echo _('No of Manufacturer Controls in covid-19'); ?>"
														title="<?php echo _('Please enter No of Manufacturer Controls in covid-19'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['covid-19']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1" class="form-control"
														placeholder="<?php echo _('No of Calibrators in covid-19'); ?>"
														title="<?php echo _('Please enter No of Calibrators in covid-19'); ?>" />
												</td>
											</tr>
										<?php }
										if ((SYSTEM_CONFIG['modules']['hepatitis'])) { ?>
											<tr id="hepatitisTable" class="ctlCalibrator" <?php echo $hepatitis; ?>>
												<td align="left">
													<?php echo _("Hepatitis"); ?><input type="hidden" name="testType[]"
														id="testType1" value="hepatitis" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['hepatitis']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control"
														placeholder="<?php echo _('No of In-House Controls in hepatitis'); ?>"
														title="<?php echo _('Please enter No of In-House Controls in hepatitis'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['hepatitis']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control"
														placeholder="<?php echo _('No of Manufacturer Controls in hepatitis'); ?>"
														title="<?php echo _('Please enter No of Manufacturer Controls in hepatitis'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['hepatitis']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1" class="form-control"
														placeholder="<?php echo _('No of Calibrators in hepatitis'); ?>"
														title="<?php echo _('Please enter No of Calibrators in hepatitis'); ?>" />
												</td>
											</tr>
										<?php }
										if ((SYSTEM_CONFIG['modules']['tb'])) { ?>
											<tr id="tbTable" class="ctlCalibrator" <?php echo $tb; ?>>
												<td align="left">
													<?php echo _("tb"); ?><input type="hidden" name="testType[]" id="testType1"
														value="tb" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['tb']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control"
														placeholder="<?php echo _('No of In-House Controls in TB'); ?>"
														title="<?php echo _('Please enter No of In-House Controls in TB'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['tb']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control"
														placeholder="<?php echo _('No of Manufacturer Controls in TB'); ?>"
														title="<?php echo _('Please enter No of Manufacturer Controls in TB'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['tb']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1" class="form-control"
														placeholder="<?php echo _('No of Calibrators in TB'); ?>"
														title="<?php echo _('Please enter No of Calibrators in TB'); ?>" /></td>
											</tr>
										<?php }
										if (SYSTEM_CONFIG['modules']['generic-tests']) { ?>
								...
								<tbody id="machineTable">
									...
									if (count($configMachineInfo) > 0) {
										foreach ($configMachineInfo as $machine) {
											...
											<tr>
												<td>
													<input type="hidden" name="configMachineId[]"
														value="<?php echo $machine['config_machine_id']; ?>" />
													<input type="text" name="configMachineName[]"
														id="configMachineName<?php echo $i; ?>"
														class="form-control configMachineName isRequired"
														placeholder="<?php echo _('Machine Name'); ?>"
														title="<?php echo _('Please enter machine name'); ?>"
														value="<?php echo $machine['config_machine_name']; ?>"
														onblur="checkDublicateName(this, 'configMachineName');" ; />
												</td>
												<td>
													<input type="text"
														value="<?php echo $machine['date_format'] ?: 'd/m/Y H:i'; ?>"
														name="dateFormat[]" id="dateFormat<?php echo $i; ?>"
														class="form-control" placeholder='<?php echo _("Date Format"); ?>'
														title='<?php echo _("Please enter date format"); ?>' />
												</td>
												<td>
													<input type="text" value="<?php echo $machine['file_name']; ?>"
														name="fileName[]" id="fileName<?php echo $i; ?>" class="form-control"
														placeholder='<?php echo _("File Name"); ?>'
														title='<?php echo _("Please enter file name"); ?>'
														onblur="checkDublicateName(this, 'fileName');" />
												</td>
												<td>
													<div class="col-md-3">
														<input type="checkbox" id="pocdevice<?php echo $i; ?>"
															name="pocdevice[]" value=""
															onclick="getLatiLongi(<?php echo $i; ?>);" <?php echo $check; ?>>
													</div>
													<div class="latLong<?php echo $i; ?> " style="<?php echo $style; ?>">
														<div class="col-md-4">
															<input type="text" name="latitude[]" id="latitude<?php echo $i; ?>"
																value="<?php echo $machine['latitude']; ?>"
																class="form-control " placeholder="<?php echo _('Latitude'); ?>"
																data-placement="bottom" title="<?php echo _('Latitude'); ?>" />
														</div>
														<div class="col-md-4">
															<input type="text" name="longitude[]"
																id="longitude<?php echo $i; ?>"
																value="<?php echo $machine['longitude']; ?>"
																class="form-control "
																placeholder="<?php echo _('Longitude'); ?>"
																data-placement="bottom" title="<?php echo _('Longitude'); ?>" />
														</div>
													</div>
												</td>
												<td align="center" style="vertical-align:middle;">
													<a class="btn btn-xs btn-primary" href="javascript:void(0);"
														onclick="insRow();"><em class="fa-solid fa-plus"></em></a>
												</td>
											</tr>
											<?php
											$i++;
									...
									<tr>
										<td>
											<input type="text" name="configMachineName[]" id="configMachineName0"
												class="form-control configMachineName isRequired"
												placeholder="<?php echo _('Machine Name'); ?>"
												title="<?php echo _('Please enter machine name'); ?>"
												onblur="checkMachineName(this);" />
										</td>
										<td>
											<input type="text" value="d/m/Y H:i" name="dateFormat[]" id="dateFormat0"
												class="form-control" placeholder='<?php echo _("Date Format"); ?>'
												title='<?php echo _("Please enter date format"); ?>' />
										</td>
										<td>
											<input type="text" name="fileName[]" id="fileName0" class="form-control"
												placeholder='<?php echo _("File Name"); ?>'
												title='<?php echo _("Please enter file name"); ?>'
												onblur="checkDublicateName(this, 'fileName');" />
										</td>
										<td>
											<div class="col-md-3">
												<input type="checkbox" id="pocdevice0" name="pocdevice[]" value=""
													onclick="getLatiLongi(0);">
											</div>
											<div class="latLong0 " style="display:none">
												<div class="col-md-4">
													<input type="text" name="latitude[]" id="latitude0"
														class="form-control " placeholder="<?php echo _('Latitude'); ?>"
														data-placement="bottom" title="<?php echo _('Latitude'); ?>" />
												</div>
												<div class="col-md-4">
													<input type="text" name="longitude[]" id="longitude0"
														class="form-control "
														placeholder="<?php echo _('Longitude'); ?>"
														data-placement="bottom" title="<?php echo _('Longitude'); ?>" />
												</div>
										...
										<td align="center" style="vertical-align:middle;">
											<a class="btn btn-xs btn-primary" href="javascript:void(0);"
												onclick="insRow();"><em class="fa-solid fa-plus"></em></a>&nbsp;&nbsp;<a
												class="btn btn-xs btn-default" href="javascript:void(0);"
												onclick="removeAttributeRow(this.parentNode.parentNode);"><em
					...
					<div class="box-footer">
						<input type="hidden" id="configId" name="configId"
							value="<?php echo base64_encode($sInfo['config_id']); ?>" />
