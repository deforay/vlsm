...
$title = _translate("TB Sample Rejection Reasons");
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-heart-pulse"></em> <?php echo _translate("TB Sample Rejection Reasons"); ?></h1>
		<ol class="breadcrumb">
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header with-border">
						<a href="javascript:void(0);" onclick="forceMetadataSync('<?php echo $general->encrypt('r_tb_sample_rejection_reasons', base64_decode((string) $keyFromGlobalConfig)); ?>')" class="btn btn-success pull-right" style="margin-left: 10px;"> <em class="fa-solid fa-refresh"></em></a>
