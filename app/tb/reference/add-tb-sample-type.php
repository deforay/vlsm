...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><em class="fa-solid fa-heart-pulse"></em> <?php echo _translate("Add TB Sample Type"); ?></h1>
    <ol class="breadcrumb">
      ...
      <div class="box-body">
        ...
        <form class="form-horizontal" method='post' name='addSampleForm' id='addSampleForm' autocomplete="off" enctype="multipart/form-data" action="add-sample-type-helper.php">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-lg-7">
                    <input type="text" class="form-control isRequired" id="sampleName" name="sampleName" placeholder="<?php echo _translate('Sample Name'); ?>" title="<?php echo _translate('Please enter Sample name'); ?>" onblur='checkNameValidation("r_tb_sample_type","sample_name",this,null,"<?php echo _translate("The Sample name that you entered already exists.Enter another name"); ?>",null)' />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
          ...
          <div class="box-footer">
            ...
            <a href="tb-sample-type.php" class="btn btn-default"> <?php echo _translate("Cancel"); ?></a>
          </div>
          <!-- /.box-footer -->
        </form>
        <!-- /.row -->
