...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-heart-pulse"></em> <?php echo _("Add TB Sample Rejection Reasons"); ?></h1>
		<ol class="breadcrumb">
			...
			<div class="box-body">
				...
				<form class="form-horizontal" method='post' name='addSampleRejcForm' id='addSampleRejcForm' autocomplete="off" enctype="multipart/form-data" action="add-rejection-reason-helper.php">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="rejectionReasonName" name="rejectionReasonName" placeholder="<?php echo _('Rejection Reason Name'); ?>" title="<?php echo _('Please enter Rejection Reason name'); ?>" onblur='checkNameValidation("r_tb_sample_rejection_reasons","rejection_reason_name",this,null,"<?php echo _("The Rejection Reason name that you entered already exists.Enter another Rejection Reason name"); ?>",null)' />
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="rejectionType" class="col-lg-4 control-label"><?php echo _("Rejection Type"); ?><span class="mandatory">*</span> <em class="fas fa-edit"></em></label>
									<div class="col-lg-7">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="rejectionReasonCode" name="rejectionReasonCode" placeholder="<?php echo _('Rejection Reason Code'); ?>" title="<?php echo _('Please enter Rejection Reason Code'); ?>" onblur='checkNameValidation("r_tb_sample_rejection_reasons","rejection_reason_code",this,null,"<?php echo _("The Rejection Reason code that you entered already exists.Enter another Rejection Reason code"); ?>",null)' />
									</div>
								</div>
							</div>
							<div class="col-md-6">
					...
					<div class="box-footer">
						...
						<a href="tb-sample-rejection-reasons.php" class="btn btn-default"> <?php echo _("Cancel"); ?></a>
					</div>
					<!-- /.box-footer -->
				</form>
				<!-- /.row -->
