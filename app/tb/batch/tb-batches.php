			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-header with-border">
						<?php if (isset($_SESSION['privileges']) && in_array("tb-add-batch.php", $_SESSION['privileges'])) { ?>
							<a href="tb-add-batch.php" class="btn btn-primary pull-right"> <em class="fa-solid fa-plus"></em> <?php echo _("Create New Batch");?></a>
						<?php } ?>
