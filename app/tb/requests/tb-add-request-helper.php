...
try {
    ...
    $tbData = array(
        ...
        'request_created_datetime'            => (isset($_POST['requestedDate']) && $_POST['requestedDate'] == 'yes') ? $_POST['requestedDate'] : $general->getCurrentDateTime(),
    ...
    if ($id > 0) {
        ...
        $action = ucwords($_SESSION['userName']) . ' added a new TB request with the Sample ID/Code  ' . $_POST['tbSampleId'];
