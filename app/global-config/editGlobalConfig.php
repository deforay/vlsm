										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-10">
													...
													<input type="radio" class="isRequired readPage" title="<?php echo _translate('Please select the EID Sample ID Format'); ?>" id="eid_auto_generate2" name="eid_sample_code" value="auto2" <?php echo ($arr['eid_sample_code'] == 'auto2') ? 'checked' : ''; ?> style="display:<?php echo ($arr['vl_form'] == COUNTRY\PNG) ? '' : 'none'; ?>"><span id="eid_auto2" style="display:<?php echo ($arr['vl_form'] == COUNTRY\PNG) ? '' : 'none'; ?>"> <?php echo _translate("Auto"); ?> 2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-10">
													...
													<input type="radio" class="isRequired readPage" title="Please select the Covid-19 Sample ID Format" id="covid19_auto_generate2" name="covid19_sample_code" value="auto2" <?php echo ($arr['covid19_sample_code'] == 'auto2') ? 'checked' : ''; ?> style="display:<?php echo ($arr['vl_form'] == COUNTRY\PNG) ? '' : 'none'; ?>"><span id="covid19_auto2" style="display:<?php echo ($arr['vl_form'] == COUNTRY\PNG) ? '' : 'none'; ?>"> Auto 2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-10">
													...
													<input type="radio" class="isRequired readPage" title="<?php echo _translate('Please select the TB Sample ID Format'); ?>" id="tb_auto_generate2" name="tb_sample_code" value="auto2" <?php echo ($arr['tb_sample_code'] == 'auto2') ? 'checked' : ''; ?> style="display:<?php echo ($arr['vl_form'] == COUNTRY\PNG) ? '' : 'none'; ?>"><span id="tb_auto2" style="display:<?php echo ($arr['vl_form'] == COUNTRY\PNG) ? '' : 'none'; ?>"> <?php echo _translate("Auto"); ?> 2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-lg-10">
													...
													<input type="radio" class="isRequired readPage" title="<?php echo _translate('Please select the Generic Test Sample ID Format'); ?>" id="generic_auto_generate2" name="generic_sample_code" value="auto2" <?php echo ($arr['generic_sample_code'] == 'auto2') ? 'checked' : ''; ?> style="display:<?php echo ($arr['vl_form'] == COUNTRY\PNG) ? '' : 'none'; ?>"><span id="generic_auto2" style="display:<?php echo ($arr['vl_form'] == COUNTRY\PNG) ? '' : 'none'; ?>"> <?php echo _translate("Auto"); ?> 2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
