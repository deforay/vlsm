...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><em class="fa-solid fa-gears"></em> <?php echo _translate("Edit Sample Type"); ?></h1>
        <ol class="breadcrumb">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <select class="form-control isRequired" id="sampleTypeStatus" name="sampleTypeStatus" title="<?php echo _translate('Please select sample type status'); ?>">
                                            ...
                                            <option value="active" <?php echo ($sampleTypeInfo[0]['sample_type_status'] == 'active') ? "selected='selected'" : "" ?>><?php echo _translate("Active"); ?></option>
                                            <option value="inactive" <?php echo ($sampleTypeInfo[0]['sample_type_status'] == 'inactive') ? "selected='selected'" : "" ?>><?php echo _translate("Inactive"); ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
