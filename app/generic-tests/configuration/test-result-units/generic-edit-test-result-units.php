...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><em class="fa-solid fa-gears"></em> <?php echo _("Edit Test Result Units"); ?></h1>
        <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="form-control isRequired" id="unitName" name="unitName" placeholder="<?php echo _('Unit Name'); ?>" title="<?php echo _('Please enter unit name'); ?>" onblur="checkNameValidation('r_generic_test_result_units','unit_name',this,'<?php echo "unit_id##" . $unitInfo[0]['unit_id']; ?>','<?php echo _("This test result unit name that you entered already exists.Try another name"); ?>',null)" value="<?php echo $unitInfo[0]['unit_name']; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <select class="form-control isRequired" id="status" name="status" title="<?php echo _('Please select status'); ?>">
                                            ...
                                            <option value="active" <?php echo ($unitInfo[0]['unit_status'] == 'active') ? "selected='selected'" : "" ?>><?php echo _("Active"); ?></option>
                                            <option value="inactive" <?php echo ($unitInfo[0]['unit_status'] == 'inactive') ? "selected='selected'" : "" ?>><?php echo _("Inactive"); ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
