													...
													<table style="width: 100%;margin: 0 auto;" border="1" class="table table-bordered table-striped clearfix">
														<tr>
															...
															<td class="firstSubTest" style="width:30%;">
																<input type="text" name="resultConfig[sub_test_name][<?php echo $key; ?>]" id="resultSubGroup<?php echo $key; ?>" value="<?php echo (isset($resultName) && !empty($resultName)) ? $resultName : ''; ?>" class="form-control subtestname input-sm" placeholder="Enter the sub test name" title="Please ener the sub test name for <?php echo $key; ?> row" />
															</td>
															<td style="width:20%;">
																...
																<table style="width:100%;" class="table table-bordered table-striped clearfix">
																	...
																	if (isset($resultsInnerList) && !empty($resultsInnerList)) {
																		...
																		foreach ($resultsInnerList['expectedResult'][$key] as $ikey => $value) { ?>
																			<tr>
																				<td><input type="text" value="<?php echo $value ?? null; ?>" name="resultConfig[qualitative][expectedResult][<?php echo $key; ?>][<?php echo $ikey; ?>]" class="form-control result-inputs qualitative-input-<?php echo $key; ?><?php echo $ikey; ?> input-sm" placeholder="Enter the expected result" title="Please enter the expected result" /></td>
																				<td><input type="text" value="<?php echo $resultsInnerList['resultCode'][$key][$ikey] ?? null; ?>" name="resultConfig[qualitative][resultCode][<?php echo $key; ?>][<?php echo $ikey; ?>]" class="form-control result-inputs qualitative-input-<?php echo $key; ?><?php echo $ikey; ?> input-sm" placeholder="Enter the result code" title="Please enter the result code" /></td>
																				<td><input type="text" value="<?php echo $resultsInnerList['sortOrder'][$key][$ikey] ?? null; ?>" name="resultConfig[qualitative][sortOrder][<?php echo $key; ?>][<?php echo $ikey; ?>]" class="form-control result-inputs qualitative-input-<?php echo $key; ?><?php echo $ikey; ?> input-sm" placeholder="Enter the sort order" title="Please enter the sort order" /></td>
											...
											<tr class="quantitative-div <?php echo (isset($testResultAttribute['result_type'][$key]) && !empty($testResultAttribute['result_type'][$key]) && $testResultAttribute['result_type'][$key] == 'quantitative') ? '' : 'hide'; ?>" id="quantitativeRow<?php echo $key; ?>">
												<td colspan="4">
													<table style="width:100%;" class="table table-bordered table-striped clearfix">
														...
														<tr>
															<td>
																<input type="text" value="<?php echo $resultsInnerList['high_range'][$key] ?? null; ?>" name="resultConfig[quantitative][high_range][<?php echo $key; ?>]" class="form-control result-inputs quantitative-input-<?php echo $key; ?>1 input-sm" placeholder="Enter the high value" title="Please enter the high value" />
															</td>
															<td>
																<input type="text" value="<?php echo $resultsInnerList['threshold_range'][$key] ?? null; ?>" name="resultConfig[quantitative][threshold_range][<?php echo $key; ?>]" class="form-control result-inputs quantitative-input-<?php echo $key; ?>1 input-sm" placeholder="Enter the threshold value" title="Please enter the threshold value" />
															</td>
															<td>
																<input type="text" value="<?php echo $resultsInnerList['low_range'][$key] ?? null; ?>" name="resultConfig[quantitative][low_range][<?php echo $key; ?>]" class="form-control result-inputs quantitative-input-<?php echo $key; ?>1 input-sm" placeholder="Enter the low value" title="Please enter the low value" />
															</td>
														</tr>
													</table>
												</td>
