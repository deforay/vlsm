...
if (isset($_SERVER['HTTP_REFERER'])) {
	$lastUrl1 = strpos((string) $_SERVER['HTTP_REFERER'], "update-generic-test-result.php");
	$lastUrl2 = strpos((string) $_SERVER['HTTP_REFERER'], "generic-test-result.php");
}
if ($lastUrl1 != '' || $lastUrl2 != '') {
	...
	$status = (isset($_COOKIE['status']) && $_COOKIE['status'] != '') ? $_COOKIE['status'] : 'no_result';
}
?>
<style>
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-list-check"></em>
			<?php echo _translate("Enter Other Lab Tests Result"); ?>
		</h1>
		<ol class="breadcrumb">
