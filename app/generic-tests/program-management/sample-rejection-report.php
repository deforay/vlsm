			...
			<div class="col-xs-12">
				<div class="box">
					<table aria-describedby="table" class="table" aria-hidden="true"
						...
						<tr>
							...
							<td>
								<select class="form-control" id="labName" name="labName"
									title="<?php echo _('Please select lab name'); ?>" style="width:220px;">
									<?= $testingLabsDropdown; ?>
								</select>
							</td>
						</tr>
						<tr>
							...
							<td>
								<select class="form-control" id="clinicName" name="clinicName"
									title="<?php echo _('Please select clinic name'); ?>" multiple="multiple"
									style="width:220px;">
									<?= $facilitiesDropdown; ?>
								</select>
							</td>
						...
						<tr>
							<td colspan="4">&nbsp;<input type="button" onclick="searchResultData();"
