...
if (isset($sarr['sc_user_type']) && $sarr['sc_user_type'] == 'vluser' && !empty($sarr['sc_testing_lab_id'])) {
	$testingLabs = $facilitiesService->getTestingLabs('generic-tests', true, false, "facility_id = " . $sarr['sc_testing_lab_id']);
} else {
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-book"></em> <?php echo _("Lab Tests Sample Status Report"); ?></h1>
		<ol class="breadcrumb">
			<li><a href="/"><em class="fa-solid fa-chart-pie"></em> <?php echo _("Home"); ?></a></li>
			<li class="active"><?php echo _("Lab Tests Sample Status Report"); ?></li>
		</ol>
	</section>
