			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header with-border">
						<?php if (isset($_SESSION['privileges']) && in_array("generic-add-test-categories.php", $_SESSION['privileges'])) { ?>
							<a href="generic-add-test-categories.php" class="btn btn-primary pull-right"> <em class="fa-solid fa-plus"></em> <?php echo _("Add Test Categories"); ?></a>
						<?php } ?>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<table aria-describedby="table" id="partnerTable" class="table table-bordered table-striped" aria-hidden="true">
							<thead>
								<tr>
									...
									<?php if (isset($_SESSION['privileges']) && in_array("generic-edit-test-categories.php", $_SESSION['privileges'])) { ?>
