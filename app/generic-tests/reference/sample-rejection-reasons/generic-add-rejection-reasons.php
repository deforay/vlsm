...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-flask-vial"></em> <?php echo _("Add Generic Sample Rejection Reasons"); ?></h1>
		<ol class="breadcrumb">
			<li><a href="/"><em class="fa-solid fa-chart-pie"></em> <?php echo _("Home"); ?></a></li>
			<li class="active"><?php echo _("Generic Sample Rejection Reasons"); ?></li>
		</ol>
	</section>
			...
			<div class="box-body">
				...
				<form class="form-horizontal" method='post' name='addSampleRejcForm' id='addSampleRejcForm' autocomplete="off" enctype="multipart/form-data" action="save-generic-sample-rejection-reasons-helper.php">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="rejectionReasonCode" name="rejectionReasonCode" placeholder="<?php echo _('Rejection Reason Code'); ?>" title="<?php echo _('Please enter Rejection Reason Code'); ?>" onblur='checkNameValidation("r_generic_sample_rejection_reasons","rejection_reason_code",this,null,"<?php echo _("The Rejection Reason code that you entered already exists.Enter another Rejection Reason code"); ?>",null)' />
									</div>
								</div>
							</div>
							<div class="col-md-6">
					...
					<div class="box-footer">
						...
						<a href="generic-sample-rejection-reasons.php" class="btn btn-default"> <?php echo _("Cancel"); ?></a>
					</div>
					<!-- /.box-footer -->
				</form>
				<!-- /.row -->
