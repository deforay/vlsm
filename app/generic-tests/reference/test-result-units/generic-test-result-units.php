			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header with-border">
						<?php if (isset($_SESSION['privileges']) && in_array("generic-add-test-result-units.php", $_SESSION['privileges'])) { ?>
							<a href="generic-add-test-result-units.php" class="btn btn-primary pull-right"> <em class="fa-solid fa-plus"></em> <?php echo _("Add Test Result Units"); ?></a>
						<?php } ?>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<table aria-describedby="table" id="partnerTable" class="table table-bordered table-striped" aria-hidden="true">
							<thead>
								<tr>
									...
									<?php if (isset($_SESSION['privileges']) && in_array("generic-edit-test-result-units.php", $_SESSION['privileges'])) { ?>
