...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><em class="fa-solid fa-square-h"></em> <?php echo _("Add Hepatitis Sample Type");?></h1>
    <ol class="breadcrumb">
      <li><a href="/"><em class="fa-solid fa-chart-pie"></em> <?php echo _("Home");?></a></li>
      <li class="active"><?php echo _("Hepatitis Sample Type");?></li>
    </ol>
  </section>
      ...
      <div class="box-body">
        ...
        <form class="form-horizontal" method='post' name='addSampleForm' id='addSampleForm' autocomplete="off" enctype="multipart/form-data" action="save-hepatitis-sample-type-helper.php">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-lg-7">
                    <input type="text" class="form-control isRequired" id="sampleName" name="sampleName" placeholder="<?php echo _('Sample Name');?>" title="<?php echo _('Please enter Sample name');?>" onblur='checkNameValidation("r_hepatitis_sample_type","sample_name",this,null,"<?php echo _("The Sample name that you entered already exists.Enter another name");?>",null)' />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
          ...
          <div class="box-footer">
            ...
            <a href="hepatitis-sample-type.php" class="btn btn-default"> <?php echo _("Cancel");?></a>
          </div>
          <!-- /.box-footer -->
        </form>
        <!-- /.row -->
