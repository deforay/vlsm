...
$title = _translate("Hepatitis Co-morbidities");
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-square-h"></em> <?php echo _translate("Hepatitis Co-morbidities"); ?></h1>
		<ol class="breadcrumb">
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<a href="javascript:void(0);" onclick="forceMetadataSync('<?php echo $general->encrypt('r_hepatitis_comorbidities', base64_decode((string) $keyFromGlobalConfig)); ?>')" class="btn btn-success pull-right" style="margin-left: 10px;"> <em class="fa-solid fa-refresh"></em></a>
						<?php if (_isAllowed("hepatitis-sample-type.php") && $general->isLISInstance() === false) { ?>
							<a href="add-hepatitis-comorbidities.php" class="btn btn-primary pull-right"> <em class="fa-solid fa-plus"></em> <?php echo _translate("Add Hepatitis Co-morbidities"); ?></a>
						<?php } ?>
