...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-square-h"></em> <?php echo _translate("Add Hepatitis Test Reasons"); ?></h1>
		<ol class="breadcrumb">
			<li><a href="/"><em class="fa-solid fa-chart-pie"></em> <?php echo _translate("Home"); ?></a></li>
			<li class="active"><?php echo _translate("Hepatitis Test Reasons"); ?></li>
		</ol>
	</section>
			...
			<div class="box-body">
				...
				<form class="form-horizontal" method='post' name='addTstForm' id='addTstForm' autocomplete="off" enctype="multipart/form-data" action="save-hepatitis-test-reasons-helper.php">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="testReasonName" name="testReasonName" placeholder="<?php echo _translate('Test Reason Name'); ?>" title="<?php echo _translate('Please enter Test Reason name'); ?>" onblur='checkNameValidation("r_hepatitis_test_reasons","test_reason_name",this,null,"<?php echo _translate("The Test Reason name that you entered already exists.Enter another name"); ?>",null)' />
									</div>
								</div>
							</div>
							<div class="col-md-6">
					...
					<div class="box-footer">
						...
						<a href="hepatitis-test-reasons.php" class="btn btn-default"> <?php echo _translate("Cancel"); ?></a>
					</div>
					<!-- /.box-footer -->
				</form>
				<!-- /.row -->
