...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><em class="fa-solid fa-square-h"></em> <?php echo _("Add Hepatitis Sample Rejection Reasons"); ?></h1>
    <ol class="breadcrumb">
      ...
      <div class="box-body">
        ...
        <form class="form-horizontal" method='post' name='addSampleRejcForm' id='addSampleRejcForm' autocomplete="off" enctype="multipart/form-data" action="save-hepatitis-sample-rejection-reasons-helper.php">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-lg-7">
                    <select class="form-control isRequired select2 editableSelect" id="rejectionType" name="rejectionType" placeholder="<?php echo _('Rejection Type'); ?>" title="<?php echo _('Please enter Rejection Type'); ?>">
                    </select>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-lg-7">
                    <input type="text" class="form-control isRequired" id="rejectionReasonCode" name="rejectionReasonCode" placeholder="<?php echo _('Rejection Reason Code'); ?>" title="<?php echo _('Please enter Rejection Reason Code'); ?>" onblur='checkNameValidation("r_hepatitis_sample_rejection_reasons","rejection_reason_code",this,null,"<?php echo _("The Rejection Reason code that you entered already exists.Enter another Rejection Reason code"); ?>",null)' />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
          ...
          <div class="box-footer">
            ...
            <a href="hepatitis-sample-rejection-reasons.php" class="btn btn-default"> <?php echo _("Cancel"); ?></a>
          </div>
          <!-- /.box-footer -->
        </form>
        <!-- /.row -->
