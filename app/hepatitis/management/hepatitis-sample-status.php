...
$title = _translate("Hepatitis | Sample Status Report");
...
if (isset($sarr['sc_user_type']) && $sarr['sc_user_type'] == 'vluser' && !empty($sarr['sc_testing_lab_id'])) {
	$testingLabs = $facilitiesService->getTestingLabs('hepatitis', true, false, "facility_id = " . $sarr['sc_testing_lab_id']);
} else {
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-book"></em> <?php echo _translate("Hepatitis Sample Status Report"); ?></h1>
		<ol class="breadcrumb">
			<!-- <li><a href="/"><em class="fa-solid fa-chart-pie"></em> Home</a></li> -->
			<li><em class="fa-solid fa-book"></em> <?php echo _translate("Hepatitis"); ?></li>
			<li><?php echo _translate("Management"); ?></li>
			<li class="active"><?php echo _translate("Hepatitis Sample Status"); ?></li>
		</ol>
	</section>
	...
	<section class="content">
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body">
						<button class="btn btn-success pull-right" type="button" onclick="hepatitisExportTAT()"><em class="fa-solid fa-cloud-arrow-down"></em> <?php echo _translate("Export to excel"); ?></button>
						<table aria-describedby="table" id="hepatitisRequestDataTable" class="table table-bordered table-striped" aria-hidden="true">
							<thead>
								<tr>
									<th><?php echo _translate("Hepatitis Sample ID"); ?></th>
