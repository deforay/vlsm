...
foreach ($rResult as $aRow) {
    ...
    $row[] = $status;
    //$row[] = '<a href="updateVlTestResult.php?id=' . base64_encode($aRow['hepatitis_id']) . '" class="btn btn-success btn-xs" style="margin-right: 2px;" title="Result"><i class="fa-solid fa-pen-to-square"></i> Result</a>';
