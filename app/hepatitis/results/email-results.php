...
$batchQuery = "SELECT * FROM batch_details WHERE test_type='hepatitis' AND batch_status='completed'";
						...
						<div class="row">
							<div class="col-md-9">
								<div class="form-group">
									...
									<div class="col-lg-9">
										<input type="text" id="subject" name="subject" class="form-control isRequired" placeholder="<?php echo _translate('Subject'); ?>" title="<?php echo _translate('Please enter subject'); ?>" value="Hepatitis Test Results" />
									</div>
								</div>
							</div>
						</div>
...
<script type="text/javascript">
	...
	function getSampleDetails() {
		...
		var type = $('#type').val();
		$.post("/hepatitis/results/getRequestSampleCodeDetails.php", {
