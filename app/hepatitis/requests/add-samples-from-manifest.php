...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo _("Hepatitis Test Request"); ?>
			</li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body table-responsive">
						<table aria-describedby="table" id="hepatitisManifestDataTable"
							...
							<thead>
								<tr>
									...
									<th>
										<?php echo _("HCV VL Result"); ?>
									</th>
									<th>
										<?php echo _("HBV VL Result"); ?>
									</th>
									<th>
