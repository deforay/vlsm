      ...
      $sarr[$systemConfigResult[$i]['name']] = $systemConfigResult[$i]['value'];
        ...
        */
        ...
        foreach ($rResult as $aRow) {
            ...
            $row[] = '<a href="editVlFacilityMap.php?id=' . base64_encode($aRow['vl_lab_id']) . '" class="btn btn-primary btn-xs" style="margin-right: 2px;" title="Edit"><i class="fa-solid fa-pen-to-square"></i> Edit</i></a>';
           }
            $output['aaData'][] = $row;
        }
