      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header with-border">
            <?php if (_isAllowed("addVlFacilityMap.php") && (($general->isSTSInstance() || ($general->isStandaloneInstance())))) { ?>
            ...
            <table aria-describedby="table" id="facilityMapDataTable" class="table table-bordered table-striped" aria-hidden="true">
              <thead>
                <tr>
                  ...
                  <?php if (_isAllowed("editVlFacilityMap.php") && (($general->isSTSInstance() || ($general->isStandaloneInstance())))) { ?>
                    <th>Action</th>
                  <?php } ?>
                </tr>
              </thead>
