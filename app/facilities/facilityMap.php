      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header with-border">
            <?php if (_isAllowed("addVlFacilityMap.php") && (($_SESSION['instance']['type'] == 'remoteuser' || ($sarr['sc_user_type'] == 'standalone')))) { ?>
            ...
            <table aria-describedby="table" id="facilityMapDataTable" class="table table-bordered table-striped" aria-hidden="true">
              <thead>
                <tr>
                  ...
                  <?php if (_isAllowed("editVlFacilityMap.php") && (($_SESSION['instance']['type'] == 'remoteuser' || ($sarr['sc_user_type'] == 'standalone')))) { ?>
                    <th>Action</th>
                  <?php } ?>
                </tr>
              </thead>
