...
class GenericTestsService
{
    ...
    public function insertSampleCode($params)
    {
        try {
            ...
            $sampleJson = $this->generateGenericSampleID($provinceCode, $sampleCollectionDate, null, $provinceId, $oldSampleCodeKey);
            ...
            $sQuery = "SELECT sample_id, sample_code, sample_code_format, sample_code_key, remote_sample_code, remote_sample_code_format, remote_sample_code_key FROM form_vl ";
