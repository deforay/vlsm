...
class TestsService
{
    ...
    {
        return self::getTestTypes()[$key]['tableName'] ?? throw new InvalidArgumentException("Invalid test type key");
    }

    public static function getTestPrimaryKeyName(string $key): string
    {
        return self::getTestTypes()[$key]['primaryKey'] ?? throw new InvalidArgumentException("Invalid test type key");
    }

    public static function getTestName(string $key): string
    {
        return self::getTestTypes()[$key]['testName'] ?? throw new InvalidArgumentException("Invalid test type key");
    }

    public static function getTestShortName(string $key): string
    {
        return self::getTestTypes()[$key]['testShortName'] ?? throw new InvalidArgumentException("Invalid test type key");
    }
