...
//set print query
$hQuery = "SELECT hsr.sample_code FROM hold_sample_import as hsr $joinTypeWithTestTable form_hepatitis as vl ON vl.sample_code=hsr.sample_code";
                        ...
                        <tr>
                            <td>
                                ...
                                if (isset($tsResult[0]['totalCount']) && $tsResult[0]['totalCount'] > 0) { ?>
                                    ...
                                    <a href="/hepatitis/results/hepatitis-print-results.php" class="btn btn-success btn-sm">
