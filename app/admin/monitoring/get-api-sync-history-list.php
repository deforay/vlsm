...
foreach ($rResult as $key => $aRow) {
     ...
     $row[] = '<a href="javascript:void(0);" class="btn btn-success btn-xs" style="margin-right: 2px;" title="Result" onclick="showModal(\'show-params.php?id=' . base64_encode($aRow[$primaryKey]) . '\',900,520);"> Show Params</a>';
     $output['aaData'][] = $row;
}
