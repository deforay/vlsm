    ...
    <section class="content">
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <?php } ?>
                <!-- form start -->
                <form class="<?php echo $hide; ?> form-horizontal" method="post" name="moveSpecimenReferralManifestForm"
                    id="moveSpecimenReferralManifestForm" autocomplete="off"
                    action="moveSpecimenManifestCodeHelper.php">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7" style="margin-left:3%;">
                                        <input type="text" class="form-control" id="daterange" name="daterange"
                                            placeholder="<?php echo _('Date Range'); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7" style="margin-left:3%;">
                                        <select class="form-control select2" id="facilityName" name="facilityName"
                                            title="Choose one facility name">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7" style="margin-left:3%;">
                                        <select class="form-control select2 isRequired" id="testingLab"
                                            name="testingLab" title="Choose one test lab">
                            ...
                            <div class="col-md-12 text-center">
                                <div class="form-group">
                                    <a class="btn btn-primary" href="javascript:void(0);"
                                        ...
                                        onclick="getManifestCodeDetails();return false;">Search </a>
                                    <a href="move-manifest.php?t=<?= htmlspecialchars($_GET['t']); ?>"
                                        class="btn btn-default" onclick=""> Clear</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="box-footer">
                <a id="packageSubmit" class="btn btn-primary" href="javascript:void(0);" title="Please select machine"
                    onclick="validateNow();return false;" style="pointer-events:none;" disabled>Save </a>
