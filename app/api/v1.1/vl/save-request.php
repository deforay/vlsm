...
try {
    ...
    foreach ($input['data'] as $rootKey => $data) {
        ...
        $vlFulldata = array(
            ...
            'reason_for_vl_testing'                 => (isset($data['reasonForVLTesting'])) ? $data['reasonForVLTesting'] : NULL,
...
$general->addApiTracking($transactionId, $user['user_id'], count($input['data']), 'save-request', 'vl', $requestUrl, $origJson, $payload, 'json');
echo $payload;
exit(0);
