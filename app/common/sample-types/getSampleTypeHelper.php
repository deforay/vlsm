<?php
    ...
    $primaryKey="sample_type_id";
       ...
       $sQuery="SELECT * FROM r_sample_types";
      ...
      // echo $sQuery;
       ...
       // print_r($rResult);
        ...
        $aResultFilterTotal =$db->rawQuery("SELECT * FROM r_sample_types $sWhere order by $sOrder");
        $iFilteredTotal = count($aResultFilterTotal);

        /* Total data set length */
        $aResultTotal =  $db->rawQuery("SELECT * FROM r_sample_types");
