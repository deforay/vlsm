                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="form-control isRequired" id="sampleTypeName" name="sampleTypeName" placeholder="<?php echo _('Sample Type Name');?>" title="<?php echo _('Please enter sample type name');?>" onblur='checkNameValidation("r_sample_types","sample_type_name",this,null,"<?php echo _("The sample type name that you entered already exists.Enter another name");?>",null)' />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
