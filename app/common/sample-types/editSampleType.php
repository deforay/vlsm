...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <!-- form start -->
                <form class="form-horizontal" method='post' name='addSampleTypeForm' id='addSampleTypeForm' autocomplete="off" action="editSampleTypeHelper.php">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="form-control isRequired" id="sampleTypeName" name="sampleTypeName" placeholder="<?php echo _('Sample Type Name');?>" title="<?php echo _('Please enter sample type name');?>" onblur="checkNameValidation('r_sample_types','sample_type_name',this,'<?php echo "sample_type_id##" . $sampleTypeInfo[0]['sample_type_id']; ?>','<?php echo _("This sample type name that you entered already exists.Try another name");?>',null)" value="<?php echo $sampleTypeInfo[0]['sample_type_name']; ?>"/>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="sampleType.php" class="btn btn-default"> <?php echo _("Cancel");?></a>
                    </div>
                    <!-- /.box-footer -->
                </form>
                <!-- /.row -->
