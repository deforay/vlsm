...
if (session_status() == PHP_SESSION_NONE) {
    ...
    $primaryKey="test_reason_id";
       ...
       $sQuery="SELECT * FROM r_testing_reasons";
      ...
      // echo $sQuery;
       ...
       // print_r($rResult);
        ...
        $aResultFilterTotal =$db->rawQuery("SELECT * FROM r_testing_reasons $sWhere order by $sOrder");
        $iFilteredTotal = count($aResultFilterTotal);

        /* Total data set length */
        $aResultTotal =  $db->rawQuery("SELECT * FROM r_testing_reasons");
