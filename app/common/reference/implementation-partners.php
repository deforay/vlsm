				...
				<div class="box">
					<div class="box-header with-border">
						<?php if (_isAllowed("geographical-divisions-details.php") && $sarr['sc_user_type'] != 'vluser') { ?>
							<a href="add-implementation-partners.php" class="btn btn-primary pull-right"> <em class="fa-solid fa-plus"></em> <?php echo _translate("Add Implementation Partners"); ?></a>
						<?php } ?>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
