...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><i class="fa-solid fa-gears"></i> <?php echo _("Implementation Partners");?></h1>
		<ol class="breadcrumb">
				...
				<div class="box">
					<div class="box-header with-border">
						<?php if (isset($_SESSION['privileges']) && in_array("province-details.php", $_SESSION['privileges']) && $sarr['sc_user_type'] != 'vluser') { ?>
							<a href="add-implementation-partners.php" class="btn btn-primary pull-right"> <i class="fa-solid fa-plus"></i> <?php echo _("Add Implementation Partners");?></a>
						<?php } ?>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
...
<script>
	...
	$(document).ready(function() {
		...
		oTable = $('#partnerTable').dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "get-implementation-partners-helper.php",
