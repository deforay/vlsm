...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><em class="fa-solid fa-gears"></em> <?php echo _translate("Add Recommended Corrective Action"); ?></h1>
        <ol class="breadcrumb">
