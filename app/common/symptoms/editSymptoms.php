                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label for="symptomName" class="col-lg-4 control-label"><?php echo _("Symptom Name");?><span class="mandatory">*</span></label>
                                    <div class="col-lg-7">
                                        <input type="text" class="form-control isRequired" id="symptomName" name="symptomName" placeholder="<?php echo _('Symptom Name');?>" title="<?php echo _('Please enter symptom name');?>" onblur="checkNameValidation('r_symptoms','symptom_name',this,'<?php echo "symptom_id##" . $symptomInfo[0]['symptom_id']; ?>','<?php echo _("This symptom name that you entered already exists.Try another name");?>',null)" value="<?php echo $symptomInfo[0]['symptom_name']; ?>"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="symptomCode" class="col-lg-4 control-label"><?php echo _("Symptom Code");?><span class="mandatory">*</span></label>
                                    <div class="col-lg-7">
                                        <input type="text" class="form-control isRequired" id="symptomCode" name="symptomCode" placeholder="<?php echo _('Symptom Code');?>" title="<?php echo _('Please enter symptom code');?>" onblur="checkNameValidation('r_symptoms','symptom_code',this,'<?php echo "symptom_id##" . $symptomInfo[0]['symptom_id']; ?>','<?php echo _("This symptom code that you entered already exists.Try another code");?>',null)" value="<?php echo $symptomInfo[0]['symptom_code']; ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
