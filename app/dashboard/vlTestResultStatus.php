...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>VL Test Result Status [
			<?= ($tsResult[0]['status_name']); ?> ]
		</h1>
		<ol class="breadcrumb">
			<li><a href="/"><em class="fa-solid fa-chart-pie"></em> Home</a></li>
			<li class="active">VL Test Result Status [
				<?= ($tsResult[0]['status_name']); ?> ]
			</li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					<table aria-describedby="table" class="table" aria-hidden="true"
						...
						<tr>
							...
							<td>
								<select class="form-control" id="batchCode" name="batchCode"
									title="Please select batch code">
						...
						<tr>
							...
							<td>
								<select style="width:220px;" class="form-control" id="sampleType" name="sampleType"
									title="Please select sample type">
									<option value=""> -- Select -- </option>
									<?php
						...
						<tr>
							<td colspan="3">&nbsp;<input type="button" onclick="searchVlRequestData();" value="Search"
							...
							<div class="col-md-12">
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="0" id="iCol0"
										data-showhide="vlsm_country_id" class="showhideCheckBox" /> <label
								...
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="1" id="iCol1"
										...
										for="iCol1">Sample Collection Date</label>
								</div>
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="2" id="iCol2"
										data-showhide="batch_code" class="showhideCheckBox" /> <label for="iCol2">Batch
										Code</label> <br>
								</div>
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="3" id="iCol3"
										data-showhide="patient_art_no" class="showhideCheckBox" /> <label
										for="iCol3">Art No</label>
								</div>
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="4" id="iCol4"
										data-showhide="patient_first_name" class="showhideCheckBox" /> <label
										for="iCol4">Patient's Name</label> <br>
								</div>
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="5" id="iCol5"
										data-showhide="facility_name" class="showhideCheckBox" /> <label
										for="iCol5">Facility Name</label>
								</div>
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="6" id="iCol6"
										data-showhide="state" class="showhideCheckBox" /> <label
										for="iCol6">Province</label>
								</div>
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="7" id="iCol7"
										data-showhide="district" class="showhideCheckBox" /> <label
										for="iCol7">District</label>
								</div>
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="8" id="iCol8"
										data-showhide="sample_name" class="showhideCheckBox" /> <label
										for="iCol8">Sample Type</label>
								</div>
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="9" id="iCol9"
										data-showhide="result" class="showhideCheckBox" /> <label
										for="iCol9">Result</label>
								</div>
							</div>
						</div>
					</span>
					<!-- /.box-header -->
					<div class="box-body">
						<table aria-describedby="table" id="vlTestResultStatusDataTable"
