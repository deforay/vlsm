...
$title = _translate("EID Test Reasons");
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-child"></em> <?php echo _translate("EID Test Reasons"); ?></h1>
		<ol class="breadcrumb">
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header with-border">
						<a href="javascript:void(0);" onclick="forceMetadataSync('<?php echo $general->encrypt('r_eid_test_reasons', base64_decode((string) $keyFromGlobalConfig)); ?>')" class="btn btn-success pull-right" style="margin-left: 10px;"> <em class="fa-solid fa-refresh"></em></a>
						<?php if (_isAllowed("eid-sample-type.php") && $general->isLISInstance() === false) { ?>
							<a href="add-eid-test-reasons.php" class="btn btn-primary pull-right"> <em class="fa-solid fa-plus"></em> <?php echo _translate("Add EID Test Reasons"); ?></a>
						<?php } ?>
