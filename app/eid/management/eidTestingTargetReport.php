...
$title = _translate("EID Quarterly Monitoring Report");
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><em class="fa-solid fa-book"></em> <?php echo _translate("EARLY INFANT DIAGNOSIS - Testing Target Report"); ?>
      <!--<ol class="breadcrumb">-->
...
<script type="text/javascript">
  ...
  function loadVlRequestData() {
    ...
    oTable = $('#vlMonitoringTable').dataTable({
      ...
      "bProcessing": true,
      "bServerSide": true,
      "sAjaxSource": "getEidMonthlyThresholdReport.php",
