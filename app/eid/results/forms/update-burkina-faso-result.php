                            ...
                            <div class="box-body disabledForm">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35%">
                                            <select class="form-control" name="motherAlive" id="motherAlive" title="Please select the Alive or not" style="width:100%;">
                                                <option value=''> -- Select -- </option>
                                                <option value="no" <?php echo ($eidInfo['mother_alive'] == "no") ? 'selected="selected"' : ''; ?>><?= _translate('No'); ?></option>
                                ...
                                <div class="box-body">
                                    ...
                                    <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                        <tr>
                                            ...
                                            <td style="width:35%;">
                                                <select name="eidPlatform" id="eidPlatform" class="form-control result-optional" title="Please select the testing platform">
