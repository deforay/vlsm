        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                    ...
                    <div class="box box-default">
                        <div class="box-body disabledForm">
                            ...
                            <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                ...
                                <tr>
                                    <th scope="row" class="labels" style="width:15% !important">Mother's HIV Status:</th>
                                    <td style="width:35% !important">
                                    ...
                                    <th scope="row" class="labels" style="width:15% !important">ART given to the Mother during:</th>
                                    <td style="width:35% !important">
                            ...
                            <table aria-describedby="table" class="table" aria-hidden="true">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control dateTime" id="sampleReceivedDate" name="sampleReceivedDate" placeholder="<?= _("Please enter date"); ?>" title="Please enter sample receipt date" value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['sample_received_at_lab_datetime']) ?>" onchange="" style="width:100%;" />
                                    </td>
                                    <th scope="row"></th>
                                    <td></td>
                                </tr>
                            ...
                            <div class="box-body">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:25%;">
                                            <input type="text" value="<?= DateUtility::humanReadableDateFormat($eidInfo['result_approved_datetime']); ?>" class="form-control dateTime isRequired" id="approvedOnDateTime" name="approvedOnDateTime" placeholder="<?= _("Please enter date"); ?>" title="Please enter approved on" <?php echo $labFieldDisabled; ?> style="width:100%;" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="labels" style="width:25%;">Lab Tech. Comments <span class="mandatory">*</span></th>
                                        <td style="width:25%;">
                                            <textarea class="form-control isRequired" id="labTechCmt" name="labTechCmt" <?php echo $labFieldDisabled; ?> style="width:100%;" placeholder="Comments from the Lab Technician " title="Please Comments from the Lab Technician "><?= htmlspecialchars($eidInfo['lab_tech_comments']); ?></textarea>
                                        </td>
                                        <th scope="row" class="change-reason" style="display: none;">Reason for Changing <span class="mandatory">*</span></th>
                                        <td class="change-reason" style="display: none;"><textarea name="reasonForChanging" id="reasonForChanging" class="form-control date isRequired" placeholder="Enter the reason for changing" title="Please enter the reason for changing"></textarea></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="box-footer">
                    ...
                    <input type="hidden" class="" id="sampleReceivedDate" name="sampleReceivedDate" placeholder="<?= _("Please enter date"); ?>" title="Please enter sample receipt date" value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['sample_received_at_lab_datetime']) ?>" />
