						...
						<div class="box-body disabledForm">
							...
							<table class="table" aria-hidden="true"  style="width:100%">
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control date" id="mothersDob" name="mothersDob" placeholder="Date de naissance" title="Please enter Date de naissance" style="width:100%;" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['mother_dob']); ?>" onchange="" />
									</td>
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control date" id="childDob" name="childDob" placeholder="Date de naissance" title="Please enter Date de naissance" style="width:100%;" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['child_dob']) ?>" onchange="" />
									</td>
							...
							<table class="table" aria-hidden="true"  style="width:70%">
								...
								<tr>
									...
									<td>
										<input class="form-control dateTime isRequired" type="text" name="sampleCollectionDate" id="sampleCollectionDate" placeholder="Date de collecte" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['sample_collection_date']); ?>" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<input class="form-control" type="text" name="rapidtestDate" id="rapidtestDate" placeholder="Si oui, date" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['rapid_test_date']); ?>" />
									</td>
								</tr>
								<tr>
								...
								<div class="box-body">
									...
									<table class="table" aria-hidden="true"  style="width:100%">
										<tr>
											...
											<td>
												<input type="text" readonly class="form-control dateTime isRequired" id="sampleReceivedDate" name="sampleReceivedDate" placeholder="<?= _("Please enter date"); ?>" title="Date de réception de l'échantillon" <?php echo $labFieldDisabled; ?> value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['sample_received_at_vl_lab_datetime']) ?>" onchange="" style="width:100%;" />
											</td>
											<td><label for="labId">Nom du Laboratoire <span class="mandatory">*</span></label> </td>
											<td>
												<select name="labId" id="labId" class="form-control isRequired" title="Nom du Laboratoire" style="width:100%;">
										...
										<tr>
											...
											<td><input type="text" value="<?= \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['result_reviewed_datetime']); ?>" name="reviewedOn" id="reviewedOn" class="dateTime disabled-field form-control isRequired" placeholder="Date de revu" title="Date de revu" /></td>
										</tr>
