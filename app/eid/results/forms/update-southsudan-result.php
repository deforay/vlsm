        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                        ...
                        <div class="box-body disabledForm">
                            ...
                            <table class="table" aria-hidden="true" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control date" id="childDob" name="childDob" placeholder="Date of birth" title="Please enter Date of birth" style="width:100%;" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['child_dob']) ?>" onchange="" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" max=9 maxlength="1" oninput="this.value=this.value.slice(0,$(this).attr('maxlength'))" class="form-control " id="childAge" name="childAge" placeholder="Age" title="Age" style="width:100%;" onchange="" value="<?php echo $eidInfo['child_age']; ?>" /></td>
                            ...
                            <table class="table" aria-hidden="true" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control date" type="text" name="rapidtestDate" id="rapidtestDate" placeholder="if yes, test date" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['rapid_test_date']); ?>">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control date" type="text" name="previousPCRTestDate" id="previousPCRTestDate" placeholder="if yes, test date" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['last_pcr_date']); ?>" />
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="table" aria-hidden="true">
                                ...
                                <tr>
                                    ...
                                    <td style="width:35% !important;">
                                        <input class="form-control dateTime isRequired" type="text" name="sampleCollectionDate" id="sampleCollectionDate" placeholder="Sample Collection Date" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['sample_collection_date']); ?>" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control dateTime" id="sampleReceivedDate" name="sampleReceivedDate" placeholder="<?= _("Please enter date"); ?>" title="Please enter sample receipt date" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['sample_received_at_vl_lab_datetime']) ?>" onchange="" style="width:100%;" />
                                    </td>
                                    <th scope="row"></th>
                                    <td></td>
                                </tr>
                            ...
                            <div class="box-body">
                                ...
                                <table class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr class="show-rejection rejected" style="display:none;">
                                        ...
                                        <td><input value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['rejection_on']); ?>" class="form-control date rejection-date" type="text" name="rejectionDate" id="rejectionDate" placeholder="Select Rejection Date" title="Please enter sample rejection date" /></td>
                                    </tr>
                                    <tr>
                                        <th class="labels" style="width:25%;">Sample Test Date</th>
                                        <td style="width:25%;">
                                            <input type="text" class="form-control dateTime isRequired" id="sampleTestedDateTime" name="sampleTestedDateTime" placeholder="<?= _("Please enter date"); ?>" title="Please enter the Sample Tested Date and Time" <?php echo $labFieldDisabled; ?> onchange="" value="<?= \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['sample_tested_datetime']) ?>" style="width:100%;" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="labels" scope="row">Reviewed on <span class="mandatory review-approve-span" style="display: <?php echo ($eidInfo['is_sample_rejected'] != '') ? 'inline' : 'none'; ?>;">*</span></td>
                                        <td><input type="text" value="<?= \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['result_reviewed_datetime']); ?>" name="reviewedOn" id="reviewedOn" class="dateTime disabled-field form-control isRequired" placeholder="Reviewed on" title="Please enter reviewed on" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:25%;">
                                            <input type="text" value="<?= \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['result_approved_datetime']); ?>" class="form-control dateTime isRequired" id="approvedOnDateTime" name="approvedOnDateTime" placeholder="<?= _("Please enter date"); ?>" title="Please enter approved on" <?php echo $labFieldDisabled; ?> style="width:100%;" />
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <div class="box-footer">
                    ...
                    <input type="hidden" class="" id="sampleReceivedDate" name="sampleReceivedDate" placeholder="<?= _("Please enter date"); ?>" title="Please enter sample receipt date" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['sample_received_at_vl_lab_datetime']) ?>" />
