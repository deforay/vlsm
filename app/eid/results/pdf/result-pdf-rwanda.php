...
if (!empty($result)) {
    ...
    $sampleDispatchDate = '';
    $sampleDispatchTime = '';
    if (isset($result['result_dispatched_datetime']) && trim((string) $result['result_dispatched_datetime']) != '' && $result['result_dispatched_datetime'] != '0000-00-00 00:00:00') {
        $expStr = explode(" ", (string) $result['result_dispatched_datetime']);
