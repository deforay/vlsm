                                ...
                                <div class="box-body">
                                    ...
                                    <table class="table" aria-hidden="true"  style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:25%;">
                                                <input type="text" class="form-control dateTime" id="sampleTestedDateTime" name="sampleTestedDateTime" placeholder="<?= _("Please enter date"); ?>" title="Data da Quantificação" <?php echo $labFieldDisabled; ?> onchange="" style="width:100%;" value="<?php echo \App\Utilities\DateUtils::humanReadableDateFormat($eidInfo['sample_tested_datetime']) ?>" />
                                            </td>
