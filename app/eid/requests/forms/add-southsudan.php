                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="childDob" name="childDob"
                                                ...
                                                style="width:100%;" onchange="calculateAgeInMonths();" />
                                        </td>
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="row" style="width:15% !important" class="labels">ART given to the
                                            Mother during:</th>
                                        <td style="width:35% !important">
                                            <input type="checkbox" name="motherTreatment[]" value="No ART given" /> No
                                            ART given <br>
                                            <input type="checkbox" name="motherTreatment[]" value="Pregnancy" />
                                            Pregnancy <br>
                                            <input type="checkbox" name="motherTreatment[]" value="Labour/Delivery" />
                                            Labour/Delivery <br>
                                            <input type="checkbox" name="motherTreatment[]" value="Postnatal" />
                                            Postnatal <br>
