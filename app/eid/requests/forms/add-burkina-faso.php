                            ...
                            <div class="box-body">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    <tr>
                                        <?php if ($_SESSION['accessType'] == 'collection-site') { ?>
                                            <td class="labels" style="width:15%"><label for="sampleCode"><?= _translate("Sample ID"); ?> </label></td>
                                            <td style="width:35%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35%"> <input type="text" class="form-control" id="clinicianName" name="clinicianName" placeholder="Requesting Clinician Name" title="Please enter request clinician" /></td>
                                    </tr>
                                </table>
                                <br>
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35%">
                                            <input type="text" class="form-control " id="childName" name="childName" placeholder="Infant name" title="Please enter Infant Name" style="width:100%;" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35%"><input type="number" step=".1" max="60" maxlength="4" class="form-control isRequired" id="childAge" name="childAge" placeholder="Age" title="Age" style="width:100%;" /></td>
                                        <th style="width:15%" scope="row" class="labels"><?= _translate("Mother ART Number"); ?></th>
                                        <td style="width:35%"><input type="text" class="form-control " id="mothersId" name="mothersId" placeholder="Mother ART Number" title="Mother ART Number" style="width:100%;" /></td>
                                    </tr>
                                    <tr>
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35%">
                                            <input type="text" class="form-control date" id="mothersDob" name="mothersDob" placeholder="Date of birth" title="Please enter Date of birth" style="width:100%;" onchange="calculateAgeInYears('mothersDob', 'motherAgeInYears');" style="width:100%;" />
                                        </td>
                                        ...
                                        <td style="width:35%"><input type="number" step=".1" max="60" maxlength="4" class="form-control isRequired" id="motherAgeInYears" name="motherAgeInYears" placeholder="Enter mother age" title="Please enter mother age" style="width:100%;" /></td>
                                    </tr>
                                    <tr>
