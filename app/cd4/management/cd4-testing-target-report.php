...
$title = _translate("CD4 Quarterly Monitoring Report");
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><em class="fa-solid fa-book"></em> <?php echo _translate("CD4 Testing Target Report"); ?>
    </h1>
    <ol class="breadcrumb">
...
<script type="text/javascript">
  ...
  function loadVlRequestData() {
    ...
    oTable = $('#vlMonitoringTable').dataTable({
      ...
      "bProcessing": true,
      "bServerSide": true,
      "sAjaxSource": "get-cd4-monthly-threshold-report.php",
