...
$title = _translate("CD4 | View All Requests");
                        ...
                        <table aria-describedby="table" id="cd4FailedRequestDataTable" class="table table-bordered table-striped" aria-hidden="true">
                            <thead>
                                <tr>
                                    ...
                                    <?php if ((_isAllowed("/cd4/requests/cd4-edit-request.php"))) { ?>
                                        <th>
...
<script type="text/javascript">
    ...
    function loadVlRequestData() {
        ...
        oTable = $('#cd4FailedRequestDataTable').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "/cd4/results/get-failed-results.php",
    ...
    function retestSample(id, bulk = false) {
        ...
        if (id != "") {
            $.blockUI();
            $.post("/cd4/results/failed-results-retest.php", {
                    cd4Id: id,
                    bulkIds: bulk
                },
                function(data) {
