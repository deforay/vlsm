...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><em class="fa-solid fa-print"></em> <?php echo _translate("Print CD4 Results"); ?></h1>
        <ol class="breadcrumb">
            <li><a href="/"><em class="fa-solid fa-chart-pie"></em> <?php echo _translate("Home"); ?></a></li>
            <li class="active"><?php echo _translate("Print CD4 Results"); ?></li>
        </ol>
    </section>
    <!-- Main content -->
...
<script type="text/javascript">
    ...
    function loadVlRequestData() {
        ...
        oTable = $('#notPrintedTable').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "/cd4/results/get-results-for-print.php",
