...
//$cd4Results = $cd4Service->getCd4Results();
...
if (!isset($_POST['status']) || trim((string) $_POST['status']) == '') {
    if (isset($_POST['vlPrint']) && $_POST['vlPrint'] == 'not-print') {
        ...
        $sWhere[] = " ((vl.result_status = 7 AND vl.cd4_result is NOT NULL AND vl.cd4_result !='') OR (vl.result_status = 4 AND (vl.cd4_result is NULL OR vl.cd4_result = ''))) AND (result_printed_datetime is not NULL OR result_printed_datetime  > '0000-00-00')";
    }
} else {
