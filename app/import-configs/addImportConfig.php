						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control" id="dateFormat" name="dateFormat" placeholder='<?php echo _("d/m/Y"); ?>' title='<?php echo _("Please enter the date format"); ?>' />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<table border="0" class="table table-striped table-bordered table-condensed" aria-hidden="true" style="width:100%;">
								...
								<tbody id="machineTable">
									<tr>
										<td>
											<input type="text" name="configMachineName[]" id="configMachineName1" class="form-control configMachineName isRequired" placeholder='<?php echo _("Machine Name"); ?>' title='<?php echo _("Please enter machine name"); ?>' onblur="checkMachineName(this);" />
										</td>
										<td>
											<div class="col-md-3">
