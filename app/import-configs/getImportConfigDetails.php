      ...
      // echo $sQuery;
        ...
        */
        ...
        foreach ($rResult as $aRow) {
	        ...
	        $row[] = '<a href="editImportConfig.php?id=' . base64_encode($aRow['config_id']) . '" class="btn btn-default btn-xs" style="margin-right: 2px;" title="'. _("Edit").'"><i class="fa-solid fa-pen-to-square"></i> '. _("Edit").'</i></a>';
            $output['aaData'][] = $row;
        }
