...
('Generic Maximum Length', 'generic_max_length', NULL, 'generic-tests', 'yes', '2021-11-02 18:16:53', NULL, 'active'),
('Generic Minimum Length', 'generic_min_length', NULL, 'generic-tests', 'yes', '2021-11-02 18:16:53', NULL, 'active'),
('Generic Sample Code Format', 'generic_sample_code', 'MMYY', 'generic-tests', 'yes', '2021-11-02 17:48:32', NULL, 'active'),
('Sample Lock Expiry Days', 'generic_sample_lock_after_days', NULL, 'generic-tests', 'yes', '2021-11-02 17:48:32', NULL, 'active'),
...
(1, 'users', 'users.php', NULL, 'Access', NULL, 'always'),
(2, 'users', 'addUser.php', NULL, 'Add', NULL, 'always'),
(3, 'users', 'editUser.php', NULL, 'Edit', NULL, 'always'),
(4, 'facilities', 'facilities.php', NULL, 'Access', NULL, 'always'),
(5, 'facilities', 'addFacility.php', NULL, 'Add', NULL, 'always'),
(6, 'facilities', 'editFacility.php', NULL, 'Edit', NULL, 'always'),
(7, 'global-config', 'globalConfig.php', NULL, 'Access', NULL, 'always'),
(8, 'global-config', 'editGlobalConfig.php', NULL, 'Edit', NULL, 'always'),
...
(12, 'vl-requests', '/vl/requests/vl-requests.php', NULL, 'View', 1, 'always'),
...
(16, 'vl-batch', '/batch/batches.php?type=vl', NULL, 'Access', 1, 'always'),
(17, 'vl-batch', '/batch/add-batch.php?type=vl', NULL, 'Add', 2, 'always'),
(18, 'vl-batch', '/batch/edit-batch.php?type=vl', NULL, 'Edit', 3, 'always'),
(20, 'vl-results', '/vl/results/vlPrintResult.php', NULL, 'Print Result PDF', NULL, 'always'),
(21, 'vl-results', '/vl/results/vlTestResult.php', NULL, 'Enter Result Manually', NULL, 'always'),
...
(25, 'roles', 'roles.php', NULL, 'Access', NULL, 'always'),
(26, 'roles', 'editRole.php', NULL, 'Edit', NULL, 'always'),
...
(39, 'roles', 'addRole.php', NULL, 'Add', NULL, 'always'),
...
(65, 'facilities', 'facilityMap.php', NULL, 'Access Facility Map', NULL, 'always'),
...
(74, 'eid-requests', '/eid/requests/eid-add-request.php', NULL, 'Add', 2, 'always'),
...
(77, 'eid-batches', '/batch/batches.php?type=eid', NULL, 'View Batches', 1, 'always'),
(78, 'eid-batches', '/batch/add-batch.php?type=eid', NULL, 'Add Batch', 2, 'always'),
(79, 'eid-batches', '/batch/edit-batch.php?type=eid', NULL, 'Edit Batch', 3, 'always'),
(80, 'eid-results', '/eid/results/eid-manual-results.php', NULL, 'Enter Result Manually', NULL, 'always'),
...
(95, 'covid-19-requests', '/covid-19/requests/covid-19-add-request.php', NULL, 'Add', 2, 'always'),
...
(99, 'covid-19-results', '/covid-19/results/covid-19-print-results.php', NULL, 'Print Results', NULL, 'always'),
(100, 'covid-19-batches', '/batch/batches.php?type=covid19', NULL, 'View Batches', 1, 'always'),
(101, 'covid-19-batches', '/batch/add-batch.php?type=covid19', NULL, 'Add Batch', 2, 'always'),
(102, 'covid-19-batches', '/batch/edit-batch.php?type=covid19', NULL, 'Edit Batch', 3, 'always'),
(103, 'covid-19-results', '/covid-19/results/covid-19-manual-results.php', NULL, 'Enter Result Manually', NULL, 'always'),
...
(123, 'covid-19-reference', '/covid-19/reference/covid19-sample-type.php', NULL, 'Manage Reference', NULL, 'always'),
...
(143, 'vl-reports', '/vl/program-management/vlMonthlyThresholdReport.php', NULL, 'Monthly Threshold Report', NULL, 'always'),
(144, 'eid-management', '/eid/management/eidMonthlyThresholdReport.php', NULL, 'Monthly Threshold Report', NULL, 'always'),
(145, 'covid-19-management', '/covid-19/management/covid19MonthlyThresholdReport.php', NULL, 'Monthly Threshold Report', NULL, 'always'),
...
(164, 'hepatitis-results', '/hepatitis/results/hepatitis-manual-results.php', NULL, 'Enter Result Manually', NULL, 'always'),
...
(167, 'hepatitis-reference', '/hepatitis/reference/hepatitis-sample-type.php', NULL, 'Manage Hepatitis Reference', NULL, 'always'),
(168, 'vl-reports', '/vl/program-management/vlSuppressedTargetReport.php', NULL, 'Suppressed Target report', NULL, 'always'),
(169, 'hepatitis-batches', '/batch/batches.php?type=hepatitis', NULL, 'View Batches', 1, 'always'),
(170, 'hepatitis-batches', '/batch/add-batch.php?type=hepatitis', NULL, 'Add Batch', 2, 'always'),
(171, 'hepatitis-batches', '/batch/edit-batch.php?type=hepatitis', NULL, 'Edit Batch', 3, 'always'),
...
(187, 'common-reference', 'sync-history.php', NULL, 'Sync History', NULL, 'always'),
...
(194, 'tb-results', '/tb/results/tb-manual-results.php', NULL, 'Enter Result Manually', NULL, 'always'),
...
(199, 'tb-management', '/tb/management//batch/batches.php?type=tb', NULL, 'View Batches', NULL, 'always'),
(200, 'tb-management', '/tb/management//batch/add-batch.php?type=tb', NULL, 'Add Batch', NULL, 'always'),
(201, 'tb-management', '/tb/management//batch/edit-batch.php?type=tb', NULL, 'Edit Batch', NULL, 'always'),
...
(208, 'common-reference', 'activity-log.php', NULL, 'User Activity Log', NULL, 'always'),
...
(224, 'common-reference', 'audit-trail.php', NULL, 'Audit Trail', NULL, 'always'),
(225, 'vl-reference', '/vl/reference/vl-results.php', NULL, 'Manage VL Results', NULL, 'always'),
(226, 'common-reference', 'sync-status.php', NULL, 'Sync Status', NULL, 'always'),
...
(277, 'generic-results', '/generic-tests/results/generic-test-results.php', NULL, 'Manage Test Results', NULL, 'always'),
...
(317, 'vl-results', '/import-result/import-file.php?t=vl', NULL, 'Import Result from Files', NULL, 'always'),
(318, 'eid-results', '/import-result/import-file.php?t=eid', NULL, 'Import Result from Files', NULL, 'always'),
(319, 'covid-19-results', '/covid-19/results//import-result/import-file.php?t=covid19', NULL, 'Import Result from Files', NULL, 'always'),
(320, 'hepatitis-results', '/import-result/import-file.php?t=hepatitis', NULL, 'Import Result from Files', NULL, 'always'),
(321, 'tb-results', '/import-result/import-file.php?t=tb', NULL, 'Import Result from Files', NULL, 'always'),
...
(347, 'generic-tests-config', '/generic-tests/configuration/test-type.php', NULL, 'Add/Edit Test Types', NULL, 'always'),
(348, 'generic-tests-config', '/generic-tests/configuration/sample-types/generic-sample-type.php', NULL, 'Manage Sample Types', NULL, 'always'),
(349, 'generic-tests-config', '/generic-tests/configuration/testing-reasons/generic-testing-reason.php', NULL, 'Manage Testing Reasons', NULL, 'always'),
(350, 'generic-tests-config', '/generic-tests/configuration/symptoms/generic-symptoms.php', NULL, 'Manage Symptoms', NULL, 'always'),
(351, 'generic-tests-config', '/generic-tests/configuration/sample-rejection-reasons/generic-sample-rejection-reasons.php', NULL, 'Manage Sample Rejection Reasons', NULL, 'always'),
(352, 'generic-tests-config', '/generic-tests/configuration/test-failure-reasons/generic-test-failure-reason.php', NULL, 'Manage Test Failure Reasons', NULL, 'always'),
(353, 'generic-tests-config', '/generic-tests/configuration/test-result-units/generic-test-result-units.php', NULL, 'Manage Test Result Units', NULL, 'always'),
(354, 'generic-tests-config', '/generic-tests/configuration/test-methods/generic-test-methods.php', NULL, 'Manage Test Methods', NULL, 'always'),
(355, 'generic-tests-config', '/generic-tests/configuration/test-categories/generic-test-categories.php', NULL, 'Manage Test Categories', NULL, 'always'),
(356, 'generic-tests-batches', '/batch/batches.php?type=generic-tests', NULL, 'Manage Batch', 1, 'always'),
(357, 'generic-tests-batches', '/batch/add-batch.php?type=generic-tests', NULL, 'Add New Batch', 2, 'always'),
(358, 'generic-tests-batches', '/batch/edit-batch.php?type=generic-tests', NULL, 'Edit Batch', 3, 'always'),
...
(415, 'facilities', 'upload-facilities.php', NULL, 'Upload Facilities', NULL, 'always');
...
--
ALTER TABLE `privileges`
  MODIFY `privilege_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=416;
