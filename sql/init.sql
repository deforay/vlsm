...
--
DELIMITER $$
CREATE TRIGGER `form_cd4_data__ai` AFTER INSERT ON `form_cd4` FOR EACH ROW INSERT INTO `audit_form_cd4` SELECT 'insert', NULL, NOW(), d.*
    FROM `form_cd4` AS d WHERE d.cd4_id = NEW.cd4_id
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `form_cd4_data__au` AFTER UPDATE ON `form_cd4` FOR EACH ROW INSERT INTO `audit_form_cd4` SELECT 'update', NULL, NOW(), d.*
    FROM `form_cd4` AS d WHERE d.cd4_id = NEW.cd4_id
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `form_cd4_data__bd` BEFORE DELETE ON `form_cd4` FOR EACH ROW INSERT INTO `audit_form_cd4` SELECT 'delete', NULL, NOW(), d.*
...
--
-- Indexes for table `audit_form_cd4`
--
...
--
-- AUTO_INCREMENT for table `audit_form_cd4`
--
ALTER TABLE `audit_form_cd4`
