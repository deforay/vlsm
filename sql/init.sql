...
--
-- Table structure for table `audit_form_cd4`
--

DROP TABLE IF EXISTS `audit_form_cd4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `audit_form_cd4` (
  ...
  PRIMARY KEY (`cd4_id`,`revision`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `audit_form_cd4`
--

LOCK TABLES `audit_form_cd4` WRITE;
/*!40000 ALTER TABLE `audit_form_cd4` DISABLE KEYS */;
/*!40000 ALTER TABLE `audit_form_cd4` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `form_cd4` (
  `cd4_id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(64) DEFAULT NULL,
  `vlsm_instance_id` varchar(64) NOT NULL,
  `vlsm_country_id` int(11) DEFAULT NULL,
  `remote_sample` varchar(10) NOT NULL DEFAULT 'no',
...
--
-- Dumping data for table `form_cd4`
--

LOCK TABLES `form_cd4` WRITE;
/*!40000 ALTER TABLE `form_cd4` DISABLE KEYS */;
/*!40000 ALTER TABLE `form_cd4` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `form_vl` (
  ...
  KEY `patient_middle_name` (`patient_middle_name`),
  KEY `patient_last_name` (`patient_last_name`),
  KEY `reason_for_vl_testing` (`reason_for_vl_testing`),
  KEY `sample_batch_id` (`sample_batch_id`),
  KEY `funding_source` (`funding_source`),
  KEY `implementing_partner` (`implementing_partner`),
  KEY `reason_for_sample_rejection` (`reason_for_sample_rejection`),
...
CREATE TABLE `generic_test_reason_map` (
  ...
  `updated_datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`map_id`),
  UNIQUE KEY `idx_test_reason_id_test_type_id` (`test_reason_id`,`test_type_id`),
  KEY `test_type_id` (`test_type_id`),
...
CREATE TABLE `generic_test_sample_type_map` (
  ...
  `updated_datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`map_id`),
  UNIQUE KEY `idx_sample_type_id_test_type_id` (`sample_type_id`,`test_type_id`),
...
INSERT INTO `global_config` VALUES ('App Locale/Language','app_locale','en_EN','common','no',NULL,NULL,'active'),('App Menu Name','app_menu_name','VLSM','app','no','2022-02-18 16:28:05',NULL,'active'),('Auto Approval','auto_approval','yes','general','no','2022-02-18 16:28:05',NULL,'inactive'),('Barcode Format','barcode_format','C39','general','no','2022-02-18 16:28:05','daemon','active'),('Barcode Printing','bar_code_printing','off','general','no','2022-02-18 16:28:05','daemon','active'),('Batch PDF Layout','batch_pdf_layout','standard','general','no',NULL,NULL,'active'),('CD4 Maximum Length','cd4_max_length','','cd4','no','2024-02-21 15:13:51','456456amit2w343ersd3456t4yrgdfsew2','active'),('CD4 Minimum Length','cd4_min_length','','cd4','no','2024-02-21 15:13:51','456456amit2w343ersd3456t4yrgdfsew2','active'),('Minimum Patient ID Length','cd4_min_patient_id_length','','cd4','no','2024-02-21 15:13:51','456456amit2w343ersd3456t4yrgdfsew2','active'),('CD4 Sample Code Format','cd4_sample_code','MMYY','cd4','no','2024-02-21 15:13:51','456456amit2w343ersd3456t4yrgdfsew2','active'),('CD4 Sample Code Prefix','cd4_sample_code_prefix','CD4','cd4','no','2024-02-21 15:13:51','456456amit2w343ersd3456t4yrgdfsew2','active'),('Show Participant Name in Manifest','cd4_show_participant_name_in_manifest','yes','CD4','no','2024-02-21 15:13:51','456456amit2w343ersd3456t4yrgdfsew2','active'),('COVID-19 Auto Approve API Results','covid19_auto_approve_api_results','no','covid19','no',NULL,NULL,'active'),('Generate Patient Code','covid19_generate_patient_code','no','covid19','no','2022-02-18 16:28:05',NULL,'active'),('Covid-19 Maximum Length','covid19_max_length','','covid19','no','2022-02-18 16:28:05',NULL,'active'),('Minimum Patient ID Length','covid19_min_patient_id_length',NULL,'covid19','no',NULL,NULL,'active'),('Patient Code Prefix','covid19_patient_code_prefix','P','covid19','no','2022-02-18 16:28:05',NULL,'active'),('Positive Confirmatory Tests Required By Central Lab','covid19_positive_confirmatory_tests_required_by_central_lab','yes','covid19','no','2022-02-18 16:28:05',NULL,'active'),('COVID-19 Report QR Code','covid19_report_qr_code','no',NULL,'no','2022-02-18 16:28:05',NULL,'active'),('Report Type','covid19_report_type','default','covid19','no','2022-02-18 16:28:05',NULL,'active'),('Covid-19 Sample Code Format','covid19_sample_code','MMYY','covid19','no','2022-02-18 16:28:05',NULL,'active'),('Covid-19 Sample Code Prefix','covid19_sample_code_prefix','C19','covid19','no','2022-02-18 16:28:05',NULL,'active'),('Show Participant Name in Manifest','covid19_show_participant_name_in_manifest','yes','COVID19','no',NULL,NULL,'active'),('Covid19 Tests Table in Results Pdf','covid19_tests_table_in_results_pdf','no','covid19','no','2022-02-18 16:28:05',NULL,'active'),('Data Sync Interval','data_sync_interval','30','general','no','2022-02-18 16:28:05',NULL,'active'),('CSV Delimiter','default_csv_delimiter',',','general','no',NULL,NULL,'active'),('CSV Enclosure','default_csv_enclosure','\"','general','no',NULL,NULL,'active'),('Default Phone Prefix','default_phone_prefix',NULL,'general','no',NULL,NULL,'active'),('Default Time Zone','default_time_zone','UTC','general','no','2022-02-18 16:28:05','daemon','active'),('Display Encrypt PII Option','display_encrypt_pii_option','no','general','no',NULL,NULL,'active'),('Edit Profile','edit_profile','yes','general','no','2022-02-18 16:28:05','daemon','active'),('EID Auto Approve API Results','eid_auto_approve_api_results','no','eid','no',NULL,NULL,'active'),('EID Maximum Length','eid_max_length','','eid','no','2022-02-18 16:28:05','daemon','active'),('Minimum Patient ID Length','eid_min_patient_id_length',NULL,'eid','no',NULL,NULL,'active'),('EID Report QR Code','eid_report_qr_code','yes','EID','no',NULL,NULL,'active'),('EID Sample Code','eid_sample_code','MMYY','eid','no','2022-02-18 16:28:05','daemon','active'),('EID Sample Code Prefix','eid_sample_code_prefix','EID','eid','no','2022-02-18 16:28:05','daemon','active'),('Show Participant Name in Manifest','eid_show_participant_name_in_manifest','yes','EID','no',NULL,NULL,'active'),('Enable QR Code Mechanism','enable_qr_mechanism','no','general','no','2022-02-18 16:28:05',NULL,'inactive'),('Minimum Patient ID Length','generic_min_patient_id_length',NULL,'generic','no',NULL,NULL,'active'),('Generic Sample Code Format','generic_sample_code','MMYY','generic-tests','yes','2021-11-02 17:48:32',NULL,'active'),('Lab Tests Show Participant Name in Manifest','generic_show_participant_name_in_manifest',NULL,'generic-tests','yes','2021-11-02 17:48:32',NULL,'active'),('Other Tests Table in Results Pdf','generic_tests_table_in_results_pdf','no','generic-tests','yes','2024-03-26 20:15:07',NULL,'active'),('Date Format','gui_date_format','d-M-Y','general','no',NULL,NULL,'active'),('Header','header','MINISTRY OF HEALTH','general','no','2022-02-18 16:28:05','daemon','active'),('Minimum Patient ID Length','hepatitis_min_patient_id_length',NULL,'hepatitis','no',NULL,NULL,'active'),('Hepatitis Report QR Code','hepatitis_report_qr_code','yes',NULL,NULL,NULL,NULL,'active'),('Hepatitis Sample Code Format','hepatitis_sample_code','MMYY','hepatitis','no','2022-02-18 16:28:05',NULL,'active'),('Hepatitis Sample Code Prefix','hepatitis_sample_code_prefix','HEP','hepatitis','no','2022-02-18 16:28:05',NULL,'active'),('Show Participant Name in Manifest','hepatitis_show_participant_name_in_manifest','yes','HEPATITIS','no',NULL,NULL,'active'),('Result PDF High Viral Load Message','h_vl_msg','','vl','no','2022-02-18 16:28:05','daemon','active'),('Import Non matching Sample Results from Machine generated file','import_non_matching_sample','yes','general','no','2022-02-18 16:28:05','daemon','active'),('Instance Type ','instance_type','Both','general','no','2022-02-18 16:28:05','daemon','active'),('Key','key',NULL,'general','yes',NULL,NULL,'active'),('Lock Approved Covid-19 Samples','lock_approved_covid19_samples','no','covid19','no','2022-02-18 16:28:05',NULL,'active'),('Lock Approved EID Samples','lock_approved_eid_samples','no','eid','no','2022-02-18 16:28:05',NULL,'active'),('Lock Approved TB Samples','lock_approved_tb_samples','no','tb','no','2022-02-18 16:28:05',NULL,'active'),('Lock approved VL Samples','lock_approved_vl_samples','no','vl','no','2022-02-18 16:28:05',NULL,'active'),('Logo','logo',NULL,'general','no','2022-02-18 16:28:05','daemon','active'),('Low Viral Load (text results)','low_vl_text_results','Target Not Detected, TND, < 20, < 40','vl','yes','2022-02-18 16:28:05',NULL,'active'),('Result PDF Low Viral Load Message','l_vl_msg','','vl','yes','2022-02-18 16:28:05','daemon','active'),('Maximum Length','max_length','','vl','no','2022-02-18 16:28:05','daemon','active'),('Maximum Length of Phone Number','max_phone_length',NULL,'general','no',NULL,NULL,'active'),('Minimum Length','min_length','','vl','no','2022-02-18 16:28:05','daemon','active'),('Minimum Length of Phone Number','min_phone_length',NULL,'general','no',NULL,NULL,'active'),('Patient Name in Result PDF','patient_name_pdf','flname','general','no','2022-02-18 16:28:05','daemon','active'),('Result PDF Mandatory Fields','r_mandatory_fields',NULL,'vl','yes','2022-02-18 16:28:05',NULL,'active'),('Sample Code','sample_code','MMYY','vl','no','2022-02-18 16:28:05','daemon','active'),('Sample Code Prefix','sample_code_prefix','VL','general','no','2022-02-18 16:28:05','daemon','active'),('Sample Type','sample_type','enabled',NULL,'no','2022-02-18 16:28:05',NULL,'active'),('Do you want to show emoticons on the result pdf?','show_smiley','yes','general','no','2022-02-18 16:28:05','daemon','active'),('Support Email','support_email','','general','no',NULL,'','active'),('TB Auto Approve API Results','tb_auto_approve_api_results','no','tb','no',NULL,NULL,'active'),('TB Maximum Length','tb_max_length',NULL,'tb','no','2022-02-18 16:28:05',NULL,'active'),('Minimum Patient ID Length','tb_min_patient_id_length',NULL,'tb','no',NULL,NULL,'active'),('TB Sample Code Format','tb_sample_code','MMYY','tb','no','2022-02-18 16:28:05',NULL,'active'),('TB Sample Code Prefix','tb_sample_code_prefix','TB','tb','no','2022-02-18 16:28:05',NULL,'active'),('Show Participant Name in Manifest','tb_show_participant_name_in_manifest','yes','TB','no',NULL,NULL,'active'),('Testing Status','testing_status','enabled','vl','no','2022-02-18 16:28:05',NULL,'active'),('Training Mode','training_mode','no','common','no','2023-10-16 17:03:43',NULL,'active'),('Training Mode Text','training_mode_text','TRAINING SERVER','common','no','2023-10-16 17:03:43',NULL,'active'),('Same user can Review and Approve','user_review_approve','yes','general','no','2022-02-18 16:28:05','daemon','active'),('Viral Load Threshold Limit','viral_load_threshold_limit','1000','vl','no','2022-02-18 16:28:05','daemon','active'),('Vldashboard Url','vldashboard_url',NULL,'general','yes','2022-02-18 16:28:05','daemon','active'),('VL Auto Approve API Results','vl_auto_approve_api_results','no','vl','no',NULL,NULL,'active'),('Display VL Log Result','vl_display_log_result','yes','vl','no',NULL,NULL,'active'),('Display VL Log Result','vl_display_page_no_in_footer','yes','vl','no',NULL,NULL,'active'),('Display VL Log Result','vl_display_signature_table','yes','vl','no',NULL,NULL,'active'),('Viral Load Export Format','vl_excel_export_format','default','VL','no',NULL,'','active'),('Viral Load Form','vl_form',NULL,'general','no','2022-02-18 16:28:05','daemon','active'),('Interpret and Convert VL Results','vl_interpret_and_convert_results','no','VL','yes',NULL,NULL,'active'),('Minimum Patient ID Length','vl_min_patient_id_length',NULL,'vl','no',NULL,NULL,'active'),('VL Monthly Target','vl_monthly_target','no','vl','no','2022-02-18 16:28:05','','active'),('VL Report QR Code','vl_report_qr_code','yes','vl','no',NULL,NULL,'active'),('Show Participant Name in Manifest','vl_show_participant_name_in_manifest','yes','VL','no',NULL,NULL,'active');
...
CREATE TABLE `health_facilities` (
  `test_type` enum('vl','eid','covid19','hepatitis','tb','cd4','generic-tests') NOT NULL,
...
CREATE TABLE `instrument_controls` (
  ...
  PRIMARY KEY (`test_type`,`instrument_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `instruments` (
  ...
  `additional_text` varchar(256) DEFAULT NULL,
...
--
-- Dumping data for table `lab_storage`
--

LOCK TABLES `lab_storage` WRITE;
/*!40000 ALTER TABLE `lab_storage` DISABLE KEYS */;
/*!40000 ALTER TABLE `lab_storage` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `r_cd4_sample_rejection_reasons`
--

LOCK TABLES `r_cd4_sample_rejection_reasons` WRITE;
/*!40000 ALTER TABLE `r_cd4_sample_rejection_reasons` DISABLE KEYS */;
/*!40000 ALTER TABLE `r_cd4_sample_rejection_reasons` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `r_cd4_sample_types`
--

LOCK TABLES `r_cd4_sample_types` WRITE;
/*!40000 ALTER TABLE `r_cd4_sample_types` DISABLE KEYS */;
/*!40000 ALTER TABLE `r_cd4_sample_types` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `r_cd4_test_reasons`
--

LOCK TABLES `r_cd4_test_reasons` WRITE;
/*!40000 ALTER TABLE `r_cd4_test_reasons` DISABLE KEYS */;
/*!40000 ALTER TABLE `r_cd4_test_reasons` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `r_vl_art_regimen` VALUES (1,'1a = TDF+3TC+DTG',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(2,'1b = TDF+3TC+EFV',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(3,'1c = ABC+3TC+EFV',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(4,'1d = ABC+3TC+NVP',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(5,'1e = TDF+3TC+NVP',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(6,'1f = ABC+3TC+DTG',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(7,'1g = AZT+3TC+EFV',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(8,'1h = AZT+3TC+NVP',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(9,'2a = AZT+3TC+ATV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(10,'2b = AZT+3TC+LPV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(11,'2c = AZT+3TC+DTG',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(12,'2d = TDF+3TC+ATV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(13,'2e = TDF+3TC+LPV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(14,'2f = ABC+3TC+ATV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(15,'2g = ABC+3TC+LPV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(16,'3a = RAL+ETV+DRV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(17,'4a = ABC+3TC+LPV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(18,'4b = ABC+3TC+EFV',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(19,'4c = AZT+3TC+LPV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(20,'4d = AZT+3TC+EFV',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(21,'4e = TDF+3TC+EFV',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(22,'4f = ABC+3TC+NVP',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(23,'4g = AZT+3TC+NVP',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(24,'5a = AZT+3TC+RAL',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(25,'5b = ABC+3TC+RAL',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(26,'5c = AZT+3TC+LPV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(27,'5d = ABC+3TC+LPV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0),(28,'5e = AZT + 3TC+ ATV/r',0,NULL,NULL,'active','2022-02-18 16:25:07',0);
...
--
-- Dumping data for table `s_run_once_scripts_log`
--

LOCK TABLES `s_run_once_scripts_log` WRITE;
/*!40000 ALTER TABLE `s_run_once_scripts_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `s_run_once_scripts_log` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `system_config` VALUES ('Testing Lab ID','sc_testing_lab_id',''),('User Type','sc_user_type','vluser'),('Version','sc_version','5.2.9'),('Email Id','sup_email',NULL),('Password','sup_password',NULL);
