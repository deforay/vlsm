  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <form class="form-horizontal" method='post' name='addImportRequestForm' id='addImportRequestForm' enctype="multipart/form-data" autocomplete="off" action="eid-bulk-import-request-helper.php">
          <div class="box-body">
                ...
                <div class="col-xs-12">
                  <div class="col-md-12" id="stepOneForm">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <a href="<?php echo "/files/eid/{$countryFormId}/Eid_Bulk_Import_Excel_Format.xlsx"; ?>" target="_blank" class="btn btn-sm btn-primary" download><i class="fa fa-download"></i> Download Example Format</a>
                      </div>
                      <?php } ?>
                    </div>
                  </div>
