...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><i class="fa fa-child"></i> <?php echo _("EID Sample Type");?></h1>
		<ol class="breadcrumb">
				...
				<div class="box">
					<div class="box-header with-border">
						<?php if (isset($_SESSION['privileges']) && in_array("eid-sample-type.php", $_SESSION['privileges']) && $sarr['sc_user_type'] != 'vluser') { ?>
							<a href="add-eid-sample-type.php" class="btn btn-primary pull-right"> <i class="fa fa-plus"></i> <?php echo _("Add EID Sample Type");?></a>
						<?php } ?>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
