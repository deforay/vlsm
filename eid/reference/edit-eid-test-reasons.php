...
$tstQuery = "SELECT * from r_eid_test_reasons where test_reason_id=$id";
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><i class="fa fa-gears"></i> Edit EID Test Reasons</h1>
		<ol class="breadcrumb">
