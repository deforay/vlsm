...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="box box-default">
			...
			<div class="box-body">
				<!-- form start -->
				<form class="form-horizontal" method='post' name='addTstForm' id='addTstForm' autocomplete="off" enctype="multipart/form-data" action="save-eid-test-reasons-helper.php">
					<div class="box-body">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="testReasonName" name="testReasonName" placeholder="Test Reason Name" title="Please enter Test Reason name" onblur="checkNameValidation('r_eid_test_reasons','test_reason_name',this,null,'The Test Reason name that you entered already exists.Enter another name',null)" />
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<select class="form-control select2" id="parentReason" name="parentReason" placeholder="Parent Reason" title="Please enter Parent Reason">
											<?= $general->generateSelectOptions($testParent, null, '-- Select --'); ?>
										</select>
									</div>
								</div>
							</div>
