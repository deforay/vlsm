...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><i class="fa fa-child"></i> <?php echo _("EID Test Reasons");?></h1>
		<ol class="breadcrumb">
				...
				<div class="box">
					<div class="box-header with-border">
						<?php if (isset($_SESSION['privileges']) && in_array("eid-sample-type.php", $_SESSION['privileges']) && $sarr['sc_user_type'] != 'vluser') { ?>
							<a href="add-eid-test-reasons.php" class="btn btn-primary pull-right"> <i class="fa fa-plus"></i> <?php echo _("Add EID Test Reasons");?></a>
						<?php } ?>
