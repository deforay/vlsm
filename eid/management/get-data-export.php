...
foreach ($rResult as $aRow) {
     ...
     $row[] = '<a href="javascript:void(0);" class="btn btn-primary btn-xs" style="margin-right: 2px;" title="'. _("View").'" onclick="convertSearchResultToPdf(' . $aRow['eid_id'] . ');"><i class="fa fa-file-text"></i> '. _("Result PDF").'</a>';
