...
foreach ($rResult as $aRow) {
    ...
    if ($editRequest) {
        $row[] = '<a href="javascript:void(0);" class="btn btn-primary btn-xs" style="margin-right: 2px;" title="'. _("Failed result retest").'" onclick="retestSample(\'' . trim(base64_encode($aRow['eid_id'])) . '\')"><i class="fa fa-refresh"> '. _("Retest").'</i></a>';
    }
    $output['aaData'][] = $row;
}
