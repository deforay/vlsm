...
// $aResultFilterTotal = $db->rawQuery("SELECT eid_id FROM form_eid as vl LEFT JOIN facility_details as f ON vl.facility_id=f.facility_id 
...
// $aResultTotal =  $db->rawQuery("select COUNT(eid_id) as total FROM form_eid as vl $dWhere");
