...
-- Thana 24-Jul-2020
-- ALTER TABLE `form_covid19` DROP `suspected_case_drc`, DROP `probable_case_drc`, DROP `confirme_case_drc`, DROP `contact_case_drc`, DROP `respiratory_rate_option_drc`, DROP `respiratory_rate_drc`, DROP `oxygen_saturation_option_drc`, DROP `oxygen_saturation_drc`, DROP `sick_days_drc`, DROP `onset_illness_date_drc`, DROP `medical_background_drc`, DROP `past3_weeks_mbg_drc`, DROP `take_crae_childrens_mbg_drc`, DROP `live_childrens_mbg_drc`, DROP `hospitalized_mbg_drc`, DROP `ancient_tuberculosis_mbg_drc`, DROP `active_tuberculosis_mbg_drc`, DROP `chronic_cough_mbg_drc`, DROP `cancer_mbg_drc`, DROP `asthma_mbg_drc`, DROP `recurrent_chest_pain_mbg_drc`, DROP `dyspnea_chronic_respiratory_mbg_drc`, DROP `heart_disease_mbg_drc`, DROP `conacted_14_days_drc`, DROP `smoke_drc`, DROP `profession_drc`, DROP `confirmation_lab_drc`, DROP `result_pscr_drc`;
