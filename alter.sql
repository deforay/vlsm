...
CREATE TABLE `dash_covid19_form` (
 ...
 `vlsm_instance_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `vlsm_country_id` int NOT NULL,
 `sample_code_key` int DEFAULT NULL,
 `sample_code_format` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `sample_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `remote_sample` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'no',
 `remote_sample_code_key` int DEFAULT NULL,
 `remote_sample_code_format` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `remote_sample_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `sample_collection_date` datetime NOT NULL,
 `sample_received_at_hub_datetime` datetime DEFAULT NULL,
 `sample_received_at_vl_lab_datetime` datetime DEFAULT NULL,
 `sample_tested_datetime` datetime DEFAULT NULL,
 ...
 `patient_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `patient_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `patient_surname` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `patient_dob` date DEFAULT NULL,
 `patient_age` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `patient_gender` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `patient_phone_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `patient_occupation` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `patient_nationality` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `patient_address` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `patient_province` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `patient_district` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `flight_airline` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `flight_seat_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `flight_arrival_datetime` datetime DEFAULT NULL,
 `flight_airport_of_departure` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `flight_transit` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `reason_of_visit` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `is_sample_collected` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `reason_for_covid19_test` int DEFAULT NULL,
 `specimen_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `is_sample_post_mortem` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `priority_status` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `date_of_symptom_onset` date DEFAULT NULL,
 `date_of_initial_consultation` date DEFAULT NULL,
 `fever_temp` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `close_contacts` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
 `contact_with_confirmed_case` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `has_recent_travel_history` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `travel_country_names` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `travel_return_date` date DEFAULT NULL,
 `lab_id` int DEFAULT NULL,
 `lab_technician` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `lab_reception_person` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `covid19_test_platform` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `result_status` int DEFAULT NULL,
 `is_sample_rejected` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'no',
 `reason_for_sample_rejection` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `rejection_on` date DEFAULT NULL,
 `result` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
 `is_result_authorised` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `authorized_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `authorized_on` date DEFAULT NULL,
 `reason_for_changing` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
 `result_reviewed_datetime` datetime DEFAULT NULL,
 `result_reviewed_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `result_approved_datetime` datetime DEFAULT NULL,
 `result_approved_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `approver_comments` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `result_dispatched_datetime` datetime DEFAULT NULL,
 `result_mail_datetime` datetime DEFAULT NULL,
 `manual_result_entry` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'no',
 `import_machine_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `import_machine_file_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `result_printed_datetime` datetime DEFAULT NULL,
 `request_created_datetime` datetime DEFAULT NULL,
 `request_created_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
 `sample_registered_at_lab` datetime DEFAULT NULL,
 `sample_batch_id` int DEFAULT NULL,
 `sample_package_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `sample_package_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `positive_test_manifest_id` int DEFAULT NULL,
 `positive_test_manifest_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `lot_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
 `lot_expiration_date` date DEFAULT NULL,
 `is_result_mail_sent` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'no',
 `last_modified_datetime` datetime DEFAULT NULL,
 `last_modified_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- Thana 23-Jul-2020
ALTER TABLE `form_covid19`  ADD `suspected_case_drc` TEXT NULL DEFAULT NULL  AFTER `lot_expiration_date`,  ADD `probable_case_drc` TEXT NULL DEFAULT NULL  AFTER `suspected_case_drc`,  ADD `confirme_case_drc` TEXT NULL DEFAULT NULL  AFTER `probable_case_drc`,  ADD `contact_case_drc` TEXT NULL DEFAULT NULL  AFTER `confirme_case_drc`,  ADD `respiratory_rate_option_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `contact_case_drc`,  ADD `respiratory_rate_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `respiratory_rate_option_drc`,  ADD `oxygen_saturation_option_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `respiratory_rate_drc`,  ADD `oxygen_saturation_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `oxygen_saturation_option_drc`,  ADD `sick_days_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `oxygen_saturation_drc`,  ADD `onset_illness_date_drc` DATE NULL DEFAULT NULL  AFTER `sick_days_drc`,  ADD `medical_background_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `onset_illness_date_drc`,  ADD `past3_weeks_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `medical_background_drc`,  ADD `take_crae_childrens_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `past3_weeks_mbg_drc`,  ADD `live_childrens_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `take_crae_childrens_mbg_drc`,  ADD `hospitalized_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `live_childrens_mbg_drc`,  ADD `ancient_tuberculosis_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `hospitalized_mbg_drc`,  ADD `active_tuberculosis_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `ancient_tuberculosis_mbg_drc`,  ADD `chronic_cough_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `active_tuberculosis_mbg_drc`,  ADD `cancer_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `chronic_cough_mbg_drc`,  ADD `asthma_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `cancer_mbg_drc`,  ADD `recurrent_chest_pain_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `asthma_mbg_drc`,  ADD `dyspnea_chronic_respiratory_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `recurrent_chest_pain_mbg_drc`,  ADD `heart_disease_mbg_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `dyspnea_chronic_respiratory_mbg_drc`,  ADD `conacted_14_days_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `heart_disease_mbg_drc`,  ADD `smoke_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `conacted_14_days_drc`,  ADD `profession_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `smoke_drc`,  ADD `confirmation_lab_drc` VARCHAR(255) NULL DEFAULT NULL  AFTER `profession_drc`,  ADD `result_pscr_drc` DATE NULL DEFAULT NULL  AFTER `confirmation_lab_drc`;