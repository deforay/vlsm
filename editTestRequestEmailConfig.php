                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <input type="text" class="form-control" id="rq_email" name="rq_email" placeholder="Email" title="Please enter email" value="<?php echo $arr['rq_email']; ?>">
                      </div>
                    </div>
                   </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <input type="text" class="form-control" id="rq_password" name="rq_password" placeholder="Password" title="Please enter password" value="<?php echo $arr['rq_password']; ?>">
                      </div>
                    </div>
                   </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                           <div style="width:100%;margin:0 auto;clear:both;">
                            ...
                            <select id="rq_field" name="rq_field[]" multiple="multiple" class="search">
