        ...
        if(count($admin)>0){
            ...
            if($priInfo){
              ...
              if($admin[0]['landing_page']!=''){
                ...
                $fileName = array('dashboard/index.php','/vl/requests/addVlRequest.php','/vl/requests/vlRequest.php','/vl/batch/batchcode.php','mail/vlRequestMail.php','import-result/addImportResult.php','vl-print/vlPrintResult.php','vl-print/vlTestResult.php','program-management/vl-sample-status.php','program-management/vlResult.php','program-management/highViralLoad.php','roles/roles.php','users/users.php','facilities/facilities.php','global-config/globalConfig.php','import-configs/importConfig.php');
