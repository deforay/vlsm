							...
							<ul class="treeview-menu">
										...
										<ul class="treeview-menu">
											<?php if (isset($_SESSION['privileges']) && in_array("roles.php", $_SESSION['privileges'])) { ?>
												<li class="allMenu roleMenu">
													<a href="/roles/roles.php"><i class="fa fa-caret-right"></i> Roles</a>
												</li>
											<?php }
											if (isset($_SESSION['privileges']) && in_array("users.php", $_SESSION['privileges'])) { ?>
												<li class="allMenu userMenu">
													<a href="/users/users.php"><i class="fa fa-caret-right"></i> Users</a>
												</li>
											<?php }
											?>
										</ul>
										...
										<ul class="treeview-menu">
											<?php if (isset($_SESSION['privileges']) && in_array("globalConfig.php", $_SESSION['privileges'])) { ?>
												<li class="allMenu globalConfigMenu">
													<a href="/global-config/editGlobalConfig.php"><i class="fa fa-caret-right"></i> General Configuration</a>
												</li>
											<?php }
											if (isset($_SESSION['privileges']) && in_array("importConfig.php", $_SESSION['privileges'])) { ?>
												<li class="allMenu importConfigMenu">
													<a href="/import-configs/importConfig.php"><i class="fa fa-caret-right"></i> Instruments</a>
												</li>
											<?php }
								...
								if (isset($systemConfig['modules']['vl']) && $systemConfig['modules']['vl'] == true && isset($_SESSION['privileges']) && in_array("vl-art-code-details.php", $_SESSION['privileges'])) { ?>
									<li class="treeview vl-reference-manage">
										<a href="#"><i class="fa fa-flask"></i>VL Config
											<span class="pull-right-container">
												<i class="fa fa-angle-left pull-right"></i>
											</span>
										</a>
								...
								if (isset($systemConfig['modules']['eid']) && $systemConfig['modules']['eid'] == true && isset($_SESSION['privileges']) && in_array("eid-sample-type.php", $_SESSION['privileges'])) { ?>
									<li class="treeview eid-reference-manage">
										<a href="#"><i class="fa fa-child"></i>EID Config
											<span class="pull-right-container">
												<i class="fa fa-angle-left pull-right"></i>
											</span>
										</a>
								...
								<ul class="treeview-menu">
									...
									if (isset($_SESSION['privileges']) && in_array("vlRequest.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu vlRequestMenu">
											<a href="/vl/requests/vlRequest.php"><i class="fa fa-caret-right"></i> View Test Requests</a>
										</li>
									<?php }
							...
							<li class="treeview test" style="<?php echo $hideResult; ?>">
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("addImportResult.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu importResultMenu"><a href="/import-result/addImportResult.php?t=<?php echo base64_encode('vl'); ?>"><i class="fa fa-caret-right"></i> Import Result From File</a></li>
									<?php }
									...
									if (isset($_SESSION['privileges']) && in_array("vlResultMail.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu vlResultMailMenu"><a href="/mail/vlResultMail.php"><i class="fa fa-caret-right"></i> E-mail Test Result</a></li>
									<?php }  ?>
								</ul>
							</li>
						<?php }
							...
							<li class="treeview program">
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("vl-sample-status.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu missingResultMenu"><a href="/vl/program-management/vl-sample-status.php"><i class="fa fa-caret-right"></i> Sample Status Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("vlControlReport.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu vlControlReport"><a href="/vl/program-management/vlControlReport.php"><i class="fa fa-caret-right"></i> Control Report</a></li>
									<?php } ?>
                                ...
                                <li><a href="#"><i class="fa fa-caret-right"></i> VL Suppression Report</a></li>-->
									<?php if (isset($_SESSION['privileges']) && in_array("vlResult.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu vlResultMenu"><a href="/vl/program-management/vlResult.php"><i class="fa fa-caret-right"></i> Export Results</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("vlPrintResult.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu vlPrintResultMenu"><a href="/vl/results/vlPrintResult.php"><i class="fa fa-caret-right"></i> Print Result</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("highViralLoad.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu vlHighMenu"><a href="/vl/program-management/highViralLoad.php"><i class="fa fa-caret-right"></i> Clinic Reports</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("patientList.php", $_SESSION['privileges'])) { ?>
										<!--<li class="allMenu patientList"><a href="patientList.php"><i class="fa fa-caret-right"></i> Export Patient List</a></li>-->
									<?php }
									if (isset($_SESSION['privileges']) && in_array("vlWeeklyReport.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu vlWeeklyReport"><a href="/vl/program-management/vlWeeklyReport.php"><i class="fa fa-caret-right"></i> VL Lab Weekly Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("sampleRejectionReport.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu sampleRejectionReport"><a href="/vl/program-management/sampleRejectionReport.php"><i class="fa fa-caret-right"></i> Sample Rejection Report</a></li>
									<?php }
					...
					if (isset($systemConfig['modules']['eid']) && $systemConfig['modules']['eid'] == true && array_intersect($_SESSION['module'], array('eid'))) {  ?>
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("eid-requests.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu eidRequestMenu">
											<a href="/eid/requests/eid-requests.php"><i class="fa fa-caret-right"></i> View Test Requests</a>
										</li>
									<?php }
						...
						if (isset($systemConfig['modules']['eid']) && $systemConfig['modules']['eid'] == true && $eidTestResultMenuAccess == true) { ?>
							<li class="treeview eidResults" style="<?php echo $hideResult; ?>">
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("addImportResult.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu eidImportResultMenu"><a href="/import-result/addImportResult.php?t=<?php echo base64_encode('eid'); ?>"><i class="fa fa-caret-right"></i> Import Result From File</a></li>
									<?php }
							...
							<li class="treeview eidProgramMenu">
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("eid-sample-status.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu eidSampleStatus"><a href="/eid/management/eid-sample-status.php"><i class="fa fa-caret-right"></i> Sample Status Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("eid-export-data.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu eidExportResult"><a href="/eid/management/eid-export-data.php"><i class="fa fa-caret-right"></i> Export Results</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("eid-print-results.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu eidPrintResults"><a href="/eid/results/eid-print-results.php"><i class="fa fa-caret-right"></i> Print Result</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("eid-sample-rejection-report.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu eidSampleRejectionReport"><a href="/eid/management/eid-sample-rejection-report.php"><i class="fa fa-caret-right"></i> Sample Rejection Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("eid-clinic-report.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu eidClinicReport"><a href="/eid/management/eid-clinic-report.php"><i class="fa fa-caret-right"></i> Clinic Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("eidMonthlyThresholdReport.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu eidMonthlyThresholdReport"><a href="/eid/management/eidTestingTargetReport.php"><i class="fa fa-caret-right"></i> EID Testing Target Report</a></li>
									<?php } ?>
								</ul>
							</li>
					<?php }
					...
					<?php if (isset($systemConfig['modules']['covid19']) && $systemConfig['modules']['covid19'] == true && array_intersect($_SESSION['module'], array('covid19'))) {  ?>
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("covid-19-requests.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu covid19RequestMenu">
											<a href="/covid-19/requests/covid-19-requests.php"><i class="fa fa-caret-right"></i> View Test Requests</a>
										</li>
									<?php }
						...
						if (isset($systemConfig['modules']['covid19']) && $systemConfig['modules']['covid19'] == true && $covid19TestResultMenuAccess == true) { ?>
							<li class="treeview covid19Results" style="<?php echo $hideResult; ?>">
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("addImportResult.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu covid19ImportResultMenu"><a href="/import-result/addImportResult.php?t=<?php echo base64_encode('covid19'); ?>"><i class="fa fa-caret-right"></i> Import Result From File</a></li>
									<?php }
									...
									if (isset($_SESSION['privileges']) && in_array("covid-19-result-status.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu covid19ResultStatus"><a href="/covid-19/results/covid-19-result-status.php"><i class="fa fa-caret-right"></i> Manage Results Status</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("mail-covid-19-results.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu covid19ResultMailMenu"><a href="/covid-19/mail/mail-covid-19-results.php"><i class="fa fa-caret-right"></i> E-mail Test Result</a></li>
									<?php }  ?>
								</ul>
							</li>
						<?php }
							...
							<li class="treeview covid19ProgramMenu">
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("covid-19-sample-status.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu covid19SampleStatus"><a href="/covid-19/management/covid-19-sample-status.php"><i class="fa fa-caret-right"></i> Sample Status Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("covid-19-export-data.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu covid19ExportResult"><a href="/covid-19/management/covid-19-export-data.php"><i class="fa fa-caret-right"></i> Export Results</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("covid-19-print-results.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu covid19PrintResults"><a href="/covid-19/results/covid-19-print-results.php"><i class="fa fa-caret-right"></i> Print Result</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("covid-19-sample-rejection-report.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu covid19SampleRejectionReport"><a href="/covid-19/management/covid-19-sample-rejection-report.php"><i class="fa fa-caret-right"></i> Sample Rejection Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("covid-19-clinic-report.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu covid19ClinicReportMenu"><a href="/covid-19/management/covid-19-clinic-report.php"><i class="fa fa-caret-right"></i> Clinic Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("covid19MonthlyThresholdReport.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu covid19MonthlyThresholdReport"><a href="/covid-19/management/covid19TestingTargetReport.php"><i class="fa fa-caret-right"></i>COVID-19 Testing Target Report</a></li>
									<?php } ?>
								</ul>
							</li>
					<?php }
					...
					<?php if (isset($systemConfig['modules']['hepatitis']) && $systemConfig['modules']['hepatitis'] == true && array_intersect($_SESSION['module'], array('hepatitis'))) {  ?>
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("hepatitis-requests.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu hepatitisRequestMenu">
											<a href="/hepatitis/requests/hepatitis-requests.php"><i class="fa fa-caret-right"></i> View Test Requests</a>
										</li>
									<?php }
						...
						if (isset($systemConfig['modules']['hepatitis']) && $systemConfig['modules']['hepatitis'] == true && $hepatitisTestResultMenuAccess == true) { ?>
							<li class="treeview hepatitisResults" style="<?php echo $hideResult; ?>">
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("addImportResult.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu hepatitisImportResultMenu"><a href="/import-result/addImportResult.php?t=<?php echo base64_encode('hepatitis'); ?>"><i class="fa fa-caret-right"></i> Import Result From File</a></li>
									<?php }
									...
									if (isset($_SESSION['privileges']) && in_array("mail-hepatitis-results.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu hepatitisResultMailMenu"><a href="/hepatitis/mail/mail-hepatitis-results.php"><i class="fa fa-caret-right"></i> E-mail Test Result</a></li>
									<?php }  ?>
								</ul>
							</li>
						<?php }
							...
							<li class="treeview hepatitisProgramMenu">
								...
								<ul class="treeview-menu">
									<?php if (isset($_SESSION['privileges']) && in_array("hepatitis-sample-status.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu hepatitisSampleStatus"><a href="/hepatitis/management/hepatitis-sample-status.php"><i class="fa fa-caret-right"></i> Sample Status Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("hepatitis-export-data.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu hepatitisExportResult"><a href="/hepatitis/management/hepatitis-export-data.php"><i class="fa fa-caret-right"></i> Export Results</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("hepatitis-print-results.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu hepatitisPrintResults"><a href="/hepatitis/results/hepatitis-print-results.php"><i class="fa fa-caret-right"></i> Print Result</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("hepatitis-sample-rejection-report.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu hepatitisSampleRejectionReport"><a href="/hepatitis/management/hepatitis-sample-rejection-report.php"><i class="fa fa-caret-right"></i> Sample Rejection Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("hepatitis-clinic-report.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu hepatitisClinicReportMenu"><a href="/hepatitis/management/hepatitis-clinic-report.php"><i class="fa fa-caret-right"></i> Clinic Report</a></li>
									<?php }
									if (isset($_SESSION['privileges']) && in_array("hepatitis-testing-target-report.php", $_SESSION['privileges'])) { ?>
										<li class="allMenu hepatitisMonthlyThresholdReport"><a href="/hepatitis/management/hepatitis-testing-target-report.php"><i class="fa fa-caret-right"></i>Hepatitis Testing Target Report</a></li>
									<?php } ?>
								</ul>
							</li>
					<?php }
