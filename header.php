        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <?php if($allowRecencyCrossLogin){?>
              <li class="user-menu">
                <a target="_blank" href="<?php echo $recencyUrl.'login?u='.base64_encode($crossLoginResult['login_id']).'&t='.base64_encode($crossLoginResult['password']).'&name='.base64_encode($crossLoginResult['user_name']);?>" class="btn btn-link"><i class="fa fa-fw fa-external-link"></i> Recency</a>
              </li>
            <?php }?>
            <!-- Crosss Login Block End -->
