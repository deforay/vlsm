...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="pull-right"><a class="btn btn-primary" href="javascript:void(0);" onclick="showModal('addFacilityLabModal.php',900,520);" style="margin-bottom:20px;">Add Facility</a></div>
    </section>
     <!-- Main content -->
  ...
  $(document).ready(function() {
        oTable = $('#facilityModalDataTable').dataTable({	
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "getFacilitiesLabModalDetails.php",
