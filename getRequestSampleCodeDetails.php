...
if(!isset($facility) && count(array_filter($facility))==0 && trim($sampleType)== '' && trim($gender)=='' && trim($pregnant)=='' && trim($urgent)=='' && trim($_POST['sampleCollectionDate'])=='' && trim($mailSentStatus)==''){
