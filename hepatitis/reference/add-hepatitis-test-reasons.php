...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><i class="fa fa-h-square"></i> Add Hepatitis Test Reasons</h1>
		<ol class="breadcrumb">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="testReasonName" name="testReasonName" placeholder="Test Reason Name" title="Please enter Test Reason name" onblur="checkNameValidation('r_hepatitis_test_reasons','test_reason_name',this,null,'The Test Reason name that you entered already exists.Enter another name',null)" />
									</div>
								</div>
							</div>
							<div class="col-md-6">
