...
foreach ($rResult as $aRow) {
    ...
    if (isset($_SESSION['privileges']) && in_array("hepatitis-sample-type.php", $_SESSION['privileges']) && $sarr['user_type'] !='vluser') {
        $row[] = '<a href="edit-hepatitis-results.php?id=' . base64_encode($aRow['result_id']) . '" class="btn btn-primary btn-xs" style="margin-right: 2px;" title="Edit"><i class="fa fa-pencil"> Edit</i></a>';
    }
    $output['aaData'][] = $row;
}
