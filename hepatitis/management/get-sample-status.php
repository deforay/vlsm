...
if (isset($_POST['sampleReceivedDateAtLab']) && trim($_POST['sampleReceivedDateAtLab']) != '') {
    $sWhere .= ' AND DATE(c.sample_received_at_vl_lab_datetime) >= "' . $labStartDate . '" AND DATE(c.sample_received_at_vl_lab_datetime) <= "' . $labEndDate . '"';
}
if (isset($_POST['sampleTestedDate']) && trim($_POST['sampleTestedDate']) != '') {
    $sWhere .= ' AND DATE(c.sample_tested_datetime) >= "' . $testedStartDate . '" AND DATE(c.sample_tested_datetime) <= "' . $testedEndDate . '"';
}
if (!empty($_POST['labName'])) {
    $sWhere .= ' AND vl.lab_id = ' . $_POST['labName'];
}
