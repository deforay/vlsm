                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <label class="control-label">
                               ...
                               <?php } elseif($result[0]['switch_to_tdf_last_vl_date']!='' || $result[0]['switch_to_tdf_value']!='' || $result[0]['switch_to_tdf_sample_type']!='') { ?>
                                 <strong>Switch to TDF</strong>
                               <?php }  elseif($result[0]['missing_last_vl_date']!='' || $result[0]['missing_value']!='' || $result[0]['missing_sample_type']!='') { ?>
                 ...
                 <div class="row">
                   <div class="col-md-4">
                    <div class="form-group">
                        <label for="suspendTreatmentLastVLDate" class="col-lg-4 control-label">Last VL Date</label>
                        <div class="col-lg-7" style="font-style:italic;">
                          <?php echo $result[0]['switch_to_tdf_last_vl_date']; ?>
                        </div>
                    </div>
                  </div>
                   <div class="col-md-4">
                    <div class="form-group">
                        <label for="suspendTreatmentVlValue" class="col-lg-4 control-label">VL Value</label>
                        <div class="col-lg-7" style="font-style:italic;">
                          <?php echo $result[0]['switch_to_tdf_value']; ?>
                        </div>
                    </div>
                  </div>
                   <div class="col-md-4">
                    <div class="form-group">
                        <label for="suspendTreatmentSampleType" class="col-lg-4 control-label">Sample Type</label>
                        <div class="col-lg-7" style="font-style:italic;">
                           <?php echo ucwords($result[0]['stdf']); ?>
                        </div>
                    </div>
                  </div>                   
                </div>
                 ...
                 <div class="row">
                   <div class="col-md-4">
                    <div class="form-group">
                        <label for="suspendTreatmentLastVLDate" class="col-lg-4 control-label">Last VL Date</label>
                        <div class="col-lg-7" style="font-style:italic;">
                          <?php echo $result[0]['missing_last_vl_date']; ?>
                        </div>
                    </div>
                  </div>
                   <div class="col-md-4">
                    <div class="form-group">
                        <label for="suspendTreatmentVlValue" class="col-lg-4 control-label">VL Value</label>
                        <div class="col-lg-7" style="font-style:italic;">
                          <?php echo $result[0]['missing_value']; ?>
                        </div>
                    </div>
                  </div>
                   <div class="col-md-4">
