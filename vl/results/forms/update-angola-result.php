								...
								<div class="box box-primary">
									...
									<table class="table" style="width:100%">
										<tr>
											...
											<td style="width:14%;">
												<input type="text" class="form-control date" id="dateOfArtInitiation" name="dateOfArtInitiation" placeholder="e.g 09-Jan-1992" title="Please select Data de início de TARV" <?php echo $disable; ?> value="<?php echo $vlQueryInfo['treatment_initiated_date']; ?>" style="width:100%;" />
											</td>
								...
								<div class="box box-primary" style="<?php if ($_SESSION['instanceType'] == 'remoteuser' { ?> pointer-events:none;<?php } ?>">
									...
									<table class="table" style="width:100%">
										...
										<tr>
											...
											<td colspan="7">
												<textarea class="form-control" name="labComments" id="labComments" placeholder="Comentários do laboratório" style="width:100%"><?php echo trim($vlQueryInfo['approver_comments']); ?></textarea>
											</td>
										</tr>
										<tr>
