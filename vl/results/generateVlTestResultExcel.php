     ...
     foreach ($sampleResult as $sample) {
          ...
          for ($f = 0; $f < count($filedGroup); $f++) {
               ...
               if ($field ==  'result_reviewed_by') {
                    ...
                    $fValueQuery = "SELECT f.facility_name as labName FROM form_vl as vl LEFT JOIN facility_details as f ON vl.lab_id=f.facility_id where vl.vl_sample_id = '" . $sample['vl_sample_id'] . "'";
               } else {
