...
$requestArr = array();
//Set selected field
if(isset($arr['rq_field']) && trim($arr['rq_field'])!= ''){
  $explodField = explode(",",$arr['rq_field']);
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <!-- form start -->
            <form class="form-horizontal" name="editTestRequestEmailConfigForm" id="editTestRequestEmailConfigForm" method="post"  autocomplete="off" action="editTestRequestEmailConfigHelper.php">
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="rq_email" class="col-lg-3 control-label">Email Id <code>(Gmail only)</code>*</label>
                      <div class="col-lg-9">
                        <input type="text" class="form-control isEmail isRequired" id="rq_email" name="rq_email" placeholder="eg.hello.vl@gmail.com" title="Please enter email" value="<?php echo $arr['rq_email']; ?>">
                      </div>
                    </div>
                   </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="rq_password" class="col-lg-3 control-label">Password *</label>
                      <div class="col-lg-9">
                        <input type="password" class="form-control isRequired" id="rq_password" name="rq_password" placeholder="Password" title="Please enter password" value="<?php echo $arr['rq_password']; ?>">
                      </div>
                    </div>
                   </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                    <div class="form-group">
                        <label for="rq_field" class="col-lg-3 control-label">Choose Fields *</label>
                        <div class="col-lg-9">
                           <div style="width:100%;margin:0 auto;clear:both;">
                            ...
                            <select id="rq_field" name="rq_field[]" multiple="multiple" class="search isRequired" title="Please select email fields">
                                <option value="Sample ID" <?php echo(in_array("Sample ID",$requestArr)?"selected='selected'":""); ?>>Sample ID</option>
                                <option value="Urgency" <?php echo(in_array("Urgency",$requestArr)?"selected='selected'":""); ?>>Urgency</option>
                                <option value="Province" <?php echo(in_array("Province",$requestArr)?"selected='selected'":""); ?>>Province/State</option>
                                <option value="District Name" <?php echo(in_array("District Name",$requestArr)?"selected='selected'":""); ?>>District/County</option>
                                ...
                                <option value="Patient ID/ART/TRACNET" <?php echo(in_array("Patient ID/ART/TRACNET",$requestArr)?"selected='selected'":""); ?>>Patient ID/ART/TRACNET</option>
                                ...
                                <option value="Lab ID" <?php echo(in_array("Lab ID",$requestArr)?"selected='selected'":""); ?>>Lab ID</option>
                                ...
                                <option value="Is Sample Rejected" <?php echo(in_array("Is Sample Rejected",$requestArr)?"selected='selected'":""); ?>>Is Sample Rejected</option>
                                ...
                                <option value="Lab Tech. Comments" <?php echo(in_array("Lab Tech. Comments",$requestArr)?"selected='selected'":""); ?>>Lab Tech. Comments</option>
              ...
              <div class="box-footer">
                ...
                <a href="testRequestEmailConfig.php" class="btn btn-default"> Cancel</a>
              </div>
              <!-- /.box-footer -->
            </form>
          <!-- /.row -->
  ...
  $(document).ready(function() {
	 ...
	 .on('keydown', function(e){
      ...
      $('#select-all-field').click(function(){
       $('#rq_field').multiSelect('select_all');
       return false;
     });
     $('#deselect-all-field').click(function(){
       $('#rq_field').multiSelect('deselect_all');
       return false;
     });
   });
