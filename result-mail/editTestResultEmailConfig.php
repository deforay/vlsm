                        ...
                        <div class="col-lg-9">
                           <div style="width:100%;margin:0 auto;clear:both;">
                            ...
                            <select id="rs_field" name="rs_field[]" multiple="multiple" class="search isRequired" title="Please select email fields">
                                ...
                                <option value="Province" <?php echo(in_array("Province",$resultArr)?"selected='selected'":""); ?>>Province/State</option>
                                <option value="District Name" <?php echo(in_array("District Name",$resultArr)?"selected='selected'":""); ?>>District/County</option>
