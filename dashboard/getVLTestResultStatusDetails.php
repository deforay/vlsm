...
$primaryKey="vl_sample_id";
	...
	$sQuery = $sQuery." ORDER BY vl.last_modified_datetime DESC";
        ...
        $aResultFilterTotal =$db->rawQuery("SELECT vl.vl_sample_id,vl.facility_id,vl.patient_name,vl.result,f.facility_name,f.facility_code,vl.art_no,s.sample_name,b.batch_code,vl.sample_batch_id,ts.status_name FROM vl_request_form as vl INNER JOIN r_testing_status as ts ON ts.status_id=vl.status LEFT JOIN facility_details as f ON vl.facility_id=f.facility_id  LEFT JOIN r_sample_type as s ON s.sample_id=vl.sample_id LEFT JOIN batch_details as b ON b.batch_id=vl.sample_batch_id $sWhere  ORDER BY vl.last_modified_datetime DESC, $sOrder");
